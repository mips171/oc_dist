...
class ModelCustomerCustomer extends Model
{
    ...
    {
        $this->db->query("INSERT INTO " . DB_PREFIX . "customer SET customer_group_id = '" . (int) $data['customer_group_id'] . "', firstname = '" . $this->db->escape($data['firstname']) . "', lastname = '" . $this->db->escape($data['lastname']) . "', email = '" . $this->db->escape($data['email']) . "', telephone = '" . $this->db->escape($data['telephone']) . "', custom_field = '" . $this->db->escape(isset($data['custom_field']) ? json_encode($data['custom_field']) : json_encode(array())) . "', newsletter = '" . (int) $data['newsletter'] . "', salt = '" . $this->db->escape($salt = token(9)) . "', password = '" . $this->db->escape(sha1($salt . sha1($salt . sha1($data['password'])))) . "', status = '" . (int) $data['status'] . "', safe = '" . (int) $data['safe'] . "', credit_limit = '" . $this->db->escape($data['credit_limit']) . "', credit_hold = '" . (int) $data['credit_hold'] . "', abn = '" . $this->db->escape($data['abn']) . "', company = '" . $this->db->escape($data['company']) . "', date_added = NOW()");
    ...
    {
        $this->db->query("UPDATE " . DB_PREFIX . "customer SET customer_group_id = '" . (int) $data['customer_group_id'] . "', firstname = '" . $this->db->escape($data['firstname']) . "', lastname = '" . $this->db->escape($data['lastname']) . "', email = '" . $this->db->escape($data['email']) . "', telephone = '" . $this->db->escape($data['telephone']) . "', custom_field = '" . $this->db->escape(isset($data['custom_field']) ? json_encode($data['custom_field']) : json_encode(array())) . "', newsletter = '" . (int) $data['newsletter'] . "', status = '" . (int) $data['status'] . "', safe = '" . (int) $data['safe'] . "', credit_limit = '" . $this->db->escape($data['credit_limit']) . "', credit_hold = '" . (int) $data['credit_hold'] . "', abn = '" . $this->db->escape($data['abn']) . "', company = '" . $this->db->escape($data['company']) . "' WHERE customer_id = '" . (int) $customer_id . "'");
    ...
    public function getCustomers($data = array())
    {
        ...
        if (!empty($data['filter_company'])) {
            $implode[] = "LOWER(c.company) LIKE '%" . $this->db->escape(strtolower($data['filter_company'])) . "%'";
        }

<?php
	...
	if ($export_logo_criteria ? $this->mainCounter = 2 : $this->mainCounter = 1) {
		 ...
		 $col = \PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex($j++);		 
		 $sheet->setCellValue($col . $this->mainCounter, $this->language->get('column_prod_upc'));
		 $sheet->getStyle($col . $this->mainCounter)->getFont()->setBold(true);		 
		 $sheet->getColumnDimension($col)->setAutoSize(true);
		 }
		 ...
		 $col = \PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex($j++);		 
		 $sheet->setCellValue($col . $this->mainCounter, $this->language->get('column_prod_ean'));
		 $sheet->getStyle($col . $this->mainCounter)->getFont()->setBold(true);		 
		 $sheet->getColumnDimension($col)->setAutoSize(true);
		 }
		 ...
		 $col = \PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex($j++);		 
		 $sheet->setCellValue($col . $this->mainCounter, $this->language->get('column_prod_jan'));
		 $sheet->getStyle($col . $this->mainCounter)->getFont()->setBold(true);		 
		 $sheet->getColumnDimension($col)->setAutoSize(true);
		 }
		 ...
		 $col = \PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex($j++);		 
		 $sheet->setCellValue($col . $this->mainCounter, $this->language->get('column_prod_isbn'));
		 $sheet->getStyle($col . $this->mainCounter)->getFont()->setBold(true);		 
		 $sheet->getColumnDimension($col)->setAutoSize(true);
		 }
		 ...
		 $col = \PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex($j++);		 
		 $sheet->setCellValue($col . $this->mainCounter, $this->language->get('column_prod_mpn'));
		 $sheet->getStyle($col . $this->mainCounter)->getFont()->setBold(true);		 
		 $sheet->getColumnDimension($col)->setAutoSize(true);
		 }
	...
	foreach ($results as $result) {
		...
		$col = \PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex($j++);
		$sheet->getStyle($col . $counter)->getNumberFormat()->setFormatCode(\PhpOffice\PhpSpreadsheet\Style\NumberFormat::FORMAT_TEXT);
		$sheet->setCellValue($col . $counter, $result['product_upc']);
		}
		
		if (in_array('all_prod_ean', $advppp_settings_all_columns)) {
		$col = \PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex($j++);
		$sheet->getStyle($col . $counter)->getNumberFormat()->setFormatCode(\PhpOffice\PhpSpreadsheet\Style\NumberFormat::FORMAT_TEXT);
		$sheet->setCellValue($col . $counter, $result['product_ean']);
		}
		
		if (in_array('all_prod_jan', $advppp_settings_all_columns)) {
		$col = \PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex($j++);
		$sheet->getStyle($col . $counter)->getNumberFormat()->setFormatCode(\PhpOffice\PhpSpreadsheet\Style\NumberFormat::FORMAT_TEXT);
		$sheet->setCellValue($col . $counter, $result['product_jan']);
		}
		
		if (in_array('all_prod_isbn', $advppp_settings_all_columns)) {
		$col = \PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex($j++);
		$sheet->getStyle($col . $counter)->getNumberFormat()->setFormatCode(\PhpOffice\PhpSpreadsheet\Style\NumberFormat::FORMAT_TEXT);
		$sheet->setCellValue($col . $counter, $result['product_isbn']);
		}
		
		if (in_array('all_prod_mpn', $advppp_settings_all_columns)) {
		$col = \PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex($j++);
		$sheet->getStyle($col . $counter)->getNumberFormat()->setFormatCode(\PhpOffice\PhpSpreadsheet\Style\NumberFormat::FORMAT_TEXT);
		$sheet->setCellValue($col . $counter, $result['product_mpn']);
		}

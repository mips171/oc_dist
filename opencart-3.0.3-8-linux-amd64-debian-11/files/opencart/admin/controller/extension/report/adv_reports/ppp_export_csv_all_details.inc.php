<?php
	...
	$custom_fields_name = $this->model_extension_report_adv_products_profit->getCustomFieldsNames($filter_data);
	}
	...
	in_array('all_prod_upc', $advppp_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . $this->language->get('column_prod_upc') . $csv_enclosed : '';
	in_array('all_prod_ean', $advppp_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . $this->language->get('column_prod_ean') . $csv_enclosed : '';
	in_array('all_prod_jan', $advppp_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . $this->language->get('column_prod_jan') . $csv_enclosed : '';
	in_array('all_prod_isbn', $advppp_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . $this->language->get('column_prod_isbn') . $csv_enclosed : '';
	in_array('all_prod_mpn', $advppp_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . $this->language->get('column_prod_mpn') . $csv_enclosed : '';
	...
	in_array('all_campaign_name', $advppp_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . $this->language->get('column_campaign_name') . $csv_enclosed : '';	
	in_array('all_campaign_code', $advppp_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . $this->language->get('column_campaign_code') . $csv_enclosed : '';	
	...
	in_array('all_prod_upc', $advppp_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . $result['product_upc'] . $csv_enclosed : '';
	in_array('all_prod_ean', $advppp_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . $result['product_ean'] . $csv_enclosed : '';
	in_array('all_prod_jan', $advppp_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . $result['product_jan'] . $csv_enclosed : '';
	in_array('all_prod_isbn', $advppp_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . $result['product_isbn'] . $csv_enclosed : '';
	in_array('all_prod_mpn', $advppp_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . $result['product_mpn'] . $csv_enclosed : '';
	...
	in_array('all_prod_option', $advppp_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . html_entity_decode($result['product_options'], ENT_NOQUOTES, 'UTF-8') . $csv_enclosed : '';
	...
	in_array('all_prod_category', $advppp_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . html_entity_decode($result['product_category'] !== NULL ? $result['product_category'] : '') . $csv_enclosed : '';		
	in_array('all_prod_manu', $advppp_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . html_entity_decode($result['product_manu'] !== NULL ? $result['product_manu'] : '') . $csv_enclosed : '';
	in_array('all_prod_supplier', $advppp_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . html_entity_decode($result['product_supplier'] !== NULL ? $result['product_supplier'] : '') . $csv_enclosed : '';
	}
 	if ($filter_details == 'all_details_products' or $filter_details == 'all_details_orders') {
	...
	if ($filter_details == 'all_details_products') {
	in_array('all_prod_price', $advppp_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['product_price_raw'], 2)) . $csv_enclosed : '';
	...
	in_array('all_prod_total_excl_vat', $advppp_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['product_total_excl_vat_raw'], 2)) . $csv_enclosed : '';	
	in_array('all_prod_tax', $advppp_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['product_tax_raw'], 2)) . $csv_enclosed : '';		
	in_array('all_prod_total_incl_vat', $advppp_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['product_total_incl_vat_raw'], 2)) . $csv_enclosed : '';
	in_array('all_prod_discount', $advppp_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['product_discount_raw'], 2)) . $csv_enclosed : '';
	...
	in_array('all_prod_refund', $advppp_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . ($result['product_refund_raw'] != NULL ? sprintf('%0.2f', round(-$result['product_refund_raw'], 2)) : sprintf('%0.2f', round('0', 2))) . $csv_enclosed : '';
	} else {
	in_array('all_prod_refund', $advppp_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . ($result['product_refund_raw'] != NULL ? sprintf('%0.2f', round($result['product_refund_raw'], 2)) : sprintf('%0.2f', round('0', 2))) . $csv_enclosed : '';
	}	
	...
	in_array('all_prod_sales', $advppp_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['product_sales_raw'], 2)) . $csv_enclosed : '';	
	in_array('all_prod_cost', $advppp_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round(-$result['product_cost_raw'], 2)) . $csv_enclosed : '';
	in_array('all_prod_profit', $advppp_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['product_profit_raw'], 2)) . $csv_enclosed : '';
	...
	in_array('all_sub_total', $advppp_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['order_sub_total_raw'], 2)) . $csv_enclosed : '';
	in_array('all_handling', $advppp_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['order_handling_raw'] !== NULL ? $result['order_handling_raw'] : 0, 2)) . $csv_enclosed : '';
	in_array('all_loworder', $advppp_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['order_low_order_fee_raw'] !== NULL ? $result['order_low_order_fee_raw'] : 0, 2)) . $csv_enclosed : '';
	in_array('all_shipping', $advppp_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['order_shipping_raw'] !== NULL ? $result['order_shipping_raw'] : 0, 2)) . $csv_enclosed : '';
	in_array('all_reward', $advppp_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['order_reward_raw'] !== NULL ? $result['order_reward_raw'] : 0, 2)) . $csv_enclosed : '';
	...
	in_array('all_coupon', $advppp_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['order_coupon_raw'] !== NULL ? $result['order_coupon_raw'] : 0, 2)) . $csv_enclosed : '';
	...
	in_array('all_order_tax', $advppp_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['order_tax_raw'] !== NULL ? $result['order_tax_raw'] : 0, 2)) . $csv_enclosed : '';
	in_array('all_credit', $advppp_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['order_credit_raw'] !== NULL ? $result['order_credit_raw'] : 0, 2)) . $csv_enclosed : '';	
	in_array('all_voucher', $advppp_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['order_voucher_raw'] !== NULL ? $result['order_voucher_raw'] : 0, 2)) . $csv_enclosed : '';
	...
	in_array('all_discount', $advppp_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['order_discount_raw'] !== NULL ? $result['order_discount_raw'] : 0, 2)) . $csv_enclosed : '';
	in_array('all_order_value', $advppp_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['order_value_raw'], 2)) . $csv_enclosed : '';
	if ($this->config->get('advppp' . $user_id . '_formula_6')) {	
	in_array('all_refund', $advppp_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . ($result['order_refund_raw'] != NULL ? sprintf('%0.2f', round(-$result['order_refund_raw'], 2)) : sprintf('%0.2f', round('0', 2))) . $csv_enclosed : '';
	} else {
	in_array('all_refund', $advppp_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . ($result['order_refund_raw'] != NULL ? sprintf('%0.2f', round($result['order_refund_raw'], 2)) : sprintf('%0.2f', round('0', 2))) . $csv_enclosed : '';
	}
	in_array('all_order_sales', $advppp_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['order_sales_raw'], 2)) . $csv_enclosed : '';
	in_array('all_order_prod_costs', $advppp_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round(-$result['order_product_costs_raw'], 2)) . $csv_enclosed : '';	
	in_array('all_order_commission', $advppp_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round(-$result['order_commission_raw'], 2)) . $csv_enclosed : '';	
	in_array('all_order_payment_cost', $advppp_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round(-$result['order_payment_cost_raw'], 2)) . $csv_enclosed : '';
	in_array('all_order_shipping_cost', $advppp_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round(-$result['order_shipping_cost_raw'], 2)) . $csv_enclosed : '';
	in_array('all_order_extra_cost', $advppp_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round(-$result['order_extra_cost_raw'], 2)) . $csv_enclosed : '';
	in_array('all_order_return_cost', $advppp_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round(-$result['order_return_cost_raw'], 2)) . $csv_enclosed : '';
	in_array('all_shipping_balance', $advppp_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['order_ship_balance_raw'], 2)) . $csv_enclosed : '';	
	in_array('all_order_costs', $advppp_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round(-$result['order_costs_raw'], 2)) . $csv_enclosed : '';
	in_array('all_order_profit', $advppp_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['order_profit_raw'], 2)) . $csv_enclosed : '';
	...
	in_array('all_campaign_name', $advppp_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . $result['order_campaign_name'] . $csv_enclosed : '';	
	in_array('all_campaign_code', $advppp_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . $result['order_campaign_code'] . $csv_enclosed : '';	

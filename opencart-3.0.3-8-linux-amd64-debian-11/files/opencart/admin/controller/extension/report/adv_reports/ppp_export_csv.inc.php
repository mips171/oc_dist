<?php
	...
	in_array('scw_upc', $advppp_settings_scw_columns) ?  $export_csv .= $csv_delimiter . $csv_enclosed . $this->language->get('column_upc') . $csv_enclosed : '';
	in_array('scw_ean', $advppp_settings_scw_columns) ?  $export_csv .= $csv_delimiter . $csv_enclosed . $this->language->get('column_ean') . $csv_enclosed : '';
	in_array('scw_jan', $advppp_settings_scw_columns) ?  $export_csv .= $csv_delimiter . $csv_enclosed . $this->language->get('column_jan') . $csv_enclosed : '';
	in_array('scw_isbn', $advppp_settings_scw_columns) ?  $export_csv .= $csv_delimiter . $csv_enclosed . $this->language->get('column_isbn') . $csv_enclosed : '';
	in_array('scw_mpn', $advppp_settings_scw_columns) ?  $export_csv .= $csv_delimiter . $csv_enclosed . $this->language->get('column_mpn') . $csv_enclosed : '';
	...
	in_array('pnp_upc', $advppp_settings_pnp_columns) ?  $export_csv .= $csv_delimiter . $csv_enclosed . $this->language->get('column_upc') . $csv_enclosed : '';
	in_array('pnp_ean', $advppp_settings_pnp_columns) ?  $export_csv .= $csv_delimiter . $csv_enclosed . $this->language->get('column_ean') . $csv_enclosed : '';
	in_array('pnp_jan', $advppp_settings_pnp_columns) ?  $export_csv .= $csv_delimiter . $csv_enclosed . $this->language->get('column_jan') . $csv_enclosed : '';
	in_array('pnp_isbn', $advppp_settings_pnp_columns) ?  $export_csv .= $csv_delimiter . $csv_enclosed . $this->language->get('column_isbn') . $csv_enclosed : '';
	in_array('pnp_mpn', $advppp_settings_pnp_columns) ?  $export_csv .= $csv_delimiter . $csv_enclosed . $this->language->get('column_mpn') . $csv_enclosed : '';
	...
	in_array('scw_upc', $advppp_settings_scw_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . $result['upc'] . $csv_enclosed : '';
	in_array('scw_ean', $advppp_settings_scw_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . $result['ean'] . $csv_enclosed : '';
	in_array('scw_jan', $advppp_settings_scw_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . $result['jan'] . $csv_enclosed : '';
	in_array('scw_isbn', $advppp_settings_scw_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . $result['isbn'] . $csv_enclosed : '';
	in_array('scw_mpn', $advppp_settings_scw_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . $result['mpn'] . $csv_enclosed : '';
	in_array('scw_model', $advppp_settings_scw_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . $result['model'] . $csv_enclosed : '';
	in_array('scw_category', $advppp_settings_scw_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . html_entity_decode($result['categories'] !== NULL ? $result['categories'] : '') . $csv_enclosed : '';		
	in_array('scw_manufacturer', $advppp_settings_scw_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . html_entity_decode($result['manufacturers'] !== NULL ? $result['manufacturers'] : '') . $csv_enclosed : '';
	in_array('scw_supplier', $advppp_settings_scw_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . html_entity_decode($result['suppliers'] !== NULL ? $result['suppliers'] : '') . $csv_enclosed : '';
	...
	in_array('scw_price', $advppp_settings_scw_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['price_raw'], 2)) . $csv_enclosed : '';	
	in_array('scw_cost', $advppp_settings_scw_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round(-$result['cost_raw'], 2)) . $csv_enclosed : '';	
	in_array('scw_profit', $advppp_settings_scw_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['profit_raw'], 2)) . $csv_enclosed : '';
	...
	in_array('scw_customer_id', $advppp_settings_scw_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('scw_date_added', $advppp_settings_scw_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('scw_customer_name', $advppp_settings_scw_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('scw_customer_email', $advppp_settings_scw_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('scw_customer_telephone', $advppp_settings_scw_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('scw_customer_group', $advppp_settings_scw_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('scw_billing_company', $advppp_settings_scw_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('scw_billing_address_1', $advppp_settings_scw_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('scw_billing_address_2', $advppp_settings_scw_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('scw_billing_city', $advppp_settings_scw_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('scw_billing_zone', $advppp_settings_scw_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('scw_billing_postcode', $advppp_settings_scw_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('scw_billing_country', $advppp_settings_scw_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	if ($result['customer']) {	
	...
	in_array('scw_upc', $advppp_settings_scw_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('scw_ean', $advppp_settings_scw_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('scw_jan', $advppp_settings_scw_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('scw_isbn', $advppp_settings_scw_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('scw_mpn', $advppp_settings_scw_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	...
	in_array('pnp_upc', $advppp_settings_pnp_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . $result['upc'] . $csv_enclosed : '';
	in_array('pnp_ean', $advppp_settings_pnp_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . $result['ean'] . $csv_enclosed : '';
	in_array('pnp_jan', $advppp_settings_pnp_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . $result['jan'] . $csv_enclosed : '';
	in_array('pnp_isbn', $advppp_settings_pnp_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . $result['isbn'] . $csv_enclosed : '';
	in_array('pnp_mpn', $advppp_settings_pnp_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . $result['mpn'] . $csv_enclosed : '';
	in_array('pnp_model', $advppp_settings_pnp_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . $result['model'] . $csv_enclosed : '';
	in_array('pnp_category', $advppp_settings_pnp_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . html_entity_decode($result['categories'] !== NULL ? $result['categories'] : '') . $csv_enclosed : '';		
	in_array('pnp_manufacturer', $advppp_settings_pnp_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . html_entity_decode($result['manufacturers'] !== NULL ? $result['manufacturers'] : '') . $csv_enclosed : '';
	in_array('pnp_supplier', $advppp_settings_pnp_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . html_entity_decode($result['suppliers'] !== NULL ? $result['suppliers'] : '') . $csv_enclosed : '';
	...
	in_array('pnp_price', $advppp_settings_pnp_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['price_raw'], 2)) . $csv_enclosed : '';	
	in_array('pnp_cost', $advppp_settings_pnp_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round(-$result['cost_raw'], 2)) . $csv_enclosed : '';	
	in_array('pnp_profit', $advppp_settings_pnp_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['profit_raw'], 2)) . $csv_enclosed : '';

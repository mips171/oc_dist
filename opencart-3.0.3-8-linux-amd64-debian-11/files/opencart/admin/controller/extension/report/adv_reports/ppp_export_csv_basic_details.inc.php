<?php
	...
	in_array('cm_orders', $advppp_settings_cm_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . $this->language->get('column_orders') . $csv_enclosed : '';
	in_array('cm_customers', $advppp_settings_cm_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . $this->language->get('column_customers') . $csv_enclosed : '';
	...
	in_array('mv_orders', $advppp_settings_mv_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . $this->language->get('column_orders') . $csv_enclosed : '';
	in_array('mv_customers', $advppp_settings_mv_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . $this->language->get('column_customers') . $csv_enclosed : '';
	...
	in_array('mv_upc', $advppp_settings_mv_columns) ?  $export_csv .= $csv_delimiter . $csv_enclosed . $this->language->get('column_upc') . $csv_enclosed : '';
	in_array('mv_ean', $advppp_settings_mv_columns) ?  $export_csv .= $csv_delimiter . $csv_enclosed . $this->language->get('column_ean') . $csv_enclosed : '';
	in_array('mv_jan', $advppp_settings_mv_columns) ?  $export_csv .= $csv_delimiter . $csv_enclosed . $this->language->get('column_jan') . $csv_enclosed : '';
	in_array('mv_isbn', $advppp_settings_mv_columns) ?  $export_csv .= $csv_delimiter . $csv_enclosed . $this->language->get('column_isbn') . $csv_enclosed : '';
	in_array('mv_mpn', $advppp_settings_mv_columns) ?  $export_csv .= $csv_delimiter . $csv_enclosed . $this->language->get('column_mpn') . $csv_enclosed : '';
	...
	$export_csv .= $csv_delimiter . $csv_enclosed . html_entity_decode($result['suppliers'] !== NULL ? $result['suppliers'] : '') . $csv_enclosed;
	}
	in_array('cm_orders', $advppp_settings_cm_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . $result['orders'] . $csv_enclosed : '';
	in_array('cm_customers', $advppp_settings_cm_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . $result['customers'] . $csv_enclosed : '';
	...
	in_array('cm_sold_percent', $advppp_settings_cm_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . ($result['sold_quantity'] != 0 ? round(100 * ($result['sold_quantity'] / $result['sold_quantity_total']), 2) : round((0), 2)) . '%' . $csv_enclosed : '';
	in_array('cm_total_excl_vat', $advppp_settings_cm_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['total_excl_vat_raw'], 2)) . $csv_enclosed : '';
	in_array('cm_total_tax', $advppp_settings_cm_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['total_tax_raw'] !== NULL ? $result['total_tax_raw'] : 0, 2)) . $csv_enclosed : '';
	in_array('cm_total_incl_vat', $advppp_settings_cm_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['total_incl_vat_raw'], 2)) . $csv_enclosed : '';
	in_array('cm_app', $advppp_settings_cm_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['app_raw'], 2)) . $csv_enclosed : '';
	in_array('cm_discount', $advppp_settings_cm_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['discount_raw'] !== NULL ? $result['discount_raw'] : 0, 2)) . $csv_enclosed : '';
	if ($this->config->get('advppp' . $user_id . '_formula_6')) {
	in_array('cm_refunds', $advppp_settings_cm_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . ($result['refunds_raw'] != NULL ? sprintf('%0.2f', round(-$result['refunds_raw'], 2)) : sprintf('%0.2f', round('0', 2))) . $csv_enclosed : '';
	} else {
	in_array('cm_refunds', $advppp_settings_cm_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . ($result['refunds_raw'] != NULL ? sprintf('%0.2f', round($result['refunds_raw'], 2)) : sprintf('%0.2f', round('0', 2))) . $csv_enclosed : '';
	}		
	...
	in_array('cm_total_sales', $advppp_settings_cm_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['total_sales_raw'], 2)) . $csv_enclosed : '';	
	in_array('cm_total_costs', $advppp_settings_cm_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round(-$result['total_costs_raw'], 2)) . $csv_enclosed : '';	
	in_array('cm_total_profit', $advppp_settings_cm_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['total_profit_raw'], 2)) . $csv_enclosed : '';
	...
	in_array('mv_orders', $advppp_settings_mv_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . $result['orders'] . $csv_enclosed : '';
	in_array('mv_customers', $advppp_settings_mv_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . $result['customers'] . $csv_enclosed : '';
	...
	in_array('mv_upc', $advppp_settings_mv_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . $result['upc'] . $csv_enclosed : '';
	in_array('mv_ean', $advppp_settings_mv_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . $result['ean'] . $csv_enclosed : '';
	in_array('mv_jan', $advppp_settings_mv_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . $result['jan'] . $csv_enclosed : '';
	in_array('mv_isbn', $advppp_settings_mv_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . $result['isbn'] . $csv_enclosed : '';
	in_array('mv_mpn', $advppp_settings_mv_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . $result['mpn'] . $csv_enclosed : '';	
	in_array('mv_model', $advppp_settings_mv_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . $result['model'] . $csv_enclosed : '';
	in_array('mv_category', $advppp_settings_mv_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . html_entity_decode($result['categories'] !== NULL ? $result['categories'] : '') . $csv_enclosed : '';		
	in_array('mv_manufacturer', $advppp_settings_mv_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . html_entity_decode($result['manufacturers'] !== NULL ? $result['manufacturers'] : '') . $csv_enclosed : '';
	in_array('mv_supplier', $advppp_settings_mv_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . html_entity_decode($result['suppliers'] !== NULL ? $result['suppliers'] : '') . $csv_enclosed : '';
	...
	in_array('mv_price', $advppp_settings_mv_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['price_raw'], 2)) . " [" . rtrim($oprice, "; ") . "]" . $csv_enclosed : '';				
	} else {
	in_array('mv_price', $advppp_settings_mv_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['price_raw'], 2)) . $csv_enclosed : '';	
	}
	} else {
	in_array('mv_price', $advppp_settings_mv_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['price_raw'], 2)) . $csv_enclosed : '';	
	}	
	...
	in_array('mv_cost', $advppp_settings_mv_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round(-$result['cost_raw'], 2)) . " [" . rtrim($ocost, "; ") . "]" . $csv_enclosed : '';				
	} else {
	in_array('mv_cost', $advppp_settings_mv_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round(-$result['cost_raw'], 2)) . $csv_enclosed : '';	
	}
	} else {
	in_array('mv_cost', $advppp_settings_mv_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round(-$result['cost_raw'], 2)) . $csv_enclosed : '';	
	}	
	in_array('mv_profit', $advppp_settings_mv_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['profit_raw'], 2)) . $csv_enclosed : '';
	...
	in_array('mv_sold_percent', $advppp_settings_mv_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . ($result['sold_quantity'] != 0 ? round(100 * ($result['sold_quantity'] / $result['sold_quantity_total']), 2) : round((0), 2)) . '%' . $csv_enclosed : '';	
	in_array('mv_total_excl_vat', $advppp_settings_mv_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['total_excl_vat_raw'] !== NULL ? $result['total_excl_vat_raw'] : 0, 2)) . $csv_enclosed : '';
	in_array('mv_total_tax', $advppp_settings_mv_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['total_tax_raw'] !== NULL ? $result['total_tax_raw'] : 0, 2)) . $csv_enclosed : '';
	in_array('mv_total_incl_vat', $advppp_settings_mv_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['total_incl_vat_raw'] !== NULL ? $result['total_incl_vat_raw'] : 0, 2)) . $csv_enclosed : '';
	in_array('mv_app', $advppp_settings_mv_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['app_raw'] !== NULL ? $result['app_raw'] : 0, 2)) . $csv_enclosed : '';
	in_array('mv_discount', $advppp_settings_mv_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['discount_raw'] !== NULL ? $result['discount_raw'] : 0, 2)) . $csv_enclosed : '';
	if ($this->config->get('advppp' . $user_id . '_formula_6')) {
	in_array('mv_refunds', $advppp_settings_mv_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . ($result['refunds_raw'] != NULL ? sprintf('%0.2f', round(-$result['refunds_raw'], 2)) : sprintf('%0.2f', round('0', 2))) . $csv_enclosed : '';
	} else {
	in_array('mv_refunds', $advppp_settings_mv_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . ($result['refunds_raw'] != NULL ? sprintf('%0.2f', round($result['refunds_raw'], 2)) : sprintf('%0.2f', round('0', 2))) . $csv_enclosed : '';
	}		
	...
	in_array('mv_total_sales', $advppp_settings_mv_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['total_sales_raw'] !== NULL ? $result['total_sales_raw'] : 0, 2)) . $csv_enclosed : '';	
	in_array('mv_total_costs', $advppp_settings_mv_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['total_costs_raw'] !== NULL ? -$result['total_costs_raw'] : 0, 2)) . $csv_enclosed : '';	
	in_array('mv_total_profit', $advppp_settings_mv_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['total_profit_raw'] !== NULL ? $result['total_profit_raw'] : 0, 2)) . $csv_enclosed : '';
	if ($result['sold_quantity'] > 0) {
	...
	if ($filter_report == 'manufacturers' or $filter_report == 'categories' or $filter_report == 'suppliers' or $filter_report == 'products_options') {
	in_array('pl_prod_order_id', $advppp_settings_pl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('pl_prod_date_added', $advppp_settings_pl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';	
	in_array('pl_prod_inv_no', $advppp_settings_pl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';	
	in_array('pl_prod_id', $advppp_settings_pl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';	
	in_array('pl_prod_sku', $advppp_settings_pl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';	
	in_array('pl_prod_model', $advppp_settings_pl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';	
	in_array('pl_prod_name', $advppp_settings_pl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';	
	in_array('pl_prod_option', $advppp_settings_pl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';	
	if ($filter_report == 'manufacturers') {
	in_array('pl_prod_category', $advppp_settings_pl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';	
	in_array('pl_prod_supplier', $advppp_settings_pl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';	
	} elseif ($filter_report == 'categories') {
	in_array('pl_prod_manu', $advppp_settings_pl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('pl_prod_supplier', $advppp_settings_pl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	} elseif ($filter_report == 'suppliers') {
	in_array('pl_prod_category', $advppp_settings_pl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('pl_prod_manu', $advppp_settings_pl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	...
	in_array('pl_prod_attributes', $advppp_settings_pl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('pl_prod_currency', $advppp_settings_pl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('pl_prod_price', $advppp_settings_pl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('pl_prod_quantity', $advppp_settings_pl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('pl_prod_total_excl_vat', $advppp_settings_pl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('pl_prod_tax', $advppp_settings_pl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('pl_prod_total_incl_vat', $advppp_settings_pl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('pl_prod_sales', $advppp_settings_pl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('pl_prod_cost', $advppp_settings_pl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('pl_prod_profit', $advppp_settings_pl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('pl_prod_profit_margin', $advppp_settings_pl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('pl_prod_profit_markup', $advppp_settings_pl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	} else {
	in_array('ol_order_order_id', $advppp_settings_ol_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('ol_order_date_added', $advppp_settings_ol_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('ol_order_inv_no', $advppp_settings_ol_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('ol_order_customer', $advppp_settings_ol_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('ol_order_email', $advppp_settings_ol_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('ol_order_customer_group', $advppp_settings_ol_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('ol_order_shipping_method', $advppp_settings_ol_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('ol_order_payment_method', $advppp_settings_ol_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('ol_order_status', $advppp_settings_ol_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('ol_order_store', $advppp_settings_ol_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('ol_order_currency', $advppp_settings_ol_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('ol_prod_price', $advppp_settings_ol_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('ol_prod_quantity', $advppp_settings_ol_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('ol_prod_total_excl_vat', $advppp_settings_ol_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('ol_prod_tax', $advppp_settings_ol_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('ol_prod_total_incl_vat', $advppp_settings_ol_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('ol_prod_sales', $advppp_settings_ol_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('ol_prod_cost', $advppp_settings_ol_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('ol_prod_profit', $advppp_settings_ol_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('ol_prod_profit_margin', $advppp_settings_ol_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('ol_prod_profit_markup', $advppp_settings_ol_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	}
	in_array('cl_customer_cust_id', $advppp_settings_cl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('cl_billing_name', $advppp_settings_cl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';	
	in_array('cl_billing_company', $advppp_settings_cl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';	
	in_array('cl_billing_address_1', $advppp_settings_cl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';	
	in_array('cl_billing_address_2', $advppp_settings_cl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';	
	in_array('cl_billing_city', $advppp_settings_cl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';	
	in_array('cl_billing_zone', $advppp_settings_cl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';	
	in_array('cl_billing_postcode', $advppp_settings_cl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';	
	in_array('cl_billing_country', $advppp_settings_cl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';	
	in_array('cl_customer_telephone', $advppp_settings_cl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';	
	in_array('cl_shipping_name', $advppp_settings_cl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('cl_shipping_company', $advppp_settings_cl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('cl_shipping_address_1', $advppp_settings_cl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('cl_shipping_address_2', $advppp_settings_cl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('cl_shipping_city', $advppp_settings_cl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';	
	in_array('cl_shipping_zone', $advppp_settings_cl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('cl_shipping_postcode', $advppp_settings_cl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('cl_shipping_country', $advppp_settings_cl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	...
	in_array('cm_orders', $advppp_settings_cm_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('cm_customers', $advppp_settings_cm_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	...
	$export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed;
	in_array('mv_orders', $advppp_settings_mv_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('mv_customers', $advppp_settings_mv_columns) ?  $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	$export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed;
	$export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed;
	} else {
	...
	in_array('mv_upc', $advppp_settings_mv_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('mv_ean', $advppp_settings_mv_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('mv_jan', $advppp_settings_mv_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('mv_isbn', $advppp_settings_mv_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('mv_mpn', $advppp_settings_mv_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';

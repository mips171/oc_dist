<?php
	...
	if ($results) {
		...
		in_array('all_prod_upc', $advppp_settings_all_columns) ? $worksheet->setColumn($j,$j++,13) : '';
		in_array('all_prod_ean', $advppp_settings_all_columns) ? $worksheet->setColumn($j,$j++,13) : '';
		in_array('all_prod_jan', $advppp_settings_all_columns) ? $worksheet->setColumn($j,$j++,13) : '';
		in_array('all_prod_isbn', $advppp_settings_all_columns) ? $worksheet->setColumn($j,$j++,13) : '';
		in_array('all_prod_mpn', $advppp_settings_all_columns) ? $worksheet->setColumn($j,$j++,13) : '';
		...
		in_array('all_prod_option', $advppp_settings_all_columns) ? $worksheet->setColumn($j,$j++,25) : '';
		if (in_array('all_prod_option', $advppp_settings_all_columns)) {	
		if ($option_names) {
		...
		in_array('all_campaign_name', $advppp_settings_all_columns) ? $worksheet->setColumn($j,$j++,15) : '';
		in_array('all_campaign_code', $advppp_settings_all_columns) ? $worksheet->setColumn($j,$j++,15) : '';
		...
		in_array('all_prod_upc', $advppp_settings_all_columns) ? $worksheet->writeString($i, $j++, $this->language->get('column_prod_upc'), $boxFormatText) : '';
		in_array('all_prod_ean', $advppp_settings_all_columns) ? $worksheet->writeString($i, $j++, $this->language->get('column_prod_ean'), $boxFormatText) : '';
		in_array('all_prod_jan', $advppp_settings_all_columns) ? $worksheet->writeString($i, $j++, $this->language->get('column_prod_jan'), $boxFormatText) : '';
		in_array('all_prod_isbn', $advppp_settings_all_columns) ? $worksheet->writeString($i, $j++, $this->language->get('column_prod_isbn'), $boxFormatText) : '';
		in_array('all_prod_mpn', $advppp_settings_all_columns) ? $worksheet->writeString($i, $j++, $this->language->get('column_prod_mpn'), $boxFormatText) : '';
		...
		in_array('all_prod_option', $advppp_settings_all_columns) ? $worksheet->writeString($i, $j++, $this->language->get('column_prod_option'), $boxFormatText) : '';
		if (in_array('all_prod_option', $advppp_settings_all_columns)) {	
		$n = 0;
		if ($option_names) {
		foreach ($option_names as $option_name) {
		...
		in_array('all_campaign_name', $advppp_settings_all_columns) ? $worksheet->writeString($i, $j++, $this->language->get('column_campaign_name'), $boxFormatText) : '';
		in_array('all_campaign_code', $advppp_settings_all_columns) ? $worksheet->writeString($i, $j++, $this->language->get('column_campaign_code'), $boxFormatText) : '';
		...
		$j = 0;
			...
			$excelRow = $i+1;			
				...
				in_array('all_prod_upc', $advppp_settings_all_columns) ? $worksheet->write($i, $j++, $result['product_upc'], $textFormat) : '';
				in_array('all_prod_ean', $advppp_settings_all_columns) ? $worksheet->write($i, $j++, $result['product_ean'], $textFormat) : '';
				in_array('all_prod_jan', $advppp_settings_all_columns) ? $worksheet->write($i, $j++, $result['product_jan'], $textFormat) : '';
				in_array('all_prod_isbn', $advppp_settings_all_columns) ? $worksheet->write($i, $j++, $result['product_isbn'], $textFormat) : '';
				in_array('all_prod_mpn', $advppp_settings_all_columns) ? $worksheet->write($i, $j++, $result['product_mpn'], $textFormat) : '';
				...
				in_array('all_prod_option', $advppp_settings_all_columns) ? $worksheet->write($i, $j++, html_entity_decode($result['product_options'], ENT_COMPAT, 'UTF-8'), $textFormat) : '';
				if (in_array('all_prod_option', $advppp_settings_all_columns)) {
				$o = $j;
				...
				if ($result['product_profit_raw'] >= 0) {
				in_array('all_prod_profit_margin', $advppp_settings_all_columns) ? $worksheet->write($i, $j++, $result['product_profit_margin'], $percentColumnFormat) : '';
				} else {
				in_array('all_prod_profit_margin', $advppp_settings_all_columns) ? $worksheet->write($i, $j++, $result['product_profit_margin'], $nopercentColumnFormat) : '';
				}
				if ($result['product_profit_raw'] >= 0) {
				in_array('all_prod_profit_markup', $advppp_settings_all_columns) ? $worksheet->write($i, $j++, $result['product_profit_markup'], $percentColumnFormat) : '';
				} else {
				in_array('all_prod_profit_markup', $advppp_settings_all_columns) ? $worksheet->write($i, $j++, $result['product_profit_markup'], $nopercentColumnFormat) : '';
				}	
				}
				...
				if ($result['order_profit_raw'] >= 0) {
				in_array('all_order_profit_prc', $advppp_settings_all_columns) ? $worksheet->write($i, $j++, $result['order_profit_prc'], $percentColumnFormat) : '';
				} else {
				in_array('all_order_profit_prc', $advppp_settings_all_columns) ? $worksheet->write($i, $j++, $result['order_profit_prc'], $nopercentColumnFormat) : '';
				}
				...
				in_array('all_campaign_name', $advppp_settings_all_columns) ? $worksheet->write($i, $j++, $result['order_campaign_name'], $filter_report != 'products_abandoned_orders' ? $textFormat : $abtextFormat) : '';
				in_array('all_campaign_code', $advppp_settings_all_columns) ? $worksheet->write($i, $j++, $result['order_campaign_code'], $filter_report != 'products_abandoned_orders' ? $textFormat : $abtextFormat) : '';

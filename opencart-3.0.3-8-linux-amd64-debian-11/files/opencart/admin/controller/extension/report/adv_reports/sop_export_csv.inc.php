<?php
	...
	in_array('tr_tax_name', $advsop_settings_tr_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . $this->language->get('column_tax_title') . $csv_enclosed : '';
	in_array('tr_tax_rate', $advsop_settings_tr_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . $this->language->get('column_tax_rate') . $csv_enclosed : '';
	in_array('tr_tax_orders', $advsop_settings_tr_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . $this->language->get('column_orders') . $csv_enclosed : '';
	in_array('tr_tax_total', $advsop_settings_tr_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . $this->language->get('column_tax_total') . $csv_enclosed : '';
	...
	in_array('tr_tax_name', $advsop_settings_tr_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . $result['tax_title'] . $csv_enclosed : '';
	in_array('tr_tax_rate', $advsop_settings_tr_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . $result['tax_rate'] . $csv_enclosed : '';
	in_array('tr_tax_orders', $advsop_settings_tr_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . $result['orders'] . $csv_enclosed : '';
	in_array('tr_tax_total', $advsop_settings_tr_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['total_tax_raw'], 2)) . $csv_enclosed : '';

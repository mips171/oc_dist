<?php
	...
	in_array('scw_upc', $advppp_settings_scw_columns) ? $c++ . $export_html .= "<td align='left'>".$this->language->get('column_upc')."</td>" : '';
	in_array('scw_ean', $advppp_settings_scw_columns) ? $c++ . $export_html .= "<td align='left'>".$this->language->get('column_ean')."</td>" : '';
	in_array('scw_jan', $advppp_settings_scw_columns) ? $c++ . $export_html .= "<td align='left'>".$this->language->get('column_jan')."</td>" : '';
	in_array('scw_isbn', $advppp_settings_scw_columns) ? $c++ . $export_html .= "<td align='left'>".$this->language->get('column_isbn')."</td>" : '';
	in_array('scw_mpn', $advppp_settings_scw_columns) ? $c++ . $export_html .= "<td align='left'>".$this->language->get('column_mpn')."</td>" : '';
	...
	in_array('pnp_upc', $advppp_settings_pnp_columns) ? $export_html .= "<td align='left'>".$this->language->get('column_upc')."</td>" : '';
	in_array('pnp_ean', $advppp_settings_pnp_columns) ? $export_html .= "<td align='left'>".$this->language->get('column_ean')."</td>" : '';
	in_array('pnp_jan', $advppp_settings_pnp_columns) ? $export_html .= "<td align='left'>".$this->language->get('column_jan')."</td>" : '';
	in_array('pnp_isbn', $advppp_settings_pnp_columns) ? $export_html .= "<td align='left'>".$this->language->get('column_isbn')."</td>" : '';
	in_array('pnp_mpn', $advppp_settings_pnp_columns) ? $export_html .= "<td align='left'>".$this->language->get('column_mpn')."</td>" : '';
	...
	in_array('cm_orders', $advppp_settings_cm_columns) ? $export_html .= "<td align='right'>".$this->language->get('column_orders')."</td>" : '';
	in_array('cm_customers', $advppp_settings_cm_columns) ? $export_html .= "<td align='right'>".$this->language->get('column_customers')."</td>" : '';
	...
	in_array('mv_orders', $advppp_settings_mv_columns) ? $export_html .= "<td align='right'>".$this->language->get('column_orders')."</td>" : '';
	in_array('mv_customers', $advppp_settings_mv_columns) ? $export_html .= "<td align='right'>".$this->language->get('column_customers')."</td>" : '';
	...
	in_array('mv_upc', $advppp_settings_mv_columns) ? $export_html .= "<td align='left'>".$this->language->get('column_upc')."</td>" : '';
	in_array('mv_ean', $advppp_settings_mv_columns) ? $export_html .= "<td align='left'>".$this->language->get('column_ean')."</td>" : '';
	in_array('mv_jan', $advppp_settings_mv_columns) ? $export_html .= "<td align='left'>".$this->language->get('column_jan')."</td>" : '';
	in_array('mv_isbn', $advppp_settings_mv_columns) ? $export_html .= "<td align='left'>".$this->language->get('column_isbn')."</td>" : '';
	in_array('mv_mpn', $advppp_settings_mv_columns) ? $export_html .= "<td align='left'>".$this->language->get('column_mpn')."</td>" : '';
	...
	in_array('scw_upc', $advppp_settings_scw_columns) ? $export_html .= "<td align='left'>".$result['upc']."</td>" : '';
	in_array('scw_ean', $advppp_settings_scw_columns) ? $export_html .= "<td align='left'>".$result['ean']."</td>" : '';
	in_array('scw_jan', $advppp_settings_scw_columns) ? $export_html .= "<td align='left'>".$result['jan']."</td>" : '';
	in_array('scw_isbn', $advppp_settings_scw_columns) ? $export_html .= "<td align='left'>".$result['isbn']."</td>" : '';
	in_array('scw_mpn', $advppp_settings_scw_columns) ? $export_html .= "<td align='left'>".$result['mpn']."</td>" : '';
	...
	in_array('pnp_upc', $advppp_settings_pnp_columns) ? $export_html .= "<td align='left'>".$result['upc']."</td>" : '';
	in_array('pnp_ean', $advppp_settings_pnp_columns) ? $export_html .= "<td align='left'>".$result['ean']."</td>" : '';
	in_array('pnp_jan', $advppp_settings_pnp_columns) ? $export_html .= "<td align='left'>".$result['jan']."</td>" : '';
	in_array('pnp_isbn', $advppp_settings_pnp_columns) ? $export_html .= "<td align='left'>".$result['isbn']."</td>" : '';
	in_array('pnp_mpn', $advppp_settings_pnp_columns) ? $export_html .= "<td align='left'>".$result['mpn']."</td>" : '';
	...
	in_array('cm_orders', $advppp_settings_cm_columns) ? $export_html .= "<td align='right'>".$result['orders']."</td>" : '';
	in_array('cm_customers', $advppp_settings_cm_columns) ? $export_html .= "<td align='right'>".$result['customers']."</td>" : '';
	...
	in_array('mv_orders', $advppp_settings_mv_columns) ? $export_html .= "<td align='right'>".$result['orders']."</td>" : '';
	in_array('mv_customers', $advppp_settings_mv_columns) ? $export_html .= "<td align='right'>".$result['customers']."</td>" : '';
	...
	in_array('mv_upc', $advppp_settings_mv_columns) ? $export_html .= "<td align='left'>".$result['upc']."</td>" : '';
	in_array('mv_ean', $advppp_settings_mv_columns) ? $export_html .= "<td align='left'>".$result['ean']."</td>" : '';
	in_array('mv_jan', $advppp_settings_mv_columns) ? $export_html .= "<td align='left'>".$result['jan']."</td>" : '';
	in_array('mv_isbn', $advppp_settings_mv_columns) ? $export_html .= "<td align='left'>".$result['isbn']."</td>" : '';
	in_array('mv_mpn', $advppp_settings_mv_columns) ? $export_html .= "<td align='left'>".$result['mpn']."</td>" : '';
	...
	in_array('mv_price', $advppp_settings_mv_columns) ? $export_html .= "<td align='right' nowrap='nowrap' style='background-color:#f1f9e9;'>".$result['price']."" : '';
	if ($filter_report == 'products_purchased_with_options' or $filter_report == 'products_abandoned_orders') {
	if ($result['option']) {
	foreach ($result['option'] as $option) {
	in_array('mv_price', $advppp_settings_mv_columns) ? $export_html .= "<br /><small>".$option['fprice']."</small>" : '';		
	}
	}
	}	
	in_array('mv_price', $advppp_settings_mv_columns) ? $export_html .= "</td>" : '';
	in_array('mv_cost', $advppp_settings_mv_columns) ? $export_html .= "<td align='right' nowrap='nowrap' style='background-color:#f7e9e3;'>".$result['cost']."" : '';
	if ($filter_report == 'products_purchased_with_options' or $filter_report == 'products_abandoned_orders') {
	if ($result['option']) {
	foreach ($result['option'] as $option) {
	in_array('mv_cost', $advppp_settings_mv_columns) ? $export_html .= "<br /><small>".$option['fcost']."</small>" : '';		
	}
	}
	}	
	in_array('mv_cost', $advppp_settings_mv_columns) ? $export_html .= "</td>" : '';
	if ($result['profit_raw'] >= 0) {
	...
	in_array('mv_orders', $advppp_settings_mv_columns) ? $export_html .= "<td align='right' nowrap='nowrap'>".$result['orders']."</td>" : '';
	} else {
	in_array('mv_orders', $advppp_settings_mv_columns) ? $export_html .= "<td align='right' nowrap='nowrap' style='text-decoration:line-through;'>".$result['orders']."</td>" : '';
	}
	if ($filter_report != 'products_abandoned_orders') {
	in_array('mv_customers', $advppp_settings_mv_columns) ? $export_html .= "<td align='right' nowrap='nowrap'>".$result['customers']."</td>" : '';
	} else {
	in_array('mv_customers', $advppp_settings_mv_columns) ? $export_html .= "<td align='right' nowrap='nowrap' style='text-decoration:line-through;'>".$result['customers']."</td>" : '';
	}
	if ($filter_report != 'products_abandoned_orders') {
	...
	in_array('cm_orders', $advppp_settings_cm_columns) ? $export_html .= "<td style='background-color:#E5E5E5;'></td>" : '';	
	in_array('cm_customers', $advppp_settings_cm_columns) ? $export_html .= "<td style='background-color:#E5E5E5;'></td>" : '';	
	...
	in_array('mv_orders', $advppp_settings_mv_columns) ? $export_html .= "<td style='background-color:#E5E5E5;'></td>" : '';
	in_array('mv_customers', $advppp_settings_mv_columns) ? $export_html .= "<td style='background-color:#E5E5E5;'></td>" : '';
	...
	in_array('mv_upc', $advppp_settings_mv_columns) ? $export_html .= "<td style='background-color:#E5E5E5;'></td>" : '';
	in_array('mv_ean', $advppp_settings_mv_columns) ? $export_html .= "<td style='background-color:#E5E5E5;'></td>" : '';
	in_array('mv_jan', $advppp_settings_mv_columns) ? $export_html .= "<td style='background-color:#E5E5E5;'></td>" : '';
	in_array('mv_isbn', $advppp_settings_mv_columns) ? $export_html .= "<td style='background-color:#E5E5E5;'></td>" : '';
	in_array('mv_mpn', $advppp_settings_mv_columns) ? $export_html .= "<td style='background-color:#E5E5E5;'></td>" : '';

<?php
	...
	$tax_names = $this->model_extension_report_adv_products_profit->getOrderTaxNames();
	...
	$this->objPHPExcel->getProperties()->setCreator("ADV Reports & Statistics")
									   ...
									   ->setDescription("ADV Products Profit Report with All Details")
	...
	if ($export_logo_criteria ? $this->mainCounter = 2 : $this->mainCounter = 1) {
		 ...
		 if (in_array('all_order_inv_no', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_order_customer_name', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_order_email', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_order_customer_group', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if ($filter_details == 'all_details_products') {
		 if (in_array('all_prod_id', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_prod_sku', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);		 
		 ...
		 if (in_array('all_prod_upc', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);		 
		 ...
		 if (in_array('all_prod_ean', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);		 
		 ...
		 if (in_array('all_prod_jan', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);		 
		 ...
		 if (in_array('all_prod_isbn', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);		 
		 ...
		 if (in_array('all_prod_mpn', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);		 
		 ...
		 if (in_array('all_prod_model', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_prod_name', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_prod_attributes', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_prod_category', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_prod_manu', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_prod_supplier', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_prod_currency', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if ($filter_details == 'all_details_products') {
		 if (in_array('all_prod_price', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_prod_quantity', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_prod_total_excl_vat', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_prod_tax', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_prod_total_incl_vat', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_prod_discount', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 $this->objPHPExcel->getActiveSheet()->setCellValue($col . $this->mainCounter, $this->language->get('column_prod_discount'));
		 $this->objPHPExcel->getActiveSheet()->getStyle($col . $this->mainCounter)->getFont()->setBold(true);		 
		 $this->objPHPExcel->getActiveSheet()->getStyle($col . $this->mainCounter)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);		 
		 $this->objPHPExcel->getActiveSheet()->getColumnDimension($col)->setAutoSize(true);
		 }

		 if (in_array('all_prod_qty_refund', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_prod_refund', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_prod_reward_points', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_prod_sales', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_prod_cost', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_prod_profit', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_prod_profit_margin', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_prod_profit_markup', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_sub_total', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_handling', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_loworder', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_shipping', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_reward', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_reward_points', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_coupon', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_coupon_name', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_coupon_code', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_credit', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_voucher', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_voucher_code', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_discount', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_order_value', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_refund', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_order_sales', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_order_prod_costs', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 $this->objPHPExcel->getActiveSheet()->setCellValue($col . $this->mainCounter, $this->language->get('column_order_prod_costs'));
		 $this->objPHPExcel->getActiveSheet()->getStyle($col . $this->mainCounter)->getFont()->setBold(true);		 
		 $this->objPHPExcel->getActiveSheet()->getStyle($col . $this->mainCounter)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);		 
		 $this->objPHPExcel->getActiveSheet()->getColumnDimension($col)->setAutoSize(true);	
		 }

		 if (in_array('all_order_commission', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_order_payment_cost', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 $this->objPHPExcel->getActiveSheet()->setCellValue($col . $this->mainCounter, $this->language->get('column_order_payment_cost'));
		 $this->objPHPExcel->getActiveSheet()->getStyle($col . $this->mainCounter)->getFont()->setBold(true);		 
		 $this->objPHPExcel->getActiveSheet()->getStyle($col . $this->mainCounter)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);		 
		 $this->objPHPExcel->getActiveSheet()->getColumnDimension($col)->setAutoSize(true);	
		 }

		 if (in_array('all_order_shipping_cost', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 $this->objPHPExcel->getActiveSheet()->setCellValue($col . $this->mainCounter, $this->language->get('column_order_shipping_cost'));
		 $this->objPHPExcel->getActiveSheet()->getStyle($col . $this->mainCounter)->getFont()->setBold(true);		 
		 $this->objPHPExcel->getActiveSheet()->getStyle($col . $this->mainCounter)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);		 
		 $this->objPHPExcel->getActiveSheet()->getColumnDimension($col)->setAutoSize(true);	
		 }

		 if (in_array('all_order_extra_cost', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 $this->objPHPExcel->getActiveSheet()->setCellValue($col . $this->mainCounter, $this->language->get('column_order_extra_cost'));
		 $this->objPHPExcel->getActiveSheet()->getStyle($col . $this->mainCounter)->getFont()->setBold(true);		 
		 $this->objPHPExcel->getActiveSheet()->getStyle($col . $this->mainCounter)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);		 
		 $this->objPHPExcel->getActiveSheet()->getColumnDimension($col)->setAutoSize(true);	
		 }

		 if (in_array('all_order_return_cost', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 $this->objPHPExcel->getActiveSheet()->setCellValue($col . $this->mainCounter, $this->language->get('column_order_return_cost'));
		 $this->objPHPExcel->getActiveSheet()->getStyle($col . $this->mainCounter)->getFont()->setBold(true);		 
		 $this->objPHPExcel->getActiveSheet()->getStyle($col . $this->mainCounter)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);		 
		 $this->objPHPExcel->getActiveSheet()->getColumnDimension($col)->setAutoSize(true);	
		 }

		 if (in_array('all_shipping_balance', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_order_costs', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_order_profit', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_order_profit_prc', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_order_shipping_method', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_order_payment_method', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_order_status', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_order_store', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_campaign_name', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_campaign_code', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_customer_cust_id', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_billing_first_name', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_billing_last_name', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_billing_company', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_billing_address_1', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_billing_address_2', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_billing_city', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_billing_zone', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_billing_zone_id', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_billing_zone_code', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_billing_postcode', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_billing_country', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_billing_country_id', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_billing_country_code', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_customer_telephone', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_shipping_first_name', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_shipping_last_name', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_shipping_company', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_shipping_address_1', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_shipping_address_2', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_shipping_city', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_shipping_zone', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_shipping_zone_id', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_shipping_zone_code', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_shipping_postcode', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_shipping_country', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_shipping_country_id', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_shipping_country_code', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_order_weight', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_order_comment', $advppp_settings_all_columns)) {
		 $col = PHPExcel_Cell::stringFromColumnIndex($j++);
	...
	foreach ($results as $result) {
		...
		if (in_array('all_prod_supplier', $advppp_settings_all_columns)) {
		$col = PHPExcel_Cell::stringFromColumnIndex($j++);
		$this->objPHPExcel->getActiveSheet()->setCellValue($col . $counter, html_entity_decode($result['product_supplier'], ENT_COMPAT, 'UTF-8'));
		}
		}
		...
		$col = PHPExcel_Cell::stringFromColumnIndex($j++);
		$this->objPHPExcel->getActiveSheet()->getStyle($col . $counter)->getNumberFormat()->setFormatCode('0.00');
		$this->objPHPExcel->getActiveSheet()->setCellValue($col . $counter, $result['product_discount_raw']);
		if ($filter_report == 'products_abandoned_orders') {
		$this->objPHPExcel->getActiveSheet()->getStyle($col . $counter)->getFont()->applyFromArray(array('strike' => true));
		}			
		}
		...
		$col = PHPExcel_Cell::stringFromColumnIndex($j++);
		$this->objPHPExcel->getActiveSheet()->getStyle($col . $counter)->getNumberFormat()->setFormatCode('0.00');
		$this->objPHPExcel->getActiveSheet()->setCellValue($col . $counter, $result['product_sales_raw']);
		if ($filter_report == 'products_abandoned_orders') {
		$this->objPHPExcel->getActiveSheet()->getStyle($col . $counter)->getFont()->applyFromArray(array('strike' => true));
		}			
		}
		...
		$col = PHPExcel_Cell::stringFromColumnIndex($j++);
		$this->objPHPExcel->getActiveSheet()->getStyle($col . $counter)->getNumberFormat()->setFormatCode('0.00');
		$this->objPHPExcel->getActiveSheet()->setCellValue($col . $counter, -$result['product_cost_raw']);
		if ($filter_report == 'products_abandoned_orders') {
		$this->objPHPExcel->getActiveSheet()->getStyle($col . $counter)->getFont()->applyFromArray(array('strike' => true));
		}			
		}
		...
		$col = PHPExcel_Cell::stringFromColumnIndex($j++);
		$this->objPHPExcel->getActiveSheet()->getStyle($col . $counter)->getNumberFormat()->setFormatCode('0.00');
		$this->objPHPExcel->getActiveSheet()->setCellValue($col . $counter, $result['product_profit_raw']);
		if ($filter_report == 'products_abandoned_orders') {
		$this->objPHPExcel->getActiveSheet()->getStyle($col . $counter)->getFont()->applyFromArray(array('strike' => true));
		}			
		}
		...
		$this->objPHPExcel->getActiveSheet()->setCellValue($col . $counter, round($result['product_profit_margin'], 2)/100);
		if ($filter_report == 'products_abandoned_orders') {
		$this->objPHPExcel->getActiveSheet()->getStyle($col . $counter)->getFont()->applyFromArray(array('strike' => true));
		}			
		} else {
		...
		$this->objPHPExcel->getActiveSheet()->getStyle($col . $counter)->getNumberFormat()->applyFromArray(array('code' => PHPExcel_Style_NumberFormat::FORMAT_PERCENTAGE_00));		
		$this->objPHPExcel->getActiveSheet()->setCellValue($col . $counter, round($result['product_profit_markup'], 2)/100);
		if ($filter_report == 'products_abandoned_orders') {
		$this->objPHPExcel->getActiveSheet()->getStyle($col . $counter)->getFont()->applyFromArray(array('strike' => true));
		}			
		} else {
		...
		$col = PHPExcel_Cell::stringFromColumnIndex($j++);
		$this->objPHPExcel->getActiveSheet()->getStyle($col . $counter)->getNumberFormat()->setFormatCode('0.00');
		$this->objPHPExcel->getActiveSheet()->setCellValue($col . $counter, $result['order_discount_raw']);
		if ($filter_report == 'products_abandoned_orders') {
		$this->objPHPExcel->getActiveSheet()->getStyle($col . $counter)->getFont()->applyFromArray(array('strike' => true));
		}			
		}
		...
		$col = PHPExcel_Cell::stringFromColumnIndex($j++);
		$this->objPHPExcel->getActiveSheet()->getStyle($col . $counter)->getNumberFormat()->setFormatCode('0.00');
		$this->objPHPExcel->getActiveSheet()->setCellValue($col . $counter, $result['order_sales_raw']);
		if ($filter_report == 'products_abandoned_orders') {
		$this->objPHPExcel->getActiveSheet()->getStyle($col . $counter)->getFont()->applyFromArray(array('strike' => true));
		}			
		}
		...
		$col = PHPExcel_Cell::stringFromColumnIndex($j++);
		$this->objPHPExcel->getActiveSheet()->getStyle($col . $counter)->getNumberFormat()->setFormatCode('0.00');
		$this->objPHPExcel->getActiveSheet()->setCellValue($col . $counter, -$result['order_product_costs_raw']);
		if ($filter_report == 'products_abandoned_orders') {
		$this->objPHPExcel->getActiveSheet()->getStyle($col . $counter)->getFont()->applyFromArray(array('strike' => true));
		}			
		}
		...
		$col = PHPExcel_Cell::stringFromColumnIndex($j++);
		$this->objPHPExcel->getActiveSheet()->getStyle($col . $counter)->getNumberFormat()->setFormatCode('0.00');
		$this->objPHPExcel->getActiveSheet()->setCellValue($col . $counter, -$result['order_payment_cost_raw']);
		if ($filter_report == 'products_abandoned_orders') {
		$this->objPHPExcel->getActiveSheet()->getStyle($col . $counter)->getFont()->applyFromArray(array('strike' => true));
		}			
		}
		...
		$col = PHPExcel_Cell::stringFromColumnIndex($j++);
		$this->objPHPExcel->getActiveSheet()->getStyle($col . $counter)->getNumberFormat()->setFormatCode('0.00');
		$this->objPHPExcel->getActiveSheet()->setCellValue($col . $counter, -$result['order_shipping_cost_raw']);
		if ($filter_report == 'products_abandoned_orders') {
		$this->objPHPExcel->getActiveSheet()->getStyle($col . $counter)->getFont()->applyFromArray(array('strike' => true));
		}			
		}
		...
		$col = PHPExcel_Cell::stringFromColumnIndex($j++);
		$this->objPHPExcel->getActiveSheet()->getStyle($col . $counter)->getNumberFormat()->setFormatCode('0.00');
		$this->objPHPExcel->getActiveSheet()->setCellValue($col . $counter, -$result['order_extra_cost_raw']);
		if ($filter_report == 'products_abandoned_orders') {
		$this->objPHPExcel->getActiveSheet()->getStyle($col . $counter)->getFont()->applyFromArray(array('strike' => true));
		}			
		}
		...
		$col = PHPExcel_Cell::stringFromColumnIndex($j++);
		$this->objPHPExcel->getActiveSheet()->getStyle($col . $counter)->getNumberFormat()->setFormatCode('0.00');
		$this->objPHPExcel->getActiveSheet()->setCellValue($col . $counter, -$result['order_return_cost_raw']);	
		if ($filter_report == 'products_abandoned_orders') {
		$this->objPHPExcel->getActiveSheet()->getStyle($col . $counter)->getFont()->applyFromArray(array('strike' => true));
		}			
		}
		...
		$col = PHPExcel_Cell::stringFromColumnIndex($j++);
		$this->objPHPExcel->getActiveSheet()->getStyle($col . $counter)->getNumberFormat()->setFormatCode('0.00');
		$this->objPHPExcel->getActiveSheet()->setCellValue($col . $counter, $result['order_ship_balance_raw']);
		if ($filter_report == 'products_abandoned_orders') {
		$this->objPHPExcel->getActiveSheet()->getStyle($col . $counter)->getFont()->applyFromArray(array('strike' => true));
		}			
		}
		...
		$col = PHPExcel_Cell::stringFromColumnIndex($j++);
		$this->objPHPExcel->getActiveSheet()->getStyle($col . $counter)->getNumberFormat()->setFormatCode('0.00');
		$this->objPHPExcel->getActiveSheet()->setCellValue($col . $counter, -$result['order_costs_raw']);
		if ($filter_report == 'products_abandoned_orders') {
		$this->objPHPExcel->getActiveSheet()->getStyle($col . $counter)->getFont()->applyFromArray(array('strike' => true));
		}			
		}
		...
		$col = PHPExcel_Cell::stringFromColumnIndex($j++);
		$this->objPHPExcel->getActiveSheet()->getStyle($col . $counter)->getNumberFormat()->setFormatCode('0.00');
		$this->objPHPExcel->getActiveSheet()->setCellValue($col . $counter, $result['order_profit_raw']);
		if ($filter_report == 'products_abandoned_orders') {
		$this->objPHPExcel->getActiveSheet()->getStyle($col . $counter)->getFont()->applyFromArray(array('strike' => true));
		}			
		}
		...
		$this->objPHPExcel->getActiveSheet()->getStyle($col . $counter)->getNumberFormat()->applyFromArray(array('code' => PHPExcel_Style_NumberFormat::FORMAT_PERCENTAGE_00));		
		$this->objPHPExcel->getActiveSheet()->setCellValue($col . $counter, round($result['order_profit_prc'], 2)/100);
		if ($filter_report == 'products_abandoned_orders') {
		$this->objPHPExcel->getActiveSheet()->getStyle($col . $counter)->getFont()->applyFromArray(array('strike' => true));
		}			
		} else {

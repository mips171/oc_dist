...
<div id="content">
  ...
  <div class="container-fluid">
    <div class="panel panel-default">
	  ...
	  <button type="button" onclick="window.open('http://www.opencartreports.com/documentation/sop/index.html');" title="<?php echo $button_documentation; ?>" class="btn btn-warning" style="margin-bottom:10px;"><i class="fa fa-book"></i> <?php echo $button_documentation; ?></button>&nbsp;
      <div class="row">
...
<div class="well">
    ...
    <div id="filters" class="row filters-switcher <?php echo (isset($_COOKIE['show-sop-filters']) && $_COOKIE['show-sop-filters'] == 1) ? '' : 'row hide-filters'; ?>">     
      <?php if (in_array('store', $advsop_settings_filters)) { ?>
	  ...
	  <?php } ?>
	  <?php if (in_array('currency', $advsop_settings_filters)) { ?>  
    	<div class="col-lg-2" style="height:75px;">
	  ...
	  <?php } ?>
	  <?php if (in_array('tax', $advsop_settings_filters)) { ?>
    	<div class="col-lg-2" style="height:75px;">
	  ...
	  <?php } ?>
	  <?php if (in_array('tax_class', $advsop_settings_filters)) { ?>
    	<div class="col-lg-2" style="height:75px;">
	  ...
	  <?php } ?>
	  <?php if (in_array('geo_zone', $advsop_settings_filters)) { ?>
    	<div class="col-lg-2" style="height:75px;">
	  ...
	  <?php } ?>
	  <?php if (in_array('customer_group', $advsop_settings_filters)) { ?>
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>
      <?php if (in_array('customer_name', $advsop_settings_filters)) { ?>
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>
      <?php if (in_array('customer_email', $advsop_settings_filters)) { ?>
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>   
      <?php if (in_array('customer_telephone', $advsop_settings_filters)) { ?>
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>
      <?php if (in_array('ip', $advsop_settings_filters)) { ?>
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>
      <?php if (in_array('payment_company', $advsop_settings_filters)) { ?>
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>
      <?php if (in_array('payment_address', $advsop_settings_filters)) { ?>
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>
      <?php if (in_array('payment_city', $advsop_settings_filters)) { ?>
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>
      <?php if (in_array('payment_zone', $advsop_settings_filters)) { ?>
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>
      <?php if (in_array('payment_postcode', $advsop_settings_filters)) { ?>
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>
      <?php if (in_array('payment_country', $advsop_settings_filters)) { ?>
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>
      <?php if (in_array('payment_method', $advsop_settings_filters)) { ?>
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>
      <?php if (in_array('shipping_company', $advsop_settings_filters)) { ?>
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>
      <?php if (in_array('shipping_address', $advsop_settings_filters)) { ?>      
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>
      <?php if (in_array('shipping_city', $advsop_settings_filters)) { ?>      
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>
      <?php if (in_array('shipping_zone', $advsop_settings_filters)) { ?>      
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>
      <?php if (in_array('shipping_postcode', $advsop_settings_filters)) { ?>      
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>
      <?php if (in_array('shipping_country', $advsop_settings_filters)) { ?>      
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>
      <?php if (in_array('shipping_method', $advsop_settings_filters)) { ?>      
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>
      <?php if (in_array('category', $advsop_settings_filters)) { ?>      
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>
      <?php if (in_array('manufacturer', $advsop_settings_filters)) { ?>      
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>
      <?php if (in_array('supplier', $advsop_settings_filters)) { ?>      
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>
      <?php if (in_array('product', $advsop_settings_filters)) { ?>      
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>              
      <?php if (in_array('sku', $advsop_settings_filters)) { ?>      
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>
      <?php if (in_array('model', $advsop_settings_filters)) { ?>      
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>
      <?php if (in_array('option', $advsop_settings_filters)) { ?>      
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>
      <?php if (in_array('attribute', $advsop_settings_filters)) { ?>      
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>
      <?php if (in_array('location', $advsop_settings_filters)) { ?>      
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>
      <?php if (in_array('coupon_name', $advsop_settings_filters)) { ?>      
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>
      <?php if (in_array('coupon_code', $advsop_settings_filters)) { ?>      
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>
      <?php if (in_array('voucher_code', $advsop_settings_filters)) { ?>      
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>
      <?php if (in_array('campaign_name', $advsop_settings_filters)) { ?>      
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>
      <?php if (in_array('campaign_code', $advsop_settings_filters)) { ?>      
    	<div class="col-lg-2" style="height:75px;">
    ...
    <div class="modal-content" id="modal-content">
      ...
      <div><?php echo $text_load_save; ?></div><br />
        <table width="100%" id="adv_load_save" class="table table-bordered table-hover">
          ...
          <?php if ($advsop_load_save_reports) { ?>
		   <?php $adv_load_save_reports_row = 0; ?>
			<?php foreach ($advsop_load_save_reports as $advsop_load_save_report) { ?>
			  <tbody id="adv_load_save_reports_row<?php echo $adv_load_save_reports_row; ?>">
				<tr> 
				  ...
				  <td width="45%" class="text-left"><input type="text" name="advsop_load_save_report[<?php echo $adv_load_save_reports_row; ?>][save_report_title]" value="<?php echo $advsop_load_save_report['save_report_title']; ?>" placeholder="<?php echo $text_report_title; ?>" class="form-control" /></td>
				  <td width="40%" class="text-left"><textarea readonly name="advsop_load_save_report[<?php echo $adv_load_save_reports_row; ?>][save_report_link]" class="form-control"><?php echo $advsop_load_save_report['save_report_link']; ?></textarea></td>    
				  <td width="10%" class="text-center"><button type="button" onclick="location = '<?php echo ($report_link . str_replace('index.php?route=extension/report/adv_sales_profit', '', $advsop_load_save_report['save_report_link'])); ?>'" title="<?php echo $button_load; ?> Report" class="btn btn-primary"><i class="fa fa-circle-o-notch"></i> <?php echo $button_load; ?></button></td>                                
				</tr>             
			  </tbody>
  ...
  <div class="modal-dialog modal-lg modal-info">
    <div class="modal-content" id="modal-content">
      ...
      <fieldset>
        ...
        <div class="text-danger">* <?php echo $text_export_notice1; ?> <a href="http://www.opencartreports.com/documentation/sop/index.html#req_limit" target="_blank"><strong><?php echo $text_export_limit; ?></strong></a> <?php echo $text_export_notice2; ?></div>      
		</fieldset>
        <div align="right">
		  <button type="button" class="btn btn-default" title="<?php echo $button_close; ?>" data-dismiss="modal"><i class="fa fa-close"></i> <?php echo $button_close; ?></button>
      ...
      <fieldset>
		...
		<div class="row" style="padding:2px;">
			<div class="col-sm-12"><div class="input-group" style="width:100%;">
				...
				<select name="advsop<?php echo $user; ?>_formula_1" data-style="btn-select" data-width="15%" class="select">
					<?php if ($advsop_formula_1) { ?>
		...
		<div class="row" style="padding:2px;">                                
			<div class="col-sm-12"><div class="input-group" style="width:100%;">
				...
				<select name="advsop<?php echo $user; ?>_formula_2" data-style="btn-select" data-width="15%" class="select">
					<?php if ($advsop_formula_2) { ?>
					<option value="1" selected="selected"><?php echo $text_yes; ?></option>
					<option value="0"><?php echo $text_no; ?></option>
					<?php } else { ?>
					<option value="1"><?php echo $text_yes; ?></option>
		...
		<div class="row" style="padding:2px;">                                     
			<div class="col-sm-12"><div class="input-group" style="width:100%;">
				...
				<select name="advsop<?php echo $user; ?>_formula_3" data-style="btn-select" data-width="15%" class="select">
    				<?php if ($advsop_formula_3) { ?>
					<option value="1" selected="selected"><?php echo $text_yes; ?></option>
					<option value="0"><?php echo $text_no; ?></option>
					<?php } else { ?>
					<option value="1"><?php echo $text_yes; ?></option>
		...
		<div class="row" style="padding:2px;">                                     
			<div class="col-sm-12"><div class="input-group" style="width:100%;">
				...
				<select name="advsop<?php echo $user; ?>_formula_4" data-style="btn-select" data-width="15%" class="select">
    				<?php if ($advsop_formula_4) { ?>
					<option value="1" selected="selected"><?php echo $text_yes; ?></option>
					<option value="0"><?php echo $text_no; ?></option>
					<?php } else { ?>
					<option value="1"><?php echo $text_yes; ?></option>
		...
		<div class="row" style="padding:2px;">
			<div class="col-sm-12"><div class="input-group" style="width:100%;">
				...
				<select name="advsop<?php echo $user; ?>_formula_5" data-style="btn-select" data-width="15%" class="select">
    				<?php if ($advsop_formula_5) { ?>
					<option value="1" selected="selected"><?php echo $text_yes; ?></option>
					<option value="0"><?php echo $text_no; ?></option>
					<?php } else { ?>
					<option value="1"><?php echo $text_yes; ?></option>
		...
		<div class="row" style="padding:2px;">
			<div class="col-sm-12"><div class="input-group" style="width:100%;">
				...
				<select name="advsop<?php echo $user; ?>_formula_6" data-style="btn-select" data-width="10%" class="select">
    				<?php if ($advsop_formula_6) { ?>
					<option value="1" selected="selected"><?php echo $text_yes; ?></option>
					<option value="0"><?php echo $text_no; ?></option>
					<?php } else { ?>
					<option value="1"><?php echo $text_yes; ?></option>
                ...
                <span class="input-group-addon" style="width:13%; white-space:normal; text-align:left;"><?php echo $text_return_action; ?></span>
                  <select name="advsop<?php echo $user; ?>_return_action_refund" data-style="btn-select" data-width="15%" class="select">
                    <option value="0"></option>
                    <?php foreach ($return_actions as $return_action) { ?>
                    <?php if ($return_action['return_action_id'] == $advsop_return_action_refund) { ?>
		...
		<div class="row" style="padding:2px; padding-bottom:20px;">
			<div class="col-sm-12"><div class="input-group" style="width:100%;">
				...
				<select name="advsop<?php echo $user; ?>_formula_7" data-style="btn-select" data-width="15%" class="select">
    				<?php if ($advsop_formula_7) { ?>
					<option value="1" selected="selected"><?php echo $text_yes; ?></option>
					<option value="0"><?php echo $text_no; ?></option>
					<?php } else { ?>
					<option value="1"><?php echo $text_yes; ?></option>
		...
		<div class="row" style="padding:2px; padding-bottom:20px;">
			<div class="col-lg-4"><div class="input-group" style="width:100%;">
				...
				<select name="advsop<?php echo $user; ?>_date_format" data-style="btn-select" data-width="55%" class="select">
					<?php if ($advsop_date_format == 'DDMMYYYY') { ?>
			...
			<div class="col-lg-4"><div class="input-group" style="width:100%;">
				...
				<select name="advsop<?php echo $user; ?>_hour_format" data-style="btn-select" data-width="55%" class="select">
					<?php if ($advsop_hour_format == '24') { ?>
			...
			<div class="col-lg-4"><div class="input-group" style="width:100%;">
				...
				<select name="advsop<?php echo $user; ?>_week_days" data-style="btn-select" data-width="55%" class="select">
					<?php if ($advsop_week_days == 'mon_sun') { ?>
		...
		<div id="checkbox_filter" class="row">
			<div class="col-sm-12">
				<div class="well well-sm" style="background:#f5f5f5; height:280px; overflow:auto;">
                    ...
                    <input type="hidden" value="filters_null" name="advsop<?php echo $user; ?>_settings_filters[]" checked="checked"/>                 
					<?php foreach ($filters as $key => $filter) { ?>
						<div class="checkbox col-md-3">
						<label>
                        <?php if (in_array($key, $advsop_settings_filters)) { ?>
                        	<input type="checkbox" value="<?php echo $key; ?>" name="advsop<?php echo $user; ?>_settings_filters[]" checked="checked"/> <?php echo $filter; ?>
                        <?php } else { ?>
							<input type="checkbox" value="<?php echo $key; ?>" name="advsop<?php echo $user; ?>_settings_filters[]" /> <?php echo $filter; ?>
                        <?php } ?>
						</label>
						</div>
					<?php } ?>
		...
		<div id="checkbox_mv_column" class="row">
			<div class="col-sm-12">
				...
				<div class="well well-sm" style="background:#f5f5f5; height:230px; overflow:auto;">
                    ...
                    <input type="hidden" value="mv_null" name="advsop<?php echo $user; ?>_settings_mv_columns[]" checked="checked"/>               
					<?php foreach ($mv_columns as $key => $mv_column) { ?>
						<div class="checkbox col-md-3">
						<label>
                        <?php if (in_array($key, $advsop_settings_mv_columns)) { ?>
                        	<input type="checkbox" value="<?php echo $key; ?>" name="advsop<?php echo $user; ?>_settings_mv_columns[]" checked="checked"/> <?php echo $mv_column; ?>
                        <?php } else { ?>
							<input type="checkbox" value="<?php echo $key; ?>" name="advsop<?php echo $user; ?>_settings_mv_columns[]" /> <?php echo $mv_column; ?>
                        <?php } ?>
						</label>
						</div>
					<?php } ?>
...
<?php } else { ?>
					...
					<?php foreach ($mv_columns as $key => $mv_column) { ?>
                        <?php if (in_array($key, $advsop_settings_mv_columns)) { ?>
                        	<input type="hidden" value="<?php echo $key; ?>" name="advsop<?php echo $user; ?>_settings_mv_columns[]" checked="checked"/>
                        <?php } ?>
                    <?php } ?>
<?php } ?>
<?php if ($filter_report == 'tax') { ?>                    
		...
		<div id="checkbox_tr_column" class="row">
			<div class="col-sm-12">
				...
				<div class="well well-sm" style="background:#f5f5f5; height:90px; overflow:auto;">
                    ...
                    <input type="hidden" value="tr_null" name="advsop<?php echo $user; ?>_settings_tr_columns[]" checked="checked"/>               
					<?php foreach ($tr_columns as $key => $tr_column) { ?>
						<div class="checkbox col-md-3">
						<label>
                        <?php if (in_array($key, $advsop_settings_tr_columns)) { ?>
                        	<input type="checkbox" value="<?php echo $key; ?>" name="advsop<?php echo $user; ?>_settings_tr_columns[]" checked="checked"/> <?php echo $tr_column; ?>
                        <?php } else { ?>
							<input type="checkbox" value="<?php echo $key; ?>" name="advsop<?php echo $user; ?>_settings_tr_columns[]" /> <?php echo $tr_column; ?>
                        <?php } ?>
						</label>
						</div>
					<?php } ?>
...
<?php } else { ?>
					...
					<?php foreach ($tr_columns as $key => $tr_column) { ?>
                        <?php if (in_array($key, $advsop_settings_tr_columns)) { ?>
                        	<input type="hidden" value="<?php echo $key; ?>" name="advsop<?php echo $user; ?>_settings_tr_columns[]" checked="checked"/>
                        <?php } ?>
                    <?php } ?>
<?php } ?>  
		...
		<div id="checkbox_cr_column" class="row">
			<div class="col-sm-12">
				...
				<div class="well well-sm" style="background:#f5f5f5; height:120px; overflow:auto;">
                    ...
                    <input type="hidden" value="cr_null" name="advsop<?php echo $user; ?>_settings_cr_columns[]" checked="checked"/>               
					<?php foreach ($cr_columns as $key => $cr_column) { ?>
						<div class="checkbox col-md-3">
						<label>
                        <?php if (in_array($key, $advsop_settings_cr_columns)) { ?>
                        	<input type="checkbox" value="<?php echo $key; ?>" name="advsop<?php echo $user; ?>_settings_cr_columns[]" checked="checked"/> <?php echo $cr_column; ?>
                        <?php } else { ?>
							<input type="checkbox" value="<?php echo $key; ?>" name="advsop<?php echo $user; ?>_settings_cr_columns[]" /> <?php echo $cr_column; ?>
                        <?php } ?>
						</label>
						</div>
					<?php } ?>
...
<?php } else { ?>
					...
					<?php foreach ($cr_columns as $key => $cr_column) { ?>
                        <?php if (in_array($key, $advsop_settings_cr_columns)) { ?>
                        	<input type="hidden" value="<?php echo $key; ?>" name="advsop<?php echo $user; ?>_settings_cr_columns[]" checked="checked"/>
                        <?php } ?>
                    <?php } ?>
<?php } ?>
		...
		<div id="checkbox_vr_column" class="row">
			<div class="col-sm-12">
				...
				<div class="well well-sm" style="background:#f5f5f5; height:120px; overflow:auto;">
                    ...
                    <input type="hidden" value="vr_null" name="advsop<?php echo $user; ?>_settings_vr_columns[]" checked="checked"/>               
					<?php foreach ($vr_columns as $key => $vr_column) { ?>
						<div class="checkbox col-md-3">
						<label>
                        <?php if (in_array($key, $advsop_settings_vr_columns)) { ?>
                        	<input type="checkbox" value="<?php echo $key; ?>" name="advsop<?php echo $user; ?>_settings_vr_columns[]" checked="checked"/> <?php echo $vr_column; ?>
                        <?php } else { ?>
							<input type="checkbox" value="<?php echo $key; ?>" name="advsop<?php echo $user; ?>_settings_vr_columns[]" /> <?php echo $vr_column; ?>
                        <?php } ?>
						</label>
						</div>
					<?php } ?>
...
<?php } else { ?>
					...
					<?php foreach ($vr_columns as $key => $vr_column) { ?>
                        <?php if (in_array($key, $advsop_settings_vr_columns)) { ?>
                        	<input type="hidden" value="<?php echo $key; ?>" name="advsop<?php echo $user; ?>_settings_vr_columns[]" checked="checked"/>
                        <?php } ?>
                    <?php } ?>
<?php } ?>
<?php if ($filter_report != 'tax') { ?>
		<div class="row">
			<div class="col-sm-12">
				...
				<div class="well well-sm" style="background:#f5f5f5; height:460px; overflow:auto;">
                    ...
                    <input type="hidden" value="ol_null" name="advsop<?php echo $user; ?>_settings_ol_columns[]" checked="checked"/>              
					<?php foreach ($ol_columns as $key => $ol_column) { ?>
						<div class="checkbox col-md-3">
						<label>
                        <?php if (in_array($key, $advsop_settings_ol_columns)) { ?>
                        	<input type="checkbox" value="<?php echo $key; ?>" name="advsop<?php echo $user; ?>_settings_ol_columns[]" checked="checked"/> <?php echo $ol_column; ?>
                        <?php } else { ?>
							<input type="checkbox" value="<?php echo $key; ?>" name="advsop<?php echo $user; ?>_settings_ol_columns[]" /> <?php echo $ol_column; ?>
                        <?php } ?>
						</label>
						</div>
					<?php } ?>
                    ...
                    <input type="hidden" value="pl_null" name="advsop<?php echo $user; ?>_settings_pl_columns[]" checked="checked"/>                  
					<?php foreach ($pl_columns as $key => $pl_column) { ?>
						<div class="checkbox col-md-3">
						<label>
                        <?php if (in_array($key, $advsop_settings_pl_columns)) { ?>
                        	<input type="checkbox" value="<?php echo $key; ?>" name="advsop<?php echo $user; ?>_settings_pl_columns[]" checked="checked"/> <?php echo $pl_column; ?>
                        <?php } else { ?>
							<input type="checkbox" value="<?php echo $key; ?>" name="advsop<?php echo $user; ?>_settings_pl_columns[]" /> <?php echo $pl_column; ?>
                        <?php } ?>
						</label>
						</div>
					<?php } ?>
                    ...
                    <input type="hidden" value="cl_null" name="advsop<?php echo $user; ?>_settings_cl_columns[]" checked="checked"/>                    
					<?php foreach ($cl_columns as $key => $cl_column) { ?>
						<div class="checkbox col-md-3">
						<label>
                        <?php if (in_array($key, $advsop_settings_cl_columns)) { ?>
                        	<input type="checkbox" value="<?php echo $key; ?>" name="advsop<?php echo $user; ?>_settings_cl_columns[]" checked="checked"/> <?php echo $cl_column; ?>
                        <?php } else { ?>
							<input type="checkbox" value="<?php echo $key; ?>" name="advsop<?php echo $user; ?>_settings_cl_columns[]" /> <?php echo $cl_column; ?>
                        <?php } ?>
						</label>
						</div>
					<?php } ?>
...
<?php } else { ?>  
					...
					<?php foreach ($ol_columns as $key => $ol_column) { ?>
                        <?php if (in_array($key, $advsop_settings_ol_columns)) { ?>
                        	<input type="hidden" value="<?php echo $key; ?>" name="advsop<?php echo $user; ?>_settings_ol_columns[]" checked="checked"/>
                        <?php } ?>
					<?php } ?> 
                    <input type="hidden" value="pl_null" name="advsop<?php echo $user; ?>_settings_pl_columns[]" checked="checked"/>                     
					<?php foreach ($pl_columns as $key => $pl_column) { ?>
                        <?php if (in_array($key, $advsop_settings_pl_columns)) { ?>
                        	<input type="hidden" value="<?php echo $key; ?>" name="advsop<?php echo $user; ?>_settings_pl_columns[]" checked="checked"/>
                        <?php } ?>
					<?php } ?>                         
                    <input type="hidden" value="cl_null" name="advsop<?php echo $user; ?>_settings_cl_columns[]" checked="checked"/>                    
					<?php foreach ($cl_columns as $key => $cl_column) { ?>
                        <?php if (in_array($key, $advsop_settings_cl_columns)) { ?>
                        	<input type="hidden" value="<?php echo $key; ?>" name="advsop<?php echo $user; ?>_settings_cl_columns[]" checked="checked"/>
                        <?php } ?>
					<?php } ?>                                          
<?php } ?> 
<?php if ($filter_report != 'tax') { ?>
		<div id="checkbox_all_column" class="row">
			<div class="col-sm-12">
				...
				<div class="well well-sm" style="background:#f5f5f5; height:580px; overflow:auto;">
                	<div class="col-sm-12" align="right" style="margin-top:10px;">
                    ...
                    <input type="hidden" value="all_null" name="advsop<?php echo $user; ?>_settings_all_columns[]" checked="checked"/>                  
					<?php foreach ($all_columns as $key => $all_column) { ?>
						<div class="checkbox col-md-3">
						<label>
                        <?php if (in_array($key, $advsop_settings_all_columns)) { ?>
                        	<input type="checkbox" value="<?php echo $key; ?>" name="advsop<?php echo $user; ?>_settings_all_columns[]" checked="checked"/> <?php echo $all_column; ?>
                        <?php } else { ?>
							<input type="checkbox" value="<?php echo $key; ?>" name="advsop<?php echo $user; ?>_settings_all_columns[]" /> <?php echo $all_column; ?>
                        <?php } ?>
						</label>
						</div>
					<?php } ?>
...
<?php } else { ?>  
					...
					<?php foreach ($all_columns as $key => $all_column) { ?>
                        <?php if (in_array($key, $advsop_settings_all_columns)) { ?>
                        	<input type="hidden" value="<?php echo $key; ?>" name="advsop<?php echo $user; ?>_settings_all_columns[]" checked="checked"/>
                        <?php } ?>
					<?php } ?>
<?php } ?>          
		</fieldset>
      ...
      <fieldset>
       ...
       <legend><?php echo $text_cron_3; ?></legend> 
        ...
        <table width="100%" id="adv_cron_setting" class="table table-bordered table-hover">
          ...
          <?php if ($advsop_cron_settings) { ?>
		   <?php $adv_cron_settings_row = 0; ?>
			<?php foreach ($advsop_cron_settings as $advsop_cron_setting) { ?>
			  <tbody id="adv_cron_settings_row<?php echo $adv_cron_settings_row; ?>">
				<tr>                
				  <td width="45%" class="text-left">
            	  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_id]" value="<?php echo $advsop_cron_setting['cron_id']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_report_type]" value="<?php echo $advsop_cron_setting['cron_report_type']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_export_type]" value="<?php echo $advsop_cron_setting['cron_export_type']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_export_logo_criteria]" value="<?php echo $advsop_cron_setting['cron_export_logo_criteria']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_export_csv_delimiter]" value="<?php echo $advsop_cron_setting['cron_export_csv_delimiter']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_export_file]" value="<?php echo $advsop_cron_setting['cron_export_file']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_file_save_path]" value="<?php echo $advsop_cron_setting['cron_file_save_path']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_file_name]" value="<?php echo $advsop_cron_setting['cron_file_name']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_email]" value="<?php echo $advsop_cron_setting['cron_email']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_user]" value="<?php echo $advsop_cron_setting['cron_user']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_pass]" value="<?php echo $advsop_cron_setting['cron_pass']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_token]" value="<?php echo $advsop_cron_setting['cron_token']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_user_id]" value="<?php echo $advsop_cron_setting['cron_user_id']; ?>" />
                  
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_report]" value="<?php echo $advsop_cron_setting['cron_filter_report']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_details]" value="<?php echo $advsop_cron_setting['cron_filter_details']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_group]" value="<?php echo $advsop_cron_setting['cron_filter_group']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_sort]" value="<?php echo $advsop_cron_setting['cron_filter_sort']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_order]" value="<?php echo $advsop_cron_setting['cron_filter_order']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_limit]" value="<?php echo $advsop_cron_setting['cron_filter_limit']; ?>" />
                  
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_range]" value="<?php echo $advsop_cron_setting['cron_filter_range']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_date_start]" value="<?php echo $advsop_cron_setting['cron_date_start']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_date_end]" value="<?php echo $advsop_cron_setting['cron_date_end']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_order_status_id]" value="<?php echo $advsop_cron_setting['cron_filter_order_status_id']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_status_date_start]" value="<?php echo $advsop_cron_setting['cron_status_date_start']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_status_date_end]" value="<?php echo $advsop_cron_setting['cron_status_date_end']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_order_id_from]" value="<?php echo $advsop_cron_setting['cron_filter_order_id_from']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_order_id_to]" value="<?php echo $advsop_cron_setting['cron_filter_order_id_to']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_order_value_min]" value="<?php echo $advsop_cron_setting['cron_filter_order_value_min']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_order_value_max]" value="<?php echo $advsop_cron_setting['cron_filter_order_value_max']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_store_id]" value="<?php echo $advsop_cron_setting['cron_filter_store_id']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_currency]" value="<?php echo $advsop_cron_setting['cron_filter_currency']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_taxes]" value="<?php echo $advsop_cron_setting['cron_filter_taxes']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_tax_classes]" value="<?php echo $advsop_cron_setting['cron_filter_tax_classes']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_geo_zones]" value="<?php echo $advsop_cron_setting['cron_filter_geo_zones']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_customer_group_id]" value="<?php echo $advsop_cron_setting['cron_filter_customer_group_id']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_customer_name]" value="<?php echo $advsop_cron_setting['cron_filter_customer_name']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_customer_email]" value="<?php echo $advsop_cron_setting['cron_filter_customer_email']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_customer_telephone]" value="<?php echo $advsop_cron_setting['cron_filter_customer_telephone']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_ip]" value="<?php echo $advsop_cron_setting['cron_filter_ip']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_payment_company]" value="<?php echo $advsop_cron_setting['cron_filter_payment_company']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_payment_address]" value="<?php echo $advsop_cron_setting['cron_filter_payment_address']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_payment_city]" value="<?php echo $advsop_cron_setting['cron_filter_payment_city']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_payment_zone]" value="<?php echo $advsop_cron_setting['cron_filter_payment_zone']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_payment_postcode]" value="<?php echo $advsop_cron_setting['cron_filter_payment_postcode']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_payment_country]" value="<?php echo $advsop_cron_setting['cron_filter_payment_country']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_payment_method]" value="<?php echo $advsop_cron_setting['cron_filter_payment_method']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_shipping_company]" value="<?php echo $advsop_cron_setting['cron_filter_shipping_company']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_shipping_address]" value="<?php echo $advsop_cron_setting['cron_filter_shipping_address']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_shipping_city]" value="<?php echo $advsop_cron_setting['cron_filter_shipping_city']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_shipping_zone]" value="<?php echo $advsop_cron_setting['cron_filter_shipping_zone']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_shipping_postcode]" value="<?php echo $advsop_cron_setting['cron_filter_shipping_postcode']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_shipping_country]" value="<?php echo $advsop_cron_setting['cron_filter_shipping_country']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_shipping_method]" value="<?php echo $advsop_cron_setting['cron_filter_shipping_method']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_category]" value="<?php echo $advsop_cron_setting['cron_filter_category']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_manufacturer]" value="<?php echo $advsop_cron_setting['cron_filter_manufacturer']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_supplier]" value="<?php echo $advsop_cron_setting['cron_filter_supplier']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_sku]" value="<?php echo $advsop_cron_setting['cron_filter_sku']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_product_name]" value="<?php echo $advsop_cron_setting['cron_filter_product_name']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_model]" value="<?php echo $advsop_cron_setting['cron_filter_model']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_option]" value="<?php echo $advsop_cron_setting['cron_filter_option']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_attribute]" value="<?php echo $advsop_cron_setting['cron_filter_attribute']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_location]" value="<?php echo $advsop_cron_setting['cron_filter_location']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_coupon_name]" value="<?php echo $advsop_cron_setting['cron_filter_coupon_name']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_coupon_code]" value="<?php echo $advsop_cron_setting['cron_filter_coupon_code']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_voucher_code]" value="<?php echo $advsop_cron_setting['cron_filter_voucher_code']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_campaign_name]" value="<?php echo $advsop_cron_setting['cron_filter_campaign_name']; ?>" />
                  <input type="hidden" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_campaign_code]" value="<?php echo $advsop_cron_setting['cron_filter_campaign_code']; ?>" />

                  <input type="text" name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_title]" value="<?php echo $advsop_cron_setting['cron_title']; ?>" placeholder="<?php echo $text_cron_title; ?>" class="form-control" /></td>
				  <td width="45%" class="text-left"><textarea readonly name="advsop_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_command]" class="form-control"><?php echo $advsop_cron_setting['cron_command']; ?></textarea></td>    
...
<?php } ?>
<div id="charts" class="chart-switcher <?php echo (isset($_COOKIE['show-sop-chart']) && $_COOKIE['show-sop-chart'] == 1) ? '' : 'hide-chart'; ?>" style="margin-bottom:15px;">   
...
$(document).ready(function() {
	$.ajax({
		url: 'index.php?route=extension/report/adv_sales_profit/chart&user_token=<?php echo $user_token; ?>',
		dataType: 'json',
		success: function(json) {
			...
			$.plot('#chart2', [json['sales'], json['costs'], json['profit']], option2);	
		...
		success: function(json) {
			...
			$('#chart').vectorMap({
				...
				onLabelShow: function(event, label, code) {
					if (json[code]) {
						label.html('<strong>' + label.text() + '</strong><br />' + '<?php echo $column_orders; ?>: ' + json[code]['orders'] + '<br />' + '<?php echo $column_grevenue; ?>: ' + json[code]['sales'] + '<br />' + '<?php echo $column_gexpenses; ?>: ' + json[code]['costs'] + '<br />' + '<?php echo $column_gprofit; ?>: ' + json[code]['profit']);
					}
				}
			});			
		},
...
<?php if ($filter_details == 'all_details_products' or $filter_details == 'all_details_orders') { ?>
	...
	<?php if ($orders && $filter_limit != '999999') { ?>          
		...
		<tr>
          ...
          <?php if (in_array('all_order_inv_no', $advsop_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_order_inv_no; ?></td>
          <?php } ?>
          <?php if (in_array('all_order_customer_name', $advsop_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_order_customer; ?></td>
          <?php } ?>
          <?php if (in_array('all_order_email', $advsop_settings_all_columns)) { ?>
          <td class="left" nowrap="nowrap"><?php echo $column_order_email; ?></td>
          <?php } ?>
          <?php if (in_array('all_order_customer_group', $advsop_settings_all_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_order_customer_group; ?></td>
          <?php } ?>
          <?php if ($filter_details == 'all_details_products') { ?>
          <?php if (in_array('all_prod_id', $advsop_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_prod_id; ?></td>
          <?php } ?>
          <?php if (in_array('all_prod_sku', $advsop_settings_all_columns)) { ?>           
		  <td class="left" nowrap="nowrap"><?php echo $column_prod_sku; ?></td>
          <?php } ?>
          <?php if (in_array('all_prod_model', $advsop_settings_all_columns)) { ?>           
		  <td class="left" nowrap="nowrap"><?php echo $column_prod_model; ?></td>
          <?php } ?>
          <?php if (in_array('all_prod_name', $advsop_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_prod_name; ?></td>
          <?php } ?>
          <?php if (in_array('all_prod_option', $advsop_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_prod_option; ?></td>
          <?php } ?>
          <?php if (in_array('all_prod_attributes', $advsop_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_prod_attributes; ?></td>
          <?php } ?>
          <?php if (in_array('all_prod_category', $advsop_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_prod_category; ?></td>
          <?php } ?>          
          <?php if (in_array('all_prod_manu', $advsop_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_prod_manu; ?></td>
          <?php } ?>
          <?php if (in_array('all_prod_supplier', $advsop_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_prod_supplier; ?></td>
          <?php } ?>
          <?php } ?>
          <?php if ($filter_details == 'all_details_products' or $filter_details == 'all_details_orders') { ?>
          <?php if (in_array('all_prod_currency', $advsop_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_prod_currency; ?></td>
          <?php } ?>          
          <?php } ?>
          <?php if ($filter_details == 'all_details_products') { ?>           
          <?php if (in_array('all_prod_price', $advsop_settings_all_columns)) { ?>           
          <td class="right" nowrap="nowrap"><?php echo $column_prod_price; ?></td>
          <?php } ?>
          <?php if (in_array('all_prod_quantity', $advsop_settings_all_columns)) { ?>           
          <td class="right" nowrap="nowrap"><?php echo $column_prod_quantity; ?></td>
          <?php } ?>
          <?php if (in_array('all_prod_total_excl_vat', $advsop_settings_all_columns)) { ?>           
          <td class="right" nowrap="nowrap"><?php echo $column_prod_total_excl_vat; ?></td>
          <?php } ?>
          <?php if (in_array('all_prod_tax', $advsop_settings_all_columns)) { ?>           
          <td class="right" nowrap="nowrap"><?php echo $column_prod_tax; ?></td>
          <?php } ?>
          <?php if (in_array('all_prod_total_incl_vat', $advsop_settings_all_columns)) { ?>           
          <td class="right" nowrap="nowrap"><?php echo $column_prod_total_incl_vat; ?></td>
          <?php } ?>
          <?php if (in_array('all_prod_discount', $advsop_settings_all_columns)) { ?>           
          <td class="right" style="min-width:70px;"><?php echo $column_prod_discount; ?></td>
          <?php } ?>          
          <?php if (in_array('all_prod_qty_refund', $advsop_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_prod_qty_refunded; ?></td>
          <?php } ?> 
          <?php if (in_array('all_prod_refund', $advsop_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_prod_refunded; ?></td>
          <?php } ?>     
          <?php if (in_array('all_prod_reward_points', $advsop_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_prod_reward_points; ?></td>
          <?php } ?>                            
          <?php if (in_array('all_prod_sales', $advsop_settings_all_columns)) { ?>           
          <td class="right" nowrap="nowrap"><?php echo $column_prod_sales; ?></td>
          <?php } ?>
          <?php if (in_array('all_prod_cost', $advsop_settings_all_columns)) { ?>           
          <td class="right" nowrap="nowrap"><?php echo $column_prod_cost; ?></td>
          <?php } ?>
          <?php if (in_array('all_prod_profit', $advsop_settings_all_columns)) { ?>           
          <td class="right" nowrap="nowrap"><?php echo $column_prod_profit; ?></td>
          <?php } ?>
          <?php if (in_array('all_prod_profit_margin', $advsop_settings_all_columns)) { ?>           
          <td class="right" nowrap="nowrap"><?php echo $column_prod_profit_margin; ?></td>
          <?php } ?>
          <?php if (in_array('all_prod_profit_markup', $advsop_settings_all_columns)) { ?>           
          <td class="right" nowrap="nowrap"><?php echo $column_prod_profit_markup; ?></td>
          <?php } ?>     
          <?php } ?> 
          <?php if (in_array('all_sub_total', $advsop_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_sub_total; ?></td>
          <?php } ?>              
          <?php if (in_array('all_handling', $advsop_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_handling; ?></td>
          <?php } ?>
          <?php if (in_array('all_loworder', $advsop_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_loworder; ?></td>
          <?php } ?>                  
          <?php if (in_array('all_shipping', $advsop_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_order_shipping; ?></td>
          <?php } ?>
          <?php if (in_array('all_reward', $advsop_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_reward; ?></td>
          <?php } ?>
          <?php if (in_array('all_reward_points', $advsop_settings_all_columns)) { ?>          
          ...
          <?php } ?>           
          <?php if (in_array('all_coupon', $advsop_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_coupon; ?></td>
          <?php } ?>
          <?php if (in_array('all_coupon_name', $advsop_settings_all_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_coupon_name; ?></td>
          <?php } ?> 
          <?php if (in_array('all_coupon_code', $advsop_settings_all_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_coupon_code; ?></td>
          <?php } ?>                              
          <?php if (in_array('all_order_tax', $advsop_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_order_tax; ?></td>
          <?php } ?>
          <?php if (in_array('all_credit', $advsop_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_credit; ?></td>
          <?php } ?>
          <?php if (in_array('all_voucher', $advsop_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_voucher; ?></td>
          <?php } ?>
          <?php if (in_array('all_voucher_code', $advsop_settings_all_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_voucher_code; ?></td>
          <?php } ?>
          <?php if (in_array('all_discount', $advsop_settings_all_columns)) { ?>          
          <td class="right" style="min-width:75px;"><?php echo $column_discount; ?></td>
          <?php } ?>          
          <?php if (in_array('all_order_value', $advsop_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_order_value; ?></td>
          <?php } ?>
          <?php if (in_array('all_refund', $advsop_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_order_refund; ?></td>
          <?php } ?>                        
          <?php if (in_array('all_order_sales', $advsop_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_order_sales; ?></td>
          <?php } ?>
          <?php if (in_array('all_order_prod_costs', $advsop_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_order_prod_costs; ?></td>
          <?php } ?>
          <?php if (in_array('all_order_commission', $advsop_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_order_commission; ?></td>
          <?php } ?>
          <?php if (in_array('all_order_payment_cost', $advsop_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_order_payment_cost; ?></td>
          <?php } ?>
          <?php if (in_array('all_order_shipping_cost', $advsop_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_order_shipping_cost; ?></td>
          <?php } ?>
          <?php if (in_array('all_order_extra_cost', $advsop_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_order_extra_cost; ?></td>
          <?php } ?>
          <?php if (in_array('all_order_return_cost', $advsop_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_order_return_cost; ?></td>
          <?php } ?>                    
          <?php if (in_array('all_shipping_balance', $advsop_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_shipping_balance; ?></td>
          <?php } ?>                                                  
          <?php if (in_array('all_order_costs', $advsop_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_order_costs; ?></td>
          <?php } ?>
          <?php if (in_array('all_order_profit', $advsop_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_order_profit; ?></td>
          <?php } ?>
          <?php if (in_array('all_order_profit_prc', $advsop_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_order_margin; ?></td>
          <?php } ?>  
          <?php if (in_array('all_order_shipping_method', $advsop_settings_all_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_order_shipping_method; ?></td>
          <?php } ?>
          <?php if (in_array('all_order_payment_method', $advsop_settings_all_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_order_payment_method; ?></td>
          <?php } ?>
          <?php if (in_array('all_order_status', $advsop_settings_all_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_order_status; ?></td>
          <?php } ?>
          <?php if (in_array('all_order_store', $advsop_settings_all_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_order_store; ?></td>
          <?php } ?>
          <?php if (in_array('all_campaign_name', $advsop_settings_all_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_campaign_name; ?></td>
          <?php } ?> 
          <?php if (in_array('all_campaign_code', $advsop_settings_all_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_campaign_code; ?></td>
          <?php } ?>  
          <?php if (in_array('all_customer_cust_id', $advsop_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_customer_cust_id; ?></td>
          <?php } ?>
          <?php if (in_array('all_custom_fields', $advsop_settings_all_columns)) { ?>  
          ...
          <?php } ?>
          <?php } ?>
          <?php if (in_array('all_billing_first_name', $advsop_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_billing_first_name; ?></td>
          <?php } ?>
          <?php if (in_array('all_billing_last_name', $advsop_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_billing_last_name; ?></td>
          <?php } ?>          
          <?php if (in_array('all_billing_company', $advsop_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_billing_company; ?></td>
          <?php } ?>
          <?php if (in_array('all_billing_address_1', $advsop_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_billing_address_1; ?></td>
          <?php } ?>
          <?php if (in_array('all_billing_address_2', $advsop_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_billing_address_2; ?></td>
          <?php } ?>
          <?php if (in_array('all_billing_city', $advsop_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_billing_city; ?></td>
          <?php } ?>
          <?php if (in_array('all_billing_zone', $advsop_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_billing_zone; ?></td> 
          <?php } ?>
          <?php if (in_array('all_billing_zone_id', $advsop_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_billing_zone_id; ?></td> 
          <?php } ?>
          <?php if (in_array('all_billing_zone_code', $advsop_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_billing_zone_code; ?></td> 
          <?php } ?>                    
          <?php if (in_array('all_billing_postcode', $advsop_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_billing_postcode; ?></td>
          <?php } ?>
          <?php if (in_array('all_billing_country', $advsop_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_billing_country; ?></td>
          <?php } ?>
          <?php if (in_array('all_billing_country_id', $advsop_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_billing_country_id; ?></td>
          <?php } ?>
          <?php if (in_array('all_billing_country_code', $advsop_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_billing_country_code; ?></td>
          <?php } ?>                    
          <?php if (in_array('all_customer_telephone', $advsop_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_customer_telephone; ?></td>
          <?php } ?>
          <?php if (in_array('all_shipping_first_name', $advsop_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_shipping_first_name; ?></td> 
          <?php } ?>
          <?php if (in_array('all_shipping_last_name', $advsop_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_shipping_last_name; ?></td> 
          <?php } ?>          
          <?php if (in_array('all_shipping_company', $advsop_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_shipping_company; ?></td> 
          <?php } ?>
          <?php if (in_array('all_shipping_address_1', $advsop_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_shipping_address_1; ?></td> 
          <?php } ?>
          <?php if (in_array('all_shipping_address_2', $advsop_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_shipping_address_2; ?></td> 
          <?php } ?>
          <?php if (in_array('all_shipping_city', $advsop_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_shipping_city; ?></td>
          <?php } ?>
          <?php if (in_array('all_shipping_zone', $advsop_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_shipping_zone; ?></td> 
          <?php } ?>
          <?php if (in_array('all_shipping_zone_id', $advsop_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_shipping_zone_id; ?></td> 
          <?php } ?>
          <?php if (in_array('all_shipping_zone_code', $advsop_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_shipping_zone_code; ?></td> 
          <?php } ?>                    
          <?php if (in_array('all_shipping_postcode', $advsop_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_shipping_postcode; ?></td>
          <?php } ?>
          <?php if (in_array('all_shipping_country', $advsop_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_shipping_country; ?></td>
          <?php } ?> 
          <?php if (in_array('all_shipping_country_id', $advsop_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_shipping_country_id; ?></td>
          <?php } ?> 
          <?php if (in_array('all_shipping_country_code', $advsop_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_shipping_country_code; ?></td>
          <?php } ?>                     
          <?php if (in_array('all_order_weight', $advsop_settings_all_columns)) { ?>           
          <td class="right" nowrap="nowrap"><?php echo $column_order_weight; ?></td>
          <?php } ?>           
          <?php if (in_array('all_order_comment', $advsop_settings_all_columns)) { ?>           
    ...
    <?php if ($order['product_id']) { ?>          
		<tr bgcolor="#FFFFFF">
          ...
          <?php } ?>
          <?php if (in_array('all_prod_supplier', $advsop_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap" title="<?php echo $column_prod_supplier; ?> [<?php echo $column_order_order_id; ?>: <?php echo $order['order_id']; ?>]"><?php echo $order['product_supplier']; ?></td>
          <?php } ?>    
          <?php } ?>
          <?php if ($filter_details == 'all_details_products' or $filter_details == 'all_details_orders') { ?>
          <?php if (in_array('all_prod_currency', $advsop_settings_all_columns)) { ?>           
          ...
          <?php } ?>
          <?php if (in_array('all_prod_total_excl_vat', $advsop_settings_all_columns)) { ?>           
          <td class="right" nowrap="nowrap" title="<?php echo $column_prod_total_excl_vat; ?> [<?php echo $column_order_order_id; ?>: <?php echo $order['order_id']; ?>]" <?php echo ($filter_report == 'abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><span style="color:#090"><?php echo $order['product_total_excl_vat']; ?></span></td>
          <?php } ?>
          <?php if (in_array('all_prod_tax', $advsop_settings_all_columns)) { ?>           
          ...
          <?php } ?>
          <?php if (in_array('all_prod_discount', $advsop_settings_all_columns)) { ?>           
          <td class="right" nowrap="nowrap" title="<?php echo $column_prod_discount; ?> [<?php echo $column_order_order_id; ?>: <?php echo $order['order_id']; ?>]" <?php echo ($filter_report == 'abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><?php echo $order['product_discount']; ?></td>
          <?php } ?>          
          <?php if (in_array('all_prod_qty_refund', $advsop_settings_all_columns)) { ?>          
          ...
          <?php } ?>   
          <?php if (in_array('all_prod_refund', $advsop_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap" title="<?php echo $column_prod_refunded; ?> [<?php echo $column_order_order_id; ?>: <?php echo $order['order_id']; ?>]" <?php echo ($filter_report == 'abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><span <?php if ($advsop_formula_6) { echo 'style="color:#090"'; } ?>><?php echo $order['product_refund']; ?></span></td>
          <?php } ?>       
          <?php if (in_array('all_prod_reward_points', $advsop_settings_all_columns)) { ?>          
          ...
          <?php } ?>                             
          <?php if (in_array('all_prod_sales', $advsop_settings_all_columns)) { ?>           
          <td class="right" nowrap="nowrap" title="<?php echo $column_prod_sales; ?> [<?php echo $column_order_order_id; ?>: <?php echo $order['order_id']; ?>]" <?php echo ($filter_report == 'abandoned_orders') ? 'style="background-color:#DCFFB9; text-decoration:line-through;"' : 'style="background-color:#DCFFB9;"' ?> ><?php echo $order['product_sales']; ?></td>
          <?php } ?>
          <?php if (in_array('all_prod_cost', $advsop_settings_all_columns)) { ?>           
          <td class="right" nowrap="nowrap" title="<?php echo $column_prod_cost; ?> [<?php echo $column_order_order_id; ?>: <?php echo $order['order_id']; ?>]" <?php echo ($filter_report == 'abandoned_orders') ? 'style="background-color:#ffd7d7; text-decoration:line-through;"' : 'style="background-color:#ffd7d7;"' ?> ><?php echo $order['product_cost']; ?></td>
          <?php } ?>
          <?php if (in_array('all_prod_profit', $advsop_settings_all_columns)) { ?>           
          <td class="right" nowrap="nowrap" title="<?php echo $column_prod_profit; ?> [<?php echo $column_order_order_id; ?>: <?php echo $order['order_id']; ?>]" <?php echo ($filter_report == 'abandoned_orders') ? (($order['product_profit_raw'] >= 0) ? 'style="background-color:#c4d9ee; font-weight:bold; text-decoration:line-through;"' : 'style="background-color:#F99; font-weight:bold; text-decoration:line-through;"') : (($order['product_profit_raw'] >= 0) ? 'style="background-color:#c4d9ee; font-weight:bold;"' : 'style="background-color:#F99; font-weight:bold;"') ?> ><?php echo $order['product_profit']; ?></td>
          <?php } ?>
          <?php if (in_array('all_prod_profit_margin', $advsop_settings_all_columns)) { ?>           
          <td class="right" nowrap="nowrap" title="<?php echo $column_prod_profit_margin; ?> [<?php echo $column_order_order_id; ?>: <?php echo $order['order_id']; ?>]" <?php echo ($filter_report == 'abandoned_orders') ? (($order['product_profit_raw'] >= 0) ? 'style="background-color:#c4d9ee; font-weight:bold; text-decoration:line-through;"' : 'style="background-color:#F99; font-weight:bold; text-decoration:line-through;"') : (($order['product_profit_raw'] >= 0) ? 'style="background-color:#c4d9ee; font-weight:bold;"' : 'style="background-color:#F99; font-weight:bold;"') ?> ><?php echo $order['product_profit_margin']; ?></td>
          <?php } ?>   
          <?php if (in_array('all_prod_profit_markup', $advsop_settings_all_columns)) { ?>           
          <td class="right" nowrap="nowrap" title="<?php echo $column_prod_profit_markup; ?> [<?php echo $column_order_order_id; ?>: <?php echo $order['order_id']; ?>]" <?php echo ($filter_report == 'abandoned_orders') ? (($order['product_profit_raw'] >= 0) ? 'style="background-color:#c4d9ee; font-weight:bold; text-decoration:line-through;"' : 'style="background-color:#F99; font-weight:bold; text-decoration:line-through;"') : (($order['product_profit_raw'] >= 0) ? 'style="background-color:#c4d9ee; font-weight:bold;"' : 'style="background-color:#F99; font-weight:bold;"') ?> ><?php echo $order['product_profit_markup']; ?></td>
          <?php } ?>
          <?php } ?>  
          <?php if (in_array('all_sub_total', $advsop_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap" title="<?php echo $column_sub_total; ?> [<?php echo $column_order_order_id; ?>: <?php echo $order['order_id']; ?>]" <?php echo ($filter_report == 'abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><span style="color:#090"><?php echo $order['order_sub_total']; ?></span></td>
          <?php } ?>
          <?php if (in_array('all_handling', $advsop_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap" title="<?php echo $column_handling; ?> [<?php echo $column_order_order_id; ?>: <?php echo $order['order_id']; ?>]" <?php echo ($filter_report == 'abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><span style="color:#090"><?php echo $order['order_handling']; ?></span></td>
          <?php } ?>
          <?php if (in_array('all_loworder', $advsop_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap" title="<?php echo $column_loworder; ?> [<?php echo $column_order_order_id; ?>: <?php echo $order['order_id']; ?>]" <?php echo ($filter_report == 'abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><span style="color:#090"><?php echo $order['order_low_order_fee']; ?></span></td>
          <?php } ?>                    
          <?php if (in_array('all_shipping', $advsop_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap" title="<?php echo $column_shipping; ?> [<?php echo $column_order_order_id; ?>: <?php echo $order['order_id']; ?>]" <?php echo ($filter_report == 'abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><span <?php if ($advsop_formula_1) { echo 'style="color:#090"'; } ?>><?php echo $order['order_shipping']; ?></span></td>
          <?php } ?>
          <?php if (in_array('all_reward', $advsop_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap" title="<?php echo $column_reward; ?> [<?php echo $column_order_order_id; ?>: <?php echo $order['order_id']; ?>]" <?php echo ($filter_report == 'abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><span style="color:#090"><?php echo $order['order_reward']; ?></span></td>
          <?php } ?>
          <?php if (in_array('all_reward_points', $advsop_settings_all_columns)) { ?>          
          ...
          <?php } ?>           
          <?php if (in_array('all_coupon', $advsop_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap" title="<?php echo $column_coupon; ?> [<?php echo $column_order_order_id; ?>: <?php echo $order['order_id']; ?>]" <?php echo ($filter_report == 'abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><span style="color:#090"><?php echo $order['order_coupon']; ?></span></td>
          <?php } ?>
          <?php if (in_array('all_coupon_name', $advsop_settings_all_columns)) { ?>          
          ...
          <?php } ?>
          <?php if (in_array('all_credit', $advsop_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap" title="<?php echo $column_credit; ?> [<?php echo $column_order_order_id; ?>: <?php echo $order['order_id']; ?>]" <?php echo ($filter_report == 'abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><span style="color:#090"><?php echo $order['order_credit']; ?></span></td>
          <?php } ?>
          <?php if (in_array('all_voucher', $advsop_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap" title="<?php echo $column_voucher; ?> [<?php echo $column_order_order_id; ?>: <?php echo $order['order_id']; ?>]" <?php echo ($filter_report == 'abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><span style="color:#090"><?php echo $order['order_voucher']; ?></span></td>
          <?php } ?>
          <?php if (in_array('all_voucher_code', $advsop_settings_all_columns)) { ?>          
          ...
          <?php } ?>
          <?php if (in_array('all_discount', $advsop_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap" title="<?php echo $column_discount; ?> [<?php echo $column_order_order_id; ?>: <?php echo $order['order_id']; ?>]" <?php echo ($filter_report == 'abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><?php echo $order['order_discount']; ?></td>
          <?php } ?>          
          <?php if (in_array('all_order_value', $advsop_settings_all_columns)) { ?>          
          ...
          <?php } ?>
          <?php if (in_array('all_refund', $advsop_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap" title="<?php echo $column_order_refund; ?> [<?php echo $column_order_order_id; ?>: <?php echo $order['order_id']; ?>]" <?php echo ($filter_report == 'abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><span <?php if ($advsop_formula_6) { echo 'style="color:#090"'; } ?>><?php echo $order['order_refund']; ?></span></td>
          <?php } ?>
          <?php if (in_array('all_order_sales', $advsop_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap" title="<?php echo $column_order_sales; ?> [<?php echo $column_order_order_id; ?>: <?php echo $order['order_id']; ?>]" <?php echo ($filter_report == 'abandoned_orders') ? 'style="background-color:#DCFFB9; text-decoration:line-through;"' : 'style="background-color:#DCFFB9;"' ?> ><?php echo $order['order_sales']; ?></td>
          <?php } ?>
          <?php if (in_array('all_order_prod_costs', $advsop_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap" title="<?php echo $column_order_prod_costs; ?> [<?php echo $column_order_order_id; ?>: <?php echo $order['order_id']; ?>]" <?php echo ($filter_report == 'abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><span style="color:#F00"><?php echo $order['order_product_costs']; ?></span></td>
          <?php } ?>
          <?php if (in_array('all_order_commission', $advsop_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap" title="<?php echo $column_order_commission; ?> [<?php echo $column_order_order_id; ?>: <?php echo $order['order_id']; ?>]" <?php echo ($filter_report == 'abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><span style="color:#F00"><?php echo $order['order_commission']; ?></span></td>
          <?php } ?>
          <?php if (in_array('all_order_payment_cost', $advsop_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap" title="<?php echo $column_order_payment_cost; ?> [<?php echo $column_order_order_id; ?>: <?php echo $order['order_id']; ?>]" <?php echo ($filter_report == 'abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><span <?php if ($advsop_formula_3) { echo 'style="color:#F00"'; } ?>><?php echo $order['order_payment_cost']; ?></span></td>
          <?php } ?>
          <?php if (in_array('all_order_shipping_cost', $advsop_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap" title="<?php echo $column_order_shipping_cost; ?> [<?php echo $column_order_order_id; ?>: <?php echo $order['order_id']; ?>]" <?php echo ($filter_report == 'abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><span <?php if ($advsop_formula_2) { echo 'style="color:#F00"'; } ?>><?php echo $order['order_shipping_cost']; ?></span></td>
          <?php } ?>
          <?php if (in_array('all_order_extra_cost', $advsop_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap" title="<?php echo $column_order_extra_cost; ?> [<?php echo $column_order_order_id; ?>: <?php echo $order['order_id']; ?>]" <?php echo ($filter_report == 'abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><span <?php if ($advsop_formula_4) { echo 'style="color:#F00"'; } ?>><?php echo $order['order_extra_cost']; ?></span></td>
          <?php } ?>
          <?php if (in_array('all_order_return_cost', $advsop_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap" title="<?php echo $column_order_return_cost; ?> [<?php echo $column_order_order_id; ?>: <?php echo $order['order_id']; ?>]" <?php echo ($filter_report == 'abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><span <?php if ($advsop_formula_5) { echo 'style="color:#F00"'; } ?>><?php echo $order['order_return_cost']; ?></span></td>
          <?php } ?>                    
          <?php if (in_array('all_shipping_balance', $advsop_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap" title="<?php echo $column_shipping_balance; ?> [<?php echo $column_order_order_id; ?>: <?php echo $order['order_id']; ?>]" <?php echo ($filter_report == 'abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><?php echo $order['order_ship_balance']; ?></td>
          <?php } ?>            
          <?php if (in_array('all_order_costs', $advsop_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap" title="<?php echo $column_order_costs; ?> [<?php echo $column_order_order_id; ?>: <?php echo $order['order_id']; ?>]" <?php echo ($filter_report == 'abandoned_orders') ? 'style="background-color:#ffd7d7; text-decoration:line-through;"' : 'style="background-color:#ffd7d7;"' ?> ><?php echo $order['order_costs']; ?></td>
          <?php } ?>
          <?php if (in_array('all_order_profit', $advsop_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap" title="<?php echo $column_order_profit; ?> [<?php echo $column_order_order_id; ?>: <?php echo $order['order_id']; ?>]" <?php echo ($filter_report == 'abandoned_orders') ? (($order['order_profit_raw'] >= 0) ? 'style="background-color:#c4d9ee; font-weight:bold; text-decoration:line-through;"' : 'style="background-color:#F99; font-weight:bold; text-decoration:line-through;"') : (($order['order_profit_raw'] >= 0) ? 'style="background-color:#c4d9ee; font-weight:bold;"' : 'style="background-color:#F99; font-weight:bold;"') ?> ><?php echo $order['order_profit']; ?></td>
          <?php } ?>
          <?php if (in_array('all_order_profit_prc', $advsop_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap" title="<?php echo $column_order_margin; ?> [<?php echo $column_order_order_id; ?>: <?php echo $order['order_id']; ?>]" <?php echo ($filter_report == 'abandoned_orders') ? (($order['order_profit_raw'] >= 0) ? 'style="background-color:#c4d9ee; font-weight:bold; text-decoration:line-through;"' : 'style="background-color:#F99; font-weight:bold; text-decoration:line-through;"') : (($order['order_profit_raw'] >= 0) ? 'style="background-color:#c4d9ee; font-weight:bold;"' : 'style="background-color:#F99; font-weight:bold;"') ?> ><?php echo $order['order_profit_prc']; ?></td>
          <?php } ?>
          <?php if (in_array('all_order_shipping_method', $advsop_settings_all_columns)) { ?>          
          ...
          <?php } ?>
          <?php if (in_array('all_campaign_name', $advsop_settings_all_columns)) { ?>          
          <td class="left" nowrap="nowrap" title="<?php echo $column_campaign_name; ?> [<?php echo $column_order_order_id; ?>: <?php echo $order['order_id']; ?>]" <?php echo ($filter_report == 'abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><?php echo $order['order_campaign_name']; ?></td>
          <?php } ?>   
          <?php if (in_array('all_campaign_code', $advsop_settings_all_columns)) { ?>          
          <td class="left" nowrap="nowrap" title="<?php echo $column_campaign_code; ?> [<?php echo $column_order_order_id; ?>: <?php echo $order['order_id']; ?>]" <?php echo ($filter_report == 'abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><?php echo $order['order_campaign_code']; ?></td>
          <?php } ?>
          <?php if (in_array('all_customer_cust_id', $advsop_settings_all_columns)) { ?>
...
<?php if ($filter_details != 'all_details_products' && $filter_details != 'all_details_orders' && $filter_limit != '999999') { ?>
    <table class="list_main">
        <thead>
		  ...
		  <?php } ?>
          <?php if ($filter_report == 'tax') { ?>
          <?php if (in_array('tr_tax_name', $advsop_settings_tr_columns)) { ?>
          <td class="left"><?php echo $column_tax_title; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('tr_tax_rate', $advsop_settings_tr_columns)) { ?>
          <td class="right"><?php echo $column_tax_rate; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('tr_tax_orders', $advsop_settings_tr_columns)) { ?>
          <td class="right"><?php echo $column_orders; $c++; ?></td>
		  <?php } ?>
          <?php if (in_array('tr_tax_total', $advsop_settings_tr_columns)) { ?>
          <td class="right"><?php echo $column_tax_total; $c++; ?></td>
          <?php } ?>
          <?php } elseif ($filter_report == 'coupon') { ?>
          <?php if (in_array('cr_coupon_name', $advsop_settings_cr_columns)) { ?>
          <td class="left"><?php echo $column_coupon_name; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('cr_coupon_code', $advsop_settings_cr_columns)) { ?>          
          <td class="left"><?php echo $column_coupon_code; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('cr_coupon_discount', $advsop_settings_cr_columns)) { ?>            
          <td class="right"><?php echo $column_coupon_discount; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('cr_coupon_type', $advsop_settings_cr_columns)) { ?>            
          <td class="left"><?php echo $column_coupon_type; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('cr_coupon_status', $advsop_settings_cr_columns)) { ?>            
          <td class="left"><?php echo $column_coupon_status; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('cr_coupon_date_added', $advsop_settings_cr_columns)) { ?>            
          <td class="left"><?php echo $column_coupon_date_added; $c++; ?></td>
          <?php } ?>          
          <?php if (in_array('cr_coupon_last_used', $advsop_settings_cr_columns)) { ?>            
          <td class="left"><?php echo $column_coupon_last_used; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('cr_coupon_amount', $advsop_settings_cr_columns)) { ?>            
          <td class="right"><?php echo $column_coupon_amount; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('cr_coupon_orders', $advsop_settings_cr_columns)) { ?>            
          <td class="right"><?php echo $column_orders; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('cr_coupon_total', $advsop_settings_cr_columns)) { ?>            
          ...
          <?php } elseif ($filter_report == 'voucher') { ?>
          <?php if (in_array('vr_voucher_code', $advsop_settings_vr_columns)) { ?>
          <td class="left"><?php echo $column_voucher_code; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('vr_voucher_from_name', $advsop_settings_vr_columns)) { ?>          
          <td class="left"><?php echo $column_voucher_from_name; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('vr_voucher_from_email', $advsop_settings_vr_columns)) { ?>            
          <td class="left"><?php echo $column_voucher_from_email; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('vr_voucher_to_name', $advsop_settings_vr_columns)) { ?>            
          <td class="left"><?php echo $column_voucher_to_name; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('vr_voucher_to_email', $advsop_settings_vr_columns)) { ?>            
          <td class="left"><?php echo $column_voucher_to_email; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('vr_voucher_theme', $advsop_settings_vr_columns)) { ?>            
          <td class="left"><?php echo $column_voucher_theme; $c++; ?></td>
          <?php } ?>          
          <?php if (in_array('vr_voucher_status', $advsop_settings_vr_columns)) { ?>            
          <td class="left"><?php echo $column_voucher_status; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('vr_voucher_date_added', $advsop_settings_vr_columns)) { ?>            
          <td class="left"><?php echo $column_voucher_date_added; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('vr_voucher_amount', $advsop_settings_vr_columns)) { ?>            
          <td class="right"><?php echo $column_voucher_amount; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('vr_voucher_used_value', $advsop_settings_vr_columns)) { ?>            
          <td class="right"><?php echo $column_voucher_used_value; $c++; ?></td>
          <?php } ?>  
          <?php if (in_array('vr_voucher_remaining_value', $advsop_settings_vr_columns)) { ?>            
          <td class="right"><?php echo $column_voucher_remaining_value; $c++; ?></td>
          <?php } ?>                      
          <?php if (in_array('vr_voucher_orders', $advsop_settings_vr_columns)) { ?>            
          <td class="right"><?php echo $column_orders; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('vr_voucher_total', $advsop_settings_vr_columns)) { ?>            
          <td class="right"><?php echo $column_total; $c++; ?></td>
          <?php } ?>
          <?php if ($filter_details == 'basic_details') { ?><td class="center"><?php $c++; ?><a class="btn btn-info btn-sm toggle-all expand" data-original-title="<?php echo $button_expand; ?>" data-toggle="tooltip"><i id="circle" class="fa fa-arrow-circle-down"></i></a></td><?php } ?> 
          <?php } else { ?>
          <?php if (in_array('mv_orders', $advsop_settings_mv_columns)) { ?>
          <td class="right"><?php echo $column_orders; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('mv_customers', $advsop_settings_mv_columns)) { ?>
          <td class="right"><?php echo $column_customers; $c++; ?></td>  
          <?php } ?>
          <?php if (in_array('mv_products', $advsop_settings_mv_columns)) { ?>            
          <td class="right"><?php echo $column_products; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('mv_sub_total', $advsop_settings_mv_columns)) { ?>          
          <td class="right"><?php echo $column_sub_total; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('mv_handling', $advsop_settings_mv_columns)) { ?>          
          <td class="right"><?php echo $column_handling; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('mv_loworder', $advsop_settings_mv_columns)) { ?>          
          <td class="right" style="min-width:80px;"><?php echo $column_loworder; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('mv_shipping', $advsop_settings_mv_columns)) { ?>          
          <td class="right"><?php echo $column_shipping; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('mv_reward', $advsop_settings_mv_columns)) { ?>          
          <td class="right"><?php echo $column_reward; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('mv_earned_points', $advsop_settings_mv_columns)) { ?>          
          <td class="right" style="min-width:105px;"><?php echo $column_earned_reward_points; $c++; ?></td>
          <?php } ?>   
          <?php if (in_array('mv_used_points', $advsop_settings_mv_columns)) { ?>          
          <td class="right" style="min-width:105px;"><?php echo $column_used_reward_points; $c++; ?></td>
          <?php } ?>                    
          <?php if (in_array('mv_coupon', $advsop_settings_mv_columns)) { ?>          
          <td class="right"><?php echo $column_coupon; $c++; ?></td> 
          <?php } ?>
          <?php if (in_array('mv_tax', $advsop_settings_mv_columns)) { ?>                   
          <td class="right"><?php echo $column_taxes; $c++; ?></td>
          <?php } ?>         
          <?php if (in_array('mv_credit', $advsop_settings_mv_columns)) { ?>          
          <td class="right"><?php echo $column_credit; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('mv_voucher', $advsop_settings_mv_columns)) { ?>          
          <td class="right"><?php echo $column_voucher; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('mv_discount', $advsop_settings_mv_columns)) { ?>          
          <td class="right" style="min-width:80px;"><?php echo $column_discount; $c++; ?></td>
          <?php } ?>          
          <?php if (in_array('mv_total', $advsop_settings_mv_columns)) { ?>          
          <td class="right"><?php echo $column_total; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('mv_aov', $advsop_settings_mv_columns)) { ?>          
          <td class="right" style="min-width:80px;"><?php echo $column_aov; $c++; ?></td>
          <?php } ?>          
          <?php if (in_array('mv_refunds', $advsop_settings_mv_columns)) { ?>          
          <td class="right"><?php echo $column_refunds; $c++; ?></td>
          <?php } ?>                    
          <?php if (in_array('mv_total_sales', $advsop_settings_mv_columns)) { ?>          
          <td class="right"><?php echo $column_total_sales; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('mv_product_costs', $advsop_settings_mv_columns)) { ?>          
          <td class="right"><?php echo $column_product_costs; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('mv_commission', $advsop_settings_mv_columns)) { ?>          
          <td class="right"><?php echo $column_commission; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('mv_payment_costs', $advsop_settings_mv_columns)) { ?>          
          <td class="right"><?php echo $column_payment_cost; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('mv_shipping_costs', $advsop_settings_mv_columns)) { ?>          
          <td class="right"><?php echo $column_shipping_cost; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('mv_extra_costs', $advsop_settings_mv_columns)) { ?>          
          <td class="right"><?php echo $column_extra_cost; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('mv_return_costs', $advsop_settings_mv_columns)) { ?>          
          <td class="right"><?php echo $column_return_cost; $c++; ?></td>
          <?php } ?>                    
          <?php if (in_array('mv_shipping_balance', $advsop_settings_mv_columns)) { ?>          
          <td class="right"><?php echo $column_shipping_balance; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('mv_total_costs', $advsop_settings_mv_columns)) { ?>          
          <td class="right"><?php echo $column_total_costs; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('mv_total_profit', $advsop_settings_mv_columns)) { ?>
          <td class="right"><label class="control-label"><span data-toggle="tooltip" title="<?php echo $help_total_profit; ?>"><?php echo $column_total_profit; $c++; ?></span></label></td>
          <?php } ?>
          <?php if (in_array('mv_total_profit_prc', $advsop_settings_mv_columns)) { ?>          
          <td class="right" style="min-width:90px;"><label class="control-label"><span data-toggle="tooltip" title="<?php echo $help_total_profit_prc; ?>"><?php echo $column_total_profit_prc; $c++; ?></span></label></td>
          <?php } ?>
          <?php if ($filter_details == 'basic_details') { ?><td class="center"><?php $c++; ?><a class="btn btn-info btn-sm toggle-all expand" data-original-title="<?php echo $button_expand; ?>" data-toggle="tooltip"><i id="circle" class="fa fa-arrow-circle-down"></i></a></td><?php } ?> 
          <?php } ?>
          </tr>
          ...
          <?php } ?>
          <?php if (in_array('mv_sub_total', $advsop_settings_mv_columns)) { ?>  
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><span style="color:#090"><?php echo $order['sub_total']; ?></span></td>
          <?php } ?>
          <?php if (in_array('mv_handling', $advsop_settings_mv_columns)) { ?>            
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><span style="color:#090"><?php echo $order['handling']; ?></span></td>
          <?php } ?>
          <?php if (in_array('mv_loworder', $advsop_settings_mv_columns)) { ?>            
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><span style="color:#090"><?php echo $order['low_order_fee']; ?></span></td>
          <?php } ?>
          <?php if (in_array('mv_shipping', $advsop_settings_mv_columns)) { ?>            
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><span <?php if ($advsop_formula_1) { echo 'style="color:#090"'; } ?>><?php echo $order['shipping']; ?></span></td>
          <?php } ?>
          <?php if (in_array('mv_reward', $advsop_settings_mv_columns)) { ?>           
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><span style="color:#090"><?php echo $order['reward']; ?></span></td>
          <?php } ?>
          <?php if (in_array('mv_earned_points', $advsop_settings_mv_columns)) { ?>          
          ...
          <?php } ?>            
          <?php if (in_array('mv_coupon', $advsop_settings_mv_columns)) { ?>            
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><span style="color:#090"><?php echo $order['coupon']; ?></span></td>  
          <?php } ?>
          <?php if (in_array('mv_tax', $advsop_settings_mv_columns)) { ?>                     
          ...
          <?php } ?>       
          <?php if (in_array('mv_credit', $advsop_settings_mv_columns)) { ?>
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><span style="color:#090"><?php echo $order['credit']; ?></span></td> 
          <?php } ?>
          <?php if (in_array('mv_voucher', $advsop_settings_mv_columns)) { ?>                      
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><span style="color:#090"><?php echo $order['voucher']; ?></span></td>
          <?php } ?>
          <?php if (in_array('mv_discount', $advsop_settings_mv_columns)) { ?>           
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><?php echo $order['discount']; ?></td>
          <?php } ?>
          <?php if (in_array('mv_total', $advsop_settings_mv_columns)) { ?>           
          ...
          <?php } ?>
          <?php if (in_array('mv_refunds', $advsop_settings_mv_columns)) { ?>               
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><span <?php if ($advsop_formula_6) { echo 'style="color:#090"'; } ?>><?php echo $order['refunds']; ?></span></td>
          <?php } ?>                     
          <?php if (in_array('mv_total_sales', $advsop_settings_mv_columns)) { ?>           
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'abandoned_orders') ? 'style="background-color:#DCFFB9; text-decoration:line-through;"' : 'style="background-color:#DCFFB9;"' ?> ><?php echo $order['total_sales']; ?></td>  
          <?php } ?>
          <?php if (in_array('mv_product_costs', $advsop_settings_mv_columns)) { ?>                      
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><span style="color:#F00"><?php echo $order['prod_costs']; ?></span></td>
          <?php } ?>
          <?php if (in_array('mv_commission', $advsop_settings_mv_columns)) { ?>                       
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><span style="color:#F00"><?php echo $order['commission']; ?></span></td>
          <?php } ?>
          <?php if (in_array('mv_payment_costs', $advsop_settings_mv_columns)) { ?>               
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><span <?php if ($advsop_formula_3) { echo 'style="color:#F00"'; } ?>><?php echo $order['pay_costs']; ?></span></td>
          <?php } ?>
          <?php if (in_array('mv_shipping_costs', $advsop_settings_mv_columns)) { ?>              
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><span <?php if ($advsop_formula_2) { echo 'style="color:#F00"'; } ?>><?php echo $order['ship_costs']; ?></span></td>  
          <?php } ?>
          <?php if (in_array('mv_extra_costs', $advsop_settings_mv_columns)) { ?>              
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><span <?php if ($advsop_formula_4) { echo 'style="color:#F00"'; } ?>><?php echo $order['extra_costs']; ?></span></td>  
          <?php } ?>
          <?php if (in_array('mv_return_costs', $advsop_settings_mv_columns)) { ?>              
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><span <?php if ($advsop_formula_5) { echo 'style="color:#F00"'; } ?>><?php echo $order['return_costs']; ?></span></td>  
          <?php } ?>                    
          <?php if (in_array('mv_shipping_balance', $advsop_settings_mv_columns)) { ?>           
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><?php echo $order['ship_balance']; ?></td>
          <?php } ?>
          <?php if (in_array('mv_total_costs', $advsop_settings_mv_columns)) { ?>                                                          
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'abandoned_orders') ? 'style="background-color:#ffd7d7; text-decoration:line-through;"' : 'style="background-color:#ffd7d7;"' ?> ><?php echo $order['total_costs']; ?></td>
          <?php } ?>
          <?php if (in_array('mv_total_profit', $advsop_settings_mv_columns)) { ?>             
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'abandoned_orders') ? (($order['total_profit_raw'] >= 0) ? 'style="background-color:#c4d9ee; font-weight:bold; text-decoration:line-through;"' : 'style="background-color:#F99; font-weight:bold; text-decoration:line-through;"') : (($order['total_profit_raw'] >= 0) ? 'style="background-color:#c4d9ee; font-weight:bold;"' : 'style="background-color:#F99; font-weight:bold;"') ?> ><?php echo $order['total_profit']; ?></td>
          <?php } ?>
          <?php if (in_array('mv_total_profit_prc', $advsop_settings_mv_columns)) { ?>           
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'abandoned_orders') ? (($order['total_profit_raw'] >= 0) ? 'style="background-color:#c4d9ee; font-weight:bold; text-decoration:line-through;"' : 'style="background-color:#F99; font-weight:bold; text-decoration:line-through;"') : (($order['total_profit_raw'] >= 0) ? 'style="background-color:#c4d9ee; font-weight:bold;"' : 'style="background-color:#F99; font-weight:bold;"') ?> ><?php echo $order['total_profit_prc']; ?></td>
          <?php } ?>
...
<div id="tab_details_<?php echo $order['order_id']; ?>" class="more" style="display:none;">
    <table class="list_detail">
      <thead>
        <tr>
          <?php if (in_array('ol_order_order_id', $advsop_settings_ol_columns)) { ?>
          <td class="left" nowrap="nowrap"><?php echo $column_order_order_id; ?></td>
          <?php } ?>
          <?php if (in_array('ol_order_date_added', $advsop_settings_ol_columns)) { ?>
          <td class="left" nowrap="nowrap"><?php echo $column_order_date_added; ?></td>
          <?php } ?>
          <?php if (in_array('ol_order_inv_no', $advsop_settings_ol_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_order_inv_no; ?></td> 
          <?php } ?>
          <?php if (in_array('ol_order_customer', $advsop_settings_ol_columns)) { ?>                           
          <td class="left" nowrap="nowrap"><?php echo $column_order_customer; ?></td>
          <?php } ?>
          <?php if (in_array('ol_order_email', $advsop_settings_ol_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_order_email; ?></td>
          <?php } ?>
          <?php if (in_array('ol_order_customer_group', $advsop_settings_ol_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_order_customer_group; ?></td>
          <?php } ?>
          <?php if (in_array('ol_order_shipping_method', $advsop_settings_ol_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_order_shipping_method; ?></td>
          <?php } ?>
          <?php if (in_array('ol_order_payment_method', $advsop_settings_ol_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_order_payment_method; ?></td>
          <?php } ?>
          <?php if (in_array('ol_order_status', $advsop_settings_ol_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_order_status; ?></td>
          <?php } ?>
          <?php if (in_array('ol_order_store', $advsop_settings_ol_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_order_store; ?></td>
          <?php } ?>
          <?php if (in_array('ol_order_currency', $advsop_settings_ol_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_order_currency; ?></td>
          <?php } ?>
          <?php if (in_array('ol_order_quantity', $advsop_settings_ol_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_order_quantity; ?></td>  
          <?php } ?>
          <?php if (in_array('ol_order_sub_total', $advsop_settings_ol_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_order_sub_total; ?></td>
          <?php } ?>
          <?php if (in_array('ol_order_shipping', $advsop_settings_ol_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_order_shipping; ?></td>
          <?php } ?>
          <?php if (in_array('ol_order_tax', $advsop_settings_ol_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_order_tax; ?></td>
          <?php } ?>
          <?php if ($filter_report == 'coupon') { ?>        
          <?php if (in_array('cr_coupon_amount', $advsop_settings_cr_columns)) { ?>          
          ...
          <?php } ?> 
          <?php } ?>
          <?php if (in_array('ol_order_value', $advsop_settings_ol_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_order_value; ?></td>
          <?php } ?>
          <?php if (in_array('ol_order_sales', $advsop_settings_ol_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_order_sales; ?></td>
          <?php } ?>
          <?php if (in_array('ol_order_costs', $advsop_settings_ol_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_order_costs; ?></td>
          <?php } ?>
          <?php if (in_array('ol_order_profit', $advsop_settings_ol_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_order_profit; ?></td>
          <?php } ?>
          <?php if (in_array('ol_order_profit_prc', $advsop_settings_ol_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_order_margin; ?></td>
          <?php } ?>
        </tr>
      </thead>
        <tr bgcolor="#FFFFFF">
          ...
          <?php } ?>
          <?php if (in_array('ol_order_sub_total', $advsop_settings_ol_columns)) { ?>          
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'abandoned_orders') ? 'style="color:#090; text-decoration:line-through;"' : 'style="color:#090;"' ?> ><?php echo $order['order_sub_total']; ?></td>
          <?php } ?>
          <?php if (in_array('ol_order_shipping', $advsop_settings_ol_columns)) { ?>          
          ...
          <?php if ($filter_report == 'coupon') { ?>        
          <?php if (in_array('cr_coupon_amount', $advsop_settings_cr_columns)) { ?>          
          <td class="right" nowrap="nowrap"<?php echo ($filter_report == 'abandoned_orders') ? 'style="color:#090; text-decoration:line-through;"' : 'style="color:#090;"' ?> ><?php echo $order['order_coupon']; ?></td>
          <?php } ?>  
          <?php } ?>
          <?php if ($filter_report == 'voucher') { ?>        
          <?php if (in_array('vr_voucher_used_value', $advsop_settings_vr_columns)) { ?>          
          <td class="right" nowrap="nowrap"<?php echo ($filter_report == 'abandoned_orders') ? 'style="color:#090; text-decoration:line-through;"' : 'style="color:#090;"' ?> ><?php echo $order['order_voucher']; ?></td>
          <?php } ?> 
          <?php } ?>          
          <?php if (in_array('ol_order_value', $advsop_settings_ol_columns)) { ?>          
          ...
          <?php } ?>
          <?php if (in_array('ol_order_sales', $advsop_settings_ol_columns)) { ?>          
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'abandoned_orders') ? 'style="background-color:#DCFFB9; text-decoration:line-through;"' : 'style="background-color:#DCFFB9;"' ?> ><?php echo $order['order_sales']; ?></td>
          <?php } ?>
          <?php if (in_array('ol_order_costs', $advsop_settings_ol_columns)) { ?>          
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'abandoned_orders') ? 'style="background-color:#ffd7d7; text-decoration:line-through;"' : 'style="background-color:#ffd7d7;"' ?> >-<?php echo $order['order_costs']; ?></td>
          <?php } ?>
          <?php if (in_array('ol_order_profit', $advsop_settings_ol_columns)) { ?>          
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'abandoned_orders') ? 'style="background-color:#c4d9ee; font-weight:bold; text-decoration:line-through;"' : 'style="background-color:#c4d9ee; font-weight:bold;"' ?> ><?php echo $order['order_profit']; ?></td>
          <?php } ?>
          <?php if (in_array('ol_order_profit_prc', $advsop_settings_ol_columns)) { ?>          
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'abandoned_orders') ? 'style="background-color:#c4d9ee; font-weight:bold; text-decoration:line-through;"' : 'style="background-color:#c4d9ee; font-weight:bold;"' ?> ><?php echo $order['order_profit_prc']; ?>%</td>
          <?php } ?>
         </tr>
    </table>  
    <table class="list_detail">
      <thead>
        <tr>
          <?php if (in_array('pl_prod_order_id', $advsop_settings_pl_columns)) { ?>
          <td class="left" nowrap="nowrap"><?php echo $column_prod_order_id; ?></td>
          <?php } ?>
          <?php if (in_array('pl_prod_date_added', $advsop_settings_pl_columns)) { ?>
          <td class="left" nowrap="nowrap"><?php echo $column_prod_date_added; ?></td>
          <?php } ?>        
          <?php if (in_array('pl_prod_id', $advsop_settings_pl_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_prod_id; ?></td>
          <?php } ?>
          <?php if (in_array('pl_prod_sku', $advsop_settings_pl_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_prod_sku; ?></td>
          <?php } ?>
          <?php if (in_array('pl_prod_model', $advsop_settings_pl_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_prod_model; ?></td>
          <?php } ?>
          <?php if (in_array('pl_prod_name', $advsop_settings_pl_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_prod_name; ?></td>
          <?php } ?>
          <?php if (in_array('pl_prod_option', $advsop_settings_pl_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_prod_option; ?></td>
          <?php } ?>
          <?php if (in_array('pl_prod_attributes', $advsop_settings_pl_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_prod_attributes; ?></td>
          <?php } ?>
          <?php if (in_array('pl_prod_category', $advsop_settings_pl_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_prod_category; ?></td>
          <?php } ?>          
          <?php if (in_array('pl_prod_manu', $advsop_settings_pl_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_prod_manu; ?></td>
          <?php } ?>
          <?php if (in_array('pl_prod_supplier', $advsop_settings_pl_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_prod_supplier; ?></td>
          <?php } ?>           
          <?php if (in_array('pl_prod_currency', $advsop_settings_pl_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_prod_currency; ?></td>
          <?php } ?>
          <?php if (in_array('pl_prod_price', $advsop_settings_pl_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_prod_price; ?></td>
          <?php } ?>
          <?php if (in_array('pl_prod_quantity', $advsop_settings_pl_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_prod_quantity; ?></td>
          <?php } ?>
          <?php if (in_array('pl_prod_total_excl_vat', $advsop_settings_pl_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_prod_total_excl_vat; ?></td>
          <?php } ?>
          <?php if (in_array('pl_prod_tax', $advsop_settings_pl_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_prod_tax; ?></td>
          <?php } ?>
          <?php if (in_array('pl_prod_total_incl_vat', $advsop_settings_pl_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_prod_total_incl_vat; ?></td>
          <?php } ?>
          <?php if (in_array('pl_prod_sales', $advsop_settings_pl_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_prod_sales; ?></td>
          <?php } ?>
          <?php if (in_array('pl_prod_cost', $advsop_settings_pl_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_prod_cost; ?></td>
          <?php } ?>
          <?php if (in_array('pl_prod_profit', $advsop_settings_pl_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_prod_profit; ?></td>
          <?php } ?>
          <?php if (in_array('pl_prod_profit_margin', $advsop_settings_pl_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_prod_profit_margin; ?></td>
          <?php } ?>
          <?php if (in_array('pl_prod_profit_markup', $advsop_settings_pl_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_prod_profit_markup; ?></td>
          <?php } ?>    
        </tr>
      </thead>
        <tr bgcolor="#FFFFFF">
          ...
          <?php } ?>
          <?php if (in_array('pl_prod_supplier', $advsop_settings_pl_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $order['product_supplier']; ?></td>
          <?php } ?>           
          <?php if (in_array('pl_prod_currency', $advsop_settings_pl_columns)) { ?>           
          ...
          <?php } ?>
          <?php if (in_array('pl_prod_total_excl_vat', $advsop_settings_pl_columns)) { ?>           
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'abandoned_orders') ? 'style="color:#090; text-decoration:line-through;"' : 'style="color:#090;"' ?> ><?php echo $order['product_total_excl_vat']; ?></td>
          <?php } ?>
          <?php if (in_array('pl_prod_tax', $advsop_settings_pl_columns)) { ?>           
          ...
          <?php } ?>
          <?php if (in_array('pl_prod_sales', $advsop_settings_pl_columns)) { ?>           
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'abandoned_orders') ? 'style="background-color:#DCFFB9; text-decoration:line-through;"' : 'style="background-color:#DCFFB9;"' ?> ><?php echo $order['product_sales']; ?></td>
          <?php } ?>
          <?php if (in_array('pl_prod_cost', $advsop_settings_pl_columns)) { ?>           
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'abandoned_orders') ? 'style="background-color:#ffd7d7; text-decoration:line-through;"' : 'style="background-color:#ffd7d7;"' ?> >-<?php echo $order['product_cost']; ?></td>
          <?php } ?>
          <?php if (in_array('pl_prod_profit', $advsop_settings_pl_columns)) { ?>           
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'abandoned_orders') ? 'style="background-color:#c4d9ee; font-weight:bold; text-decoration:line-through;"' : 'style="background-color:#c4d9ee; font-weight:bold;"' ?> ><?php echo $order['product_profit']; ?></td>
          <?php } ?>
          <?php if (in_array('pl_prod_profit_margin', $advsop_settings_pl_columns)) { ?>           
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'abandoned_orders') ? 'style="background-color:#c4d9ee; font-weight:bold; text-decoration:line-through;"' : 'style="background-color:#c4d9ee; font-weight:bold;"' ?> ><?php echo $order['product_profit_margin']; ?>%</td>
          <?php } ?>
          <?php if (in_array('pl_prod_profit_markup', $advsop_settings_pl_columns)) { ?>           
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'abandoned_orders') ? 'style="background-color:#c4d9ee; font-weight:bold; text-decoration:line-through;"' : 'style="background-color:#c4d9ee; font-weight:bold;"' ?> ><?php echo $order['product_profit_markup']; ?>%</td>
          <?php } ?>         
         </tr>       
    </table>
    <table class="list_detail">
      <thead>
        <tr>
          <?php if (in_array('cl_customer_order_id', $advsop_settings_cl_columns)) { ?>
          <td class="left" nowrap="nowrap"><?php echo $column_customer_order_id; ?></td>
          <?php } ?>
          <?php if (in_array('cl_customer_date_added', $advsop_settings_cl_columns)) { ?>
          <td class="left" nowrap="nowrap"><?php echo $column_customer_date_added; ?></td>
          <?php } ?>         
          <?php if (in_array('cl_customer_cust_id', $advsop_settings_cl_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_customer_cust_id; ?></td>
          <?php } ?>
          <?php if (in_array('cl_billing_name', $advsop_settings_cl_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_billing_name; ?></td>
          <?php } ?>
          <?php if (in_array('cl_billing_company', $advsop_settings_cl_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_billing_company; ?></td>
          <?php } ?>
          <?php if (in_array('cl_billing_address_1', $advsop_settings_cl_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_billing_address_1; ?></td> 
          <?php } ?>
          <?php if (in_array('cl_billing_address_2', $advsop_settings_cl_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_billing_address_2; ?></td> 
          <?php } ?>
          <?php if (in_array('cl_billing_city', $advsop_settings_cl_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_billing_city; ?></td>
          <?php } ?>
          <?php if (in_array('cl_billing_zone', $advsop_settings_cl_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_billing_zone; ?></td> 
          <?php } ?>
          <?php if (in_array('cl_billing_postcode', $advsop_settings_cl_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_billing_postcode; ?></td>
          <?php } ?>
          <?php if (in_array('cl_billing_country', $advsop_settings_cl_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_billing_country; ?></td>
          <?php } ?>
          <?php if (in_array('cl_customer_telephone', $advsop_settings_cl_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_customer_telephone; ?></td>
          <?php } ?>
          <?php if (in_array('cl_shipping_name', $advsop_settings_cl_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_shipping_name; ?></td> 
          <?php } ?>
          <?php if (in_array('cl_shipping_company', $advsop_settings_cl_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_shipping_company; ?></td> 
          <?php } ?>
          <?php if (in_array('cl_shipping_address_1', $advsop_settings_cl_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_shipping_address_1; ?></td> 
          <?php } ?>
          <?php if (in_array('cl_shipping_address_2', $advsop_settings_cl_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_shipping_address_2; ?></td> 
          <?php } ?>
          <?php if (in_array('cl_shipping_city', $advsop_settings_cl_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_shipping_city; ?></td>
          <?php } ?>
          <?php if (in_array('cl_shipping_zone', $advsop_settings_cl_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_shipping_zone; ?></td> 
          <?php } ?>
          <?php if (in_array('cl_shipping_postcode', $advsop_settings_cl_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_shipping_postcode; ?></td>
          <?php } ?>
          <?php if (in_array('cl_shipping_country', $advsop_settings_cl_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_shipping_country; ?></td>
          <?php } ?>          
        </tr>
      </thead>
...
<?php } ?>
        ...
        <tr>
          ...
          <?php } ?>
          <?php if (in_array('mv_discount', $advsop_settings_mv_columns)) { ?>            
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'abandoned_orders') ? 'style="background-color:#E7EFEF; color:#003A88; text-decoration:line-through;"' : 'style="background-color:#E7EFEF; color:#003A88;"' ?> ><strong><?php echo $order['discount_total']; ?></strong></td> 
          <?php } ?>
          <?php if (in_array('mv_total', $advsop_settings_mv_columns)) { ?>            
          ...
          <?php } ?>                    
          <?php if (in_array('mv_total_sales', $advsop_settings_mv_columns)) { ?>            
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'abandoned_orders') ? 'style="background-color:#DCFFB9; color:#003A88; text-decoration:line-through;"' : 'style="background-color:#DCFFB9; color:#003A88;"' ?> ><strong><?php echo $order['total_sales_total']; ?></strong></td>
          <?php } ?>
          <?php if (in_array('mv_product_costs', $advsop_settings_mv_columns)) { ?>
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'abandoned_orders') ? 'style="background-color:#E7EFEF; color:#003A88; text-decoration:line-through;"' : 'style="background-color:#E7EFEF; color:#003A88;"' ?> ><strong><?php echo $order['prod_costs_total']; ?></strong></td>
          <?php } ?>
          <?php if (in_array('mv_commission', $advsop_settings_mv_columns)) { ?>          
          ...
          <?php } ?>
          <?php if (in_array('mv_payment_costs', $advsop_settings_mv_columns)) { ?>           
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'abandoned_orders') ? 'style="background-color:#E7EFEF; color:#003A88; text-decoration:line-through;"' : 'style="background-color:#E7EFEF; color:#003A88;"' ?> ><strong><?php echo $order['pay_costs_total']; ?></strong></td> 
          <?php } ?>
          <?php if (in_array('mv_shipping_costs', $advsop_settings_mv_columns)) { ?>             
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'abandoned_orders') ? 'style="background-color:#E7EFEF; color:#003A88; text-decoration:line-through;"' : 'style="background-color:#E7EFEF; color:#003A88;"' ?> ><strong><?php echo $order['ship_costs_total']; ?></strong></td> 
          <?php } ?>
          <?php if (in_array('mv_extra_costs', $advsop_settings_mv_columns)) { ?>             
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'abandoned_orders') ? 'style="background-color:#E7EFEF; color:#003A88; text-decoration:line-through;"' : 'style="background-color:#E7EFEF; color:#003A88;"' ?> ><strong><?php echo $order['extra_costs_total']; ?></strong></td> 
          <?php } ?>
          <?php if (in_array('mv_return_costs', $advsop_settings_mv_columns)) { ?>             
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'abandoned_orders') ? 'style="background-color:#E7EFEF; color:#003A88; text-decoration:line-through;"' : 'style="background-color:#E7EFEF; color:#003A88;"' ?> ><strong><?php echo $order['return_costs_total']; ?></strong></td> 
          <?php } ?>                    
          <?php if (in_array('mv_shipping_balance', $advsop_settings_mv_columns)) { ?>            
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'abandoned_orders') ? 'style="background-color:#E7EFEF; color:#003A88; text-decoration:line-through;"' : 'style="background-color:#E7EFEF; color:#003A88;"' ?> ><strong><?php echo $order['ship_balance_total']; ?></strong></td>
          <?php } ?>
          <?php if (in_array('mv_total_costs', $advsop_settings_mv_columns)) { ?>             
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'abandoned_orders') ? 'style="background-color:#ffd7d7; color:#003A88; text-decoration:line-through;"' : 'style="background-color:#ffd7d7; color:#003A88;"' ?> ><strong><?php echo $order['total_costs_total']; ?></strong></td>
          <?php } ?>
          <?php if (in_array('mv_total_profit', $advsop_settings_mv_columns)) { ?>           
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'abandoned_orders') ? (($order['total_profit_total_raw'] >= 0) ? 'style="background-color:#c4d9ee; color:#003A88; text-decoration:line-through;"' : 'style="background-color:#F99; color:#003A88; text-decoration:line-through;"') : (($order['total_profit_total_raw'] >= 0) ? 'style="background-color:#c4d9ee; color:#003A88;"' : 'style="background-color:#F99; color:#003A88;"') ?> ><strong><?php echo $order['total_profit_total']; ?></strong></td>
          <?php } ?>
          <?php if (in_array('mv_total_profit_prc', $advsop_settings_mv_columns)) { ?>           
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'abandoned_orders') ? (($order['total_profit_total_raw'] >= 0) ? 'style="background-color:#c4d9ee; color:#003A88; text-decoration:line-through;"' : 'style="background-color:#F99; color:#003A88; text-decoration:line-through;"') : (($order['total_profit_total_raw'] >= 0) ? 'style="background-color:#c4d9ee; color:#003A88;"' : 'style="background-color:#F99; color:#003A88;"') ?> ><strong><?php echo $order['total_profit_total_prc']; ?></strong></td>
          <?php } ?>     
          <?php if ($filter_details == 'basic_details') { ?><td></td><?php } ?>
          <?php } ?>            
        </tr>
...
<script type="text/javascript">
function filter() {
	url = 'index.php?route=extension/report/adv_sales_profit&user_token=<?php echo $user_token; ?>';										 
...
function deleteCookie(name) {
	...
	var initCookies = function() {
		setCookie('show-sop-chart', 1, 365);
		$('.chart-switcher').removeClass('hide-chart');
		$(".chart_button").html('<span>Hide <?php echo $button_chart; ?></span>');
	};
	
	if (getCookie('show-sop-chart') == 1) {
		$('.chart-switcher').show();
		$(".chart_button").html('<span>Hide <?php echo $button_chart; ?></span>');
	} else if (getCookie('show-sop-chart') == 2) {
		$('.chart-switcher').hide();
	...
	$(document).on('click', '.chart-button', function(e) {
		...
		if (getCookie('show-sop-chart') == 1) {
			$('.chart-switcher').hide();
			setCookie('show-sop-chart', 2, 365);
			$(".chart_button").html('<span>Show <?php echo $button_chart; ?></span>');
		} else if (getCookie('show-sop-chart') == 2) {
			$('.chart-switcher').show();
			setCookie('show-sop-chart', 1, 365);
	...
	$(document).on('click', '.filters-button', function(e) {
		...
		if (getCookie('show-sop-filters') == 1) {
			$('.filters-switcher').hide();
			setCookie('show-sop-filters', 2, 365);
			$(".filters_button").html('<span>Show <?php echo $button_filters; ?></span>');
		} else if (getCookie('show-sop-filters') == 2) {
			$('.filters-switcher').show();
			setCookie('show-sop-filters', 1, 365);
...
$('input[name=\'filter_customer_name\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_sales_profit/customer_autocomplete&user_token=<?php echo $user_token; ?>&filter_customer_name=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
...
$('input[name=\'filter_customer_email\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_sales_profit/customer_autocomplete&user_token=<?php echo $user_token; ?>&filter_customer_email=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_customer_telephone\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_sales_profit/customer_autocomplete&user_token=<?php echo $user_token; ?>&filter_customer_telephone=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_ip\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_sales_profit/customer_autocomplete&user_token=<?php echo $user_token; ?>&filter_ip=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_payment_company\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_sales_profit/customer_autocomplete&user_token=<?php echo $user_token; ?>&filter_payment_company=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_payment_address\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_sales_profit/customer_autocomplete&user_token=<?php echo $user_token; ?>&filter_payment_address=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_payment_city\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_sales_profit/customer_autocomplete&user_token=<?php echo $user_token; ?>&filter_payment_city=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_payment_zone\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_sales_profit/customer_autocomplete&user_token=<?php echo $user_token; ?>&filter_payment_zone=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_payment_postcode\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_sales_profit/customer_autocomplete&user_token=<?php echo $user_token; ?>&filter_payment_postcode=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_payment_country\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_sales_profit/customer_autocomplete&user_token=<?php echo $user_token; ?>&filter_payment_country=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_shipping_company\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_sales_profit/customer_autocomplete&user_token=<?php echo $user_token; ?>&filter_shipping_company=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_shipping_address\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_sales_profit/customer_autocomplete&user_token=<?php echo $user_token; ?>&filter_shipping_address=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_shipping_city\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_sales_profit/customer_autocomplete&user_token=<?php echo $user_token; ?>&filter_shipping_city=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_shipping_zone\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_sales_profit/customer_autocomplete&user_token=<?php echo $user_token; ?>&filter_shipping_zone=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_shipping_postcode\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_sales_profit/customer_autocomplete&user_token=<?php echo $user_token; ?>&filter_shipping_postcode=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_shipping_country\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_sales_profit/customer_autocomplete&user_token=<?php echo $user_token; ?>&filter_shipping_country=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_sku\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_sales_profit/product_autocomplete&user_token=<?php echo $user_token; ?>&filter_sku=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_product_name\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_sales_profit/product_autocomplete&user_token=<?php echo $user_token; ?>&filter_product_name=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_model\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_sales_profit/product_autocomplete&user_token=<?php echo $user_token; ?>&filter_model=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_coupon_code\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_sales_profit/coupon_autocomplete&user_token=<?php echo $user_token; ?>&filter_coupon_code=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_voucher_code\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_sales_profit/voucher_autocomplete&user_token=<?php echo $user_token; ?>&filter_voucher_code=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_campaign_code\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_sales_profit/campaign_autocomplete&user_token=<?php echo $user_token; ?>&filter_campaign_code=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('#save_settings').on('click', function(){
	$.ajax ({
		url: 'index.php?route=extension/report/adv_sales_profit/settings&user_token=<?php echo $user_token; ?>',		
		type: 'post',
...
$('#save_report').on('click', function(){
	$.ajax ({
		url: 'index.php?route=extension/report/adv_sales_profit/load_save_report&user_token=<?php echo $user_token; ?>',		
		type: 'post',
...
function addSaveReport() {
	...
	html += '<tr>';
	html += '<td width="5%"></td>';	
	html += '<td width="45%" class="text-left"><input type="text" name="advsop_load_save_report[' + adv_load_save_reports_row + '][save_report_title]" placeholder="<?php echo $text_report_title; ?>" value="" class="form-control" style="background-color:#f7e9e3;" /></td>';
	html += '<td width="40%" class="text-left"><textarea readonly name="advsop_load_save_report[' + adv_load_save_reports_row + '][save_report_link]" class="form-control"><?php echo $save_report_link; ?></textarea></td>';
	html += '<td width="10%"></td>';
	html += '</tr>';
	html += '</tbody>';
...
function addCron() {
	...
	html += '<input type="hidden" id="cron_id_save" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_id]" value="" />';
	html += '<input type="hidden" id="cron_report_type_save" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_report_type]" value="" />';
	html += '<input type="hidden" id="cron_export_type_save" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_export_type]" value="" />';
	html += '<input type="hidden" id="cron_export_logo_criteria_save" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_export_logo_criteria]" value="" />';
	html += '<input type="hidden" id="cron_export_csv_delimiter_save" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_export_csv_delimiter]" value="" />';
	html += '<input type="hidden" id="cron_export_file_save" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_export_file]" value="" />';
	html += '<input type="hidden" id="cron_file_save_path_save" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_file_save_path]" value="" />';
	html += '<input type="hidden" id="cron_file_name_save" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_file_name]" value="" />';
	html += '<input type="hidden" id="cron_email_save" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_email]" value="" />';
	html += '<input type="hidden" id="cron_user_save" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_user]" value="" />';
	html += '<input type="hidden" id="cron_pass_save" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_pass]" value="" />';
	html += '<input type="hidden" id="cron_token_save" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_token]" value="" />';
	html += '<input type="hidden" id="cron_user_id_save" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_user_id]" value="" />';
	
	html += '<input type="hidden" id="cron_filter_report" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_filter_report]" value="" />';
	html += '<input type="hidden" id="cron_filter_details" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_filter_details]" value="" />';
	html += '<input type="hidden" id="cron_filter_group" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_filter_group]" value="" />';
	html += '<input type="hidden" id="cron_filter_sort" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_filter_sort]" value="" />';
	html += '<input type="hidden" id="cron_filter_order" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_filter_order]" value="" />';
	html += '<input type="hidden" id="cron_filter_limit" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_filter_limit]" value="" />';
	
	html += '<input type="hidden" id="cron_filter_range" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_filter_range]" value="" />';
	html += '<input type="hidden" id="cron_date_start" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_date_start]" value="" />';
	html += '<input type="hidden" id="cron_date_end" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_date_end]" value="" />';
	html += '<input type="hidden" id="cron_filter_order_status_id" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_filter_order_status_id]" value="" />';
	html += '<input type="hidden" id="cron_status_date_start" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_status_date_start]" value="" />';
	html += '<input type="hidden" id="cron_status_date_end" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_status_date_end]" value="" />';
	html += '<input type="hidden" id="cron_filter_order_id_from" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_filter_order_id_from]" value="" />';
	html += '<input type="hidden" id="cron_filter_order_id_to" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_filter_order_id_to]" value="" />';
	html += '<input type="hidden" id="cron_filter_order_value_min" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_filter_order_value_min]" value="" />';
	html += '<input type="hidden" id="cron_filter_order_value_max" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_filter_order_value_max]" value="" />';
	html += '<input type="hidden" id="cron_filter_store_id" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_filter_store_id]" value="" />';
	html += '<input type="hidden" id="cron_filter_currency" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_filter_currency]" value="" />';
	html += '<input type="hidden" id="cron_filter_taxes" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_filter_taxes]" value="" />';
	html += '<input type="hidden" id="cron_filter_tax_classes" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_filter_tax_classes]" value="" />';
	html += '<input type="hidden" id="cron_filter_geo_zones" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_filter_geo_zones]" value="" />';
	html += '<input type="hidden" id="cron_filter_customer_group_id" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_filter_customer_group_id]" value="" />';
	html += '<input type="hidden" id="cron_filter_customer_name" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_filter_customer_name]" value="" />';
	html += '<input type="hidden" id="cron_filter_customer_email" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_filter_customer_email]" value="" />';
	html += '<input type="hidden" id="cron_filter_customer_telephone" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_filter_customer_telephone]" value="" />';
	html += '<input type="hidden" id="cron_filter_ip" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_filter_ip]" value="" />';
	html += '<input type="hidden" id="cron_filter_payment_company" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_filter_payment_company]" value="" />';
	html += '<input type="hidden" id="cron_filter_payment_address" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_filter_payment_address]" value="" />';
	html += '<input type="hidden" id="cron_filter_payment_city" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_filter_payment_city]" value="" />';
	html += '<input type="hidden" id="cron_filter_payment_zone" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_filter_payment_zone]" value="" />';
	html += '<input type="hidden" id="cron_filter_payment_postcode" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_filter_payment_postcode]" value="" />';
	html += '<input type="hidden" id="cron_filter_payment_country" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_filter_payment_country]" value="" />';
	html += '<input type="hidden" id="cron_filter_payment_method" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_filter_payment_method]" value="" />';
	html += '<input type="hidden" id="cron_filter_shipping_company" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_filter_shipping_company]" value="" />';
	html += '<input type="hidden" id="cron_filter_shipping_address" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_filter_shipping_address]" value="" />';
	html += '<input type="hidden" id="cron_filter_shipping_city" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_filter_shipping_city]" value="" />';
	html += '<input type="hidden" id="cron_filter_shipping_zone" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_filter_shipping_zone]" value="" />';
	html += '<input type="hidden" id="cron_filter_shipping_postcode" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_filter_shipping_postcode]" value="" />';
	html += '<input type="hidden" id="cron_filter_shipping_country" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_filter_shipping_country]" value="" />';
	html += '<input type="hidden" id="cron_filter_shipping_method" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_filter_shipping_method]" value="" />';
	html += '<input type="hidden" id="cron_filter_category" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_filter_category]" value="" />';
	html += '<input type="hidden" id="cron_filter_manufacturer" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_filter_manufacturer]" value="" />';
	html += '<input type="hidden" id="cron_filter_supplier" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_filter_supplier]" value="" />';
	html += '<input type="hidden" id="cron_filter_sku" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_filter_sku]" value="" />';
	html += '<input type="hidden" id="cron_filter_product_name" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_filter_product_name]" value="" />';
	html += '<input type="hidden" id="cron_filter_model" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_filter_model]" value="" />';
	html += '<input type="hidden" id="cron_filter_option" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_filter_option]" value="" />';
	html += '<input type="hidden" id="cron_filter_attribute" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_filter_attribute]" value="" />';
	html += '<input type="hidden" id="cron_filter_location" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_filter_location]" value="" />';
	html += '<input type="hidden" id="cron_filter_coupon_name" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_filter_coupon_name]" value="" />';
	html += '<input type="hidden" id="cron_filter_coupon_code" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_filter_coupon_code]" value="" />';
	html += '<input type="hidden" id="cron_filter_voucher_code" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_filter_voucher_code]" value="" />';
	html += '<input type="hidden" id="cron_filter_campaign_name" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_filter_campaign_name]" value="" />';
	html += '<input type="hidden" id="cron_filter_campaign_code" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_filter_campaign_code]" value="" />';
	
	html += '<input type="text" name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_title]" placeholder="<?php echo $text_cron_title; ?>" value="" class="form-control" style="background-color:#f7e9e3;" /></td>';
	html += '<td width="45%" class="text-left"><textarea id="cron_command" readonly name="advsop_cron_setting[' + adv_cron_settings_row + '][cron_command]" class="form-control"></textarea></td>';
	html += '<td width="10%"></td>';
	html += '</tr>';
	html += '</tbody>';
...
$('#export_report').on('click', function(){
	var url_exp ='index.php?route=extension/report/adv_sales_profit/export&user_token=<?php echo $user_token; ?>';
	...
	$.ajax ({
		url: 'index.php?route=extension/report/adv_sales_profit/export_validate&user_token=<?php echo $user_token; ?>',
		type: 'post',
...
$('#save_cron').on('click', function(){
	...
	$.ajax ({
		url: 'index.php?route=extension/report/adv_sales_profit/cron&user_token=<?php echo $user_token; ?>',		
		type: 'post',
...
function cron_command() {
	...
	var addr = link+"&cron_route="+"extension/report/adv_sales_profit"+"&user_id="+user+"&cron_token="+token+"&cron_id="+id+"&cron=1";
...
function checkValidOptions() {
  ...
  var filter_details = document.getElementById('filter_details');
    ...
    if (filter_report.options[0].selected === true || filter_report.options[1].selected === true || filter_report.options[2].selected === true || filter_report.options[3].selected === true || filter_report.options[4].selected === true || filter_report.options[5].selected === true || filter_report.options[7].selected === true || filter_report.options[8].selected === true || filter_report.options[9].selected === true || filter_report.options[10].selected === true || filter_report.options[11].selected === true || filter_report.options[12].selected === true || filter_report.options[13].selected === true || filter_report.options[14].selected === true || filter_report.options[16].selected === true) {
		<?php if ($filter_report == 'tax') { ?>
		<?php if (in_array('tr_tax_name', $advsop_settings_tr_columns)) { ?>document.getElementById("tax_name").disabled = true;<?php } ?>
		<?php if (in_array('tr_tax_rate', $advsop_settings_tr_columns)) { ?>document.getElementById("tax_rate").disabled = true;<?php } ?>
		<?php if (in_array('tr_tax_orders', $advsop_settings_tr_columns)) { ?>document.getElementById("tax_orders").disabled = true;<?php } ?>
		<?php if (in_array('tr_tax_total', $advsop_settings_tr_columns)) { ?>document.getElementById("tax_total").disabled = true;<?php } ?>
		<?php } ?>	
	}	
    if (filter_report.options[0].selected === true || filter_report.options[1].selected === true || filter_report.options[2].selected === true || filter_report.options[3].selected === true || filter_report.options[4].selected === true || filter_report.options[5].selected === true || filter_report.options[6].selected === true || filter_report.options[7].selected === true || filter_report.options[8].selected === true || filter_report.options[9].selected === true || filter_report.options[10].selected === true || filter_report.options[11].selected === true || filter_report.options[12].selected === true || filter_report.options[14].selected === true || filter_report.options[16].selected === true) {
		<?php if ($filter_report == 'coupon') { ?>
		<?php if (in_array('cr_coupon_name', $advsop_settings_cr_columns)) { ?>document.getElementById("coupon_name").disabled = true;<?php } ?>
		<?php if (in_array('cr_coupon_code', $advsop_settings_cr_columns)) { ?>document.getElementById("coupon_code").disabled = true;<?php } ?>
		<?php if (in_array('cr_coupon_discount', $advsop_settings_cr_columns)) { ?>document.getElementById("coupon_discount").disabled = true;<?php } ?>
		<?php if (in_array('cr_coupon_type', $advsop_settings_cr_columns)) { ?>document.getElementById("coupon_type").disabled = true;<?php } ?>
		<?php if (in_array('cr_coupon_status', $advsop_settings_cr_columns)) { ?>document.getElementById("coupon_status").disabled = true;<?php } ?>
		<?php if (in_array('cr_coupon_last_used', $advsop_settings_cr_columns)) { ?>document.getElementById("coupon_last_used").disabled = true;<?php } ?>
		<?php if (in_array('cr_coupon_amount', $advsop_settings_cr_columns)) { ?>document.getElementById("coupon_amount").disabled = true;<?php } ?>
		<?php if (in_array('cr_coupon_orders', $advsop_settings_cr_columns)) { ?>document.getElementById("coupon_orders").disabled = true;<?php } ?>
		<?php if (in_array('cr_coupon_total', $advsop_settings_cr_columns)) { ?>document.getElementById("coupon_total").disabled = true;<?php } ?>
		<?php } ?>	
	}		
    if (filter_report.options[0].selected === true || filter_report.options[1].selected === true || filter_report.options[2].selected === true || filter_report.options[3].selected === true || filter_report.options[4].selected === true || filter_report.options[5].selected === true || filter_report.options[6].selected === true || filter_report.options[7].selected === true || filter_report.options[8].selected === true || filter_report.options[9].selected === true || filter_report.options[10].selected === true || filter_report.options[11].selected === true || filter_report.options[12].selected === true || filter_report.options[13].selected === true || filter_report.options[16].selected === true) {
		<?php if ($filter_report == 'voucher') { ?>
		<?php if (in_array('vr_voucher_code', $advsop_settings_vr_columns)) { ?>document.getElementById("voucher_code").disabled = true;<?php } ?>
		<?php if (in_array('vr_voucher_from_name', $advsop_settings_vr_columns)) { ?>document.getElementById("voucher_from_name").disabled = true;<?php } ?>
		<?php if (in_array('vr_voucher_from_email', $advsop_settings_vr_columns)) { ?>document.getElementById("voucher_from_email").disabled = true;<?php } ?>
		<?php if (in_array('vr_voucher_to_name', $advsop_settings_vr_columns)) { ?>document.getElementById("voucher_to_name").disabled = true;<?php } ?>
		<?php if (in_array('vr_voucher_to_email', $advsop_settings_vr_columns)) { ?>document.getElementById("voucher_to_email").disabled = true;<?php } ?>
		<?php if (in_array('vr_voucher_theme', $advsop_settings_vr_columns)) { ?>document.getElementById("voucher_theme").disabled = true;<?php } ?>
		<?php if (in_array('vr_voucher_status', $advsop_settings_vr_columns)) { ?>document.getElementById("voucher_status").disabled = true;<?php } ?>
		<?php if (in_array('vr_voucher_date_added', $advsop_settings_vr_columns)) { ?>document.getElementById("voucher_date_added").disabled = true;<?php } ?>
		<?php if (in_array('vr_voucher_amount', $advsop_settings_vr_columns)) { ?>document.getElementById("voucher_amount").disabled = true;<?php } ?>
		<?php if (in_array('vr_voucher_used_value', $advsop_settings_vr_columns)) { ?>document.getElementById("voucher_used_value").disabled = true;<?php } ?>
		<?php if (in_array('vr_voucher_remaining_value', $advsop_settings_vr_columns)) { ?>document.getElementById("voucher_remaining_value").disabled = true;<?php } ?>
		<?php if (in_array('vr_voucher_orders', $advsop_settings_vr_columns)) { ?>document.getElementById("voucher_orders").disabled = true;<?php } ?>
		<?php if (in_array('vr_voucher_total', $advsop_settings_vr_columns)) { ?>document.getElementById("voucher_total").disabled = true;<?php } ?>
		<?php } ?>	
	}		
    if (filter_report.options[6].selected === true || filter_report.options[13].selected === true || filter_report.options[14].selected === true || filter_details.options[2].selected === true || filter_details.options[3].selected === true) {
		<?php if ($filter_report != 'tax' && $filter_report != 'coupon' && $filter_report != 'voucher') { ?>           
		<?php if (in_array('mv_orders', $advsop_settings_mv_columns)) { ?>document.getElementById("orders").disabled = true;<?php } ?>
		<?php if (in_array('mv_customers', $advsop_settings_mv_columns)) { ?>document.getElementById("customers").disabled = true;<?php } ?>
		<?php if (in_array('mv_products', $advsop_settings_mv_columns)) { ?>document.getElementById("products").disabled = true;<?php } ?>
		<?php if (in_array('mv_sub_total', $advsop_settings_mv_columns)) { ?>document.getElementById("sub_total").disabled = true;<?php } ?>
		<?php if (in_array('mv_shipping', $advsop_settings_mv_columns)) { ?>document.getElementById("shipping").disabled = true;<?php } ?>
		<?php if (in_array('mv_reward', $advsop_settings_mv_columns)) { ?>document.getElementById("reward").disabled = true;<?php } ?>
		<?php if (in_array('mv_earned_points', $advsop_settings_mv_columns)) { ?>document.getElementById("earned_reward_points").disabled = true;<?php } ?>
		<?php if (in_array('mv_used_points', $advsop_settings_mv_columns)) { ?>document.getElementById("used_reward_points").disabled = true;<?php } ?>
		<?php if (in_array('mv_coupon', $advsop_settings_mv_columns)) { ?>document.getElementById("coupon").disabled = true;<?php } ?>
		<?php if (in_array('mv_tax', $advsop_settings_mv_columns)) { ?>document.getElementById("tax").disabled = true;<?php } ?>
		<?php if (in_array('mv_credit', $advsop_settings_mv_columns)) { ?>document.getElementById("credit").disabled = true;<?php } ?>
		<?php if (in_array('mv_voucher', $advsop_settings_mv_columns)) { ?>document.getElementById("voucher").disabled = true;<?php } ?>
		<?php if (in_array('mv_discount', $advsop_settings_mv_columns)) { ?>document.getElementById("discount").disabled = true;<?php } ?>
		<?php if (in_array('mv_total', $advsop_settings_mv_columns)) { ?>document.getElementById("total").disabled = true;<?php } ?>
		<?php if (in_array('mv_aov', $advsop_settings_mv_columns)) { ?>document.getElementById("aov").disabled = true;<?php } ?>
		<?php if (in_array('mv_refunds', $advsop_settings_mv_columns)) { ?>document.getElementById("refunds").disabled = true;<?php } ?>
		<?php if (in_array('mv_total_sales', $advsop_settings_mv_columns)) { ?>document.getElementById("total_sales").disabled = true;<?php } ?>
		<?php if (in_array('mv_product_costs', $advsop_settings_mv_columns)) { ?>document.getElementById("prod_costs").disabled = true;<?php } ?>
		<?php if (in_array('mv_commission', $advsop_settings_mv_columns)) { ?>document.getElementById("commission").disabled = true;<?php } ?>
		<?php if (in_array('mv_payment_costs', $advsop_settings_mv_columns)) { ?>document.getElementById("pay_costs").disabled = true;<?php } ?>
		<?php if (in_array('mv_shipping_costs', $advsop_settings_mv_columns)) { ?>document.getElementById("ship_costs").disabled = true;<?php } ?>
		<?php if (in_array('mv_extra_costs', $advsop_settings_mv_columns)) { ?>document.getElementById("extra_cost").disabled = true;<?php } ?>
		<?php if (in_array('mv_return_costs', $advsop_settings_mv_columns)) { ?>document.getElementById("return_cost").disabled = true;<?php } ?>
		<?php if (in_array('mv_shipping_balance', $advsop_settings_mv_columns)) { ?>document.getElementById("ship_balance").disabled = true;<?php } ?>
		<?php if (in_array('mv_total_costs', $advsop_settings_mv_columns)) { ?>document.getElementById("total_costs").disabled = true;<?php } ?>
		<?php if (in_array('mv_total_profit', $advsop_settings_mv_columns)) { ?>document.getElementById("total_profit").disabled = true;<?php } ?>
		<?php if (in_array('mv_total_profit_prc', $advsop_settings_mv_columns)) { ?>document.getElementById("total_profit_prc").disabled = true;<?php } ?>
		<?php } ?>
	}	

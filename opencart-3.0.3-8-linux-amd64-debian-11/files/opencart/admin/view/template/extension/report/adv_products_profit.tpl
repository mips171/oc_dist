	  ...
	  <div class="btn-group" style="margin-bottom:10px;">
		<button type="button" class="btn btn-set dropdown-toggle" data-toggle="dropdown" title="<?php echo $button_settings; ?>"><i class="fa fa-cog"></i> <?php echo $button_settings; ?> <span class="caret"></span></button>
		  <ul class="dropdown-menu">
			...
			<li class="divider"></li>
			<li><a href="<?php echo $settings; ?>"><i class="fa fa-cogs" style="font-size:small;"></i> <?php echo $text_module_settings; ?></a></li>
		  </ul>
	  </div>&nbsp;      
      <button type="button" onclick="window.open('http://www.opencartreports.com/documentation/ppp/index.html');" title="<?php echo $button_documentation; ?>" class="btn btn-warning" style="margin-bottom:10px;"><i class="fa fa-book"></i> <?php echo $button_documentation; ?></button>
      <div class="row">
...
<div class="well">
    ...
    <div id="filters" class="row filters-switcher <?php echo (isset($_COOKIE['show-ppp-filters']) && $_COOKIE['show-ppp-filters'] == 1) ? '' : 'row hide-filters'; ?>">   
      <?php if (in_array('store', $advppp_settings_filters)) { ?>
	  ...
	  <?php } ?>      
      <?php if ($filter_report != 'all_products_with_without_orders' && $filter_report != 'products_without_orders' && $filter_report != 'products_shopping_carts' && $filter_report != 'products_wishlists') { ?>
	  <?php if (in_array('currency', $advppp_settings_filters)) { ?>  
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>
      <?php if ($filter_report != 'all_products_with_without_orders' && $filter_report != 'products_without_orders' && $filter_report != 'products_shopping_carts' && $filter_report != 'products_wishlists') { ?>     
	  <?php if (in_array('tax', $advppp_settings_filters)) { ?>
    	<div class="col-lg-2" style="height:75px;">
	  ...
	  <?php } ?>
      <?php } ?>
	  <?php if (in_array('tax_class', $advppp_settings_filters)) { ?>
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>
      <?php if ($filter_report != 'all_products_with_without_orders' && $filter_report != 'products_without_orders' && $filter_report != 'products_shopping_carts' && $filter_report != 'products_wishlists') { ?>     
	  <?php if (in_array('geo_zone', $advppp_settings_filters)) { ?>
    	<div class="col-lg-2" style="height:75px;">
	  ...
	  <?php } ?>   
      <?php if ($filter_report != 'all_products_with_without_orders' && $filter_report != 'products_without_orders' && $filter_report != 'products_shopping_carts' && $filter_report != 'products_wishlists') { ?>     
	  <?php if (in_array('customer_group', $advppp_settings_filters)) { ?>
    	<div class="col-lg-2" style="height:75px;">
	  ...
	  <?php } ?>   
      <?php if ($filter_report != 'all_products_with_without_orders' && $filter_report != 'products_without_orders' && $filter_report != 'products_shopping_carts' && $filter_report != 'products_wishlists') { ?>     
      <?php if (in_array('customer_name', $advppp_settings_filters)) { ?>
    	<div class="col-lg-2" style="height:75px;">
	  ...
	  <?php } ?>   
      <?php if ($filter_report != 'all_products_with_without_orders' && $filter_report != 'products_without_orders' && $filter_report != 'products_shopping_carts' && $filter_report != 'products_wishlists') { ?>     
      <?php if (in_array('customer_email', $advppp_settings_filters)) { ?>
    	<div class="col-lg-2" style="height:75px;">
	  ...
	  <?php } ?>   
      <?php if ($filter_report != 'all_products_with_without_orders' && $filter_report != 'products_without_orders' && $filter_report != 'products_shopping_carts' && $filter_report != 'products_wishlists') { ?>     
      <?php if (in_array('customer_telephone', $advppp_settings_filters)) { ?>
    	<div class="col-lg-2" style="height:75px;">
	  ...
	  <?php } ?>   
      <?php if ($filter_report != 'all_products_with_without_orders' && $filter_report != 'products_without_orders' && $filter_report != 'products_shopping_carts' && $filter_report != 'products_wishlists') { ?>     
      <?php if (in_array('ip', $advppp_settings_filters)) { ?>
    	<div class="col-lg-2" style="height:75px;">
	  ...
	  <?php } ?>   
      <?php if ($filter_report != 'all_products_with_without_orders' && $filter_report != 'products_without_orders' && $filter_report != 'products_shopping_carts' && $filter_report != 'products_wishlists') { ?>     
      <?php if (in_array('payment_company', $advppp_settings_filters)) { ?>
    	<div class="col-lg-2" style="height:75px;">
	  ...
	  <?php } ?>   
      <?php if ($filter_report != 'all_products_with_without_orders' && $filter_report != 'products_without_orders' && $filter_report != 'products_shopping_carts' && $filter_report != 'products_wishlists') { ?>     
      <?php if (in_array('payment_address', $advppp_settings_filters)) { ?>
    	<div class="col-lg-2" style="height:75px;">
	  ...
	  <?php } ?>   
      <?php if ($filter_report != 'all_products_with_without_orders' && $filter_report != 'products_without_orders' && $filter_report != 'products_shopping_carts' && $filter_report != 'products_wishlists') { ?>     
      <?php if (in_array('payment_city', $advppp_settings_filters)) { ?>
    	<div class="col-lg-2" style="height:75px;">
	  ...
	  <?php } ?>   
      <?php if ($filter_report != 'all_products_with_without_orders' && $filter_report != 'products_without_orders' && $filter_report != 'products_shopping_carts' && $filter_report != 'products_wishlists') { ?>     
      <?php if (in_array('payment_zone', $advppp_settings_filters)) { ?>
    	<div class="col-lg-2" style="height:75px;">
	  ...
	  <?php } ?>   
      <?php if ($filter_report != 'all_products_with_without_orders' && $filter_report != 'products_without_orders' && $filter_report != 'products_shopping_carts' && $filter_report != 'products_wishlists') { ?>       
      <?php if (in_array('payment_postcode', $advppp_settings_filters)) { ?>
    	<div class="col-lg-2" style="height:75px;">
	  ...
	  <?php } ?>   
      <?php if ($filter_report != 'all_products_with_without_orders' && $filter_report != 'products_without_orders' && $filter_report != 'products_shopping_carts' && $filter_report != 'products_wishlists') { ?>       
      <?php if (in_array('payment_country', $advppp_settings_filters)) { ?>
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>      
      <?php if ($filter_report != 'all_products_with_without_orders' && $filter_report != 'products_without_orders' && $filter_report != 'products_shopping_carts' && $filter_report != 'products_wishlists') { ?>       
      <?php if (in_array('payment_method', $advppp_settings_filters)) { ?>
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>
      <?php if ($filter_report != 'all_products_with_without_orders' && $filter_report != 'products_without_orders' && $filter_report != 'products_shopping_carts' && $filter_report != 'products_wishlists') { ?>       
      <?php if (in_array('shipping_company', $advppp_settings_filters)) { ?>
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>
      <?php if ($filter_report != 'all_products_with_without_orders' && $filter_report != 'products_without_orders' && $filter_report != 'products_shopping_carts' && $filter_report != 'products_wishlists') { ?>       
      <?php if (in_array('shipping_address', $advppp_settings_filters)) { ?>      
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>
      <?php if ($filter_report != 'all_products_with_without_orders' && $filter_report != 'products_without_orders' && $filter_report != 'products_shopping_carts' && $filter_report != 'products_wishlists') { ?> 
      <?php if (in_array('shipping_city', $advppp_settings_filters)) { ?>      
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>
      <?php if ($filter_report != 'all_products_with_without_orders' && $filter_report != 'products_without_orders' && $filter_report != 'products_shopping_carts' && $filter_report != 'products_wishlists') { ?> 
      <?php if (in_array('shipping_zone', $advppp_settings_filters)) { ?>      
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>
      <?php if ($filter_report != 'all_products_with_without_orders' && $filter_report != 'products_without_orders' && $filter_report != 'products_shopping_carts' && $filter_report != 'products_wishlists') { ?> 
      <?php if (in_array('shipping_postcode', $advppp_settings_filters)) { ?>      
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>
      <?php if ($filter_report != 'all_products_with_without_orders' && $filter_report != 'products_without_orders' && $filter_report != 'products_shopping_carts' && $filter_report != 'products_wishlists') { ?> 
      <?php if (in_array('shipping_country', $advppp_settings_filters)) { ?>      
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>
      <?php if ($filter_report != 'all_products_with_without_orders' && $filter_report != 'products_without_orders' && $filter_report != 'products_shopping_carts' && $filter_report != 'products_wishlists') { ?> 
      <?php if (in_array('shipping_method', $advppp_settings_filters)) { ?>      
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>
      <?php } ?>
      <?php if (in_array('category', $advppp_settings_filters)) { ?>      
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>
      <?php if (in_array('manufacturer', $advppp_settings_filters)) { ?>      
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>
      <?php if (in_array('supplier', $advppp_settings_filters)) { ?>      
    	<div class="col-lg-2" style="height:75px;">
    	<label class="control-label" for="filter_supplier" style="white-space:nowrap;"><?php echo $entry_supplier; ?></label>
          <select name="filter_supplier" id="filter_supplier" class="form-control clear" multiple="multiple" size="1">
            <?php foreach ($suppliers as $supplier) { ?>
            <?php if (in_array($supplier['supplier_id'], $filter_supplier)) { ?>
      ...
      <?php } ?>
      <?php if (in_array('product', $advppp_settings_filters)) { ?>      
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>
      <?php if (in_array('sku', $advppp_settings_filters)) { ?>      
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>
      <?php if (in_array('upc', $advppp_settings_filters)) { ?>      
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>
      <?php if (in_array('ean', $advppp_settings_filters)) { ?>      
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>
      <?php if (in_array('jan', $advppp_settings_filters)) { ?>      
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>
      <?php if (in_array('isbn', $advppp_settings_filters)) { ?>      
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>
      <?php if (in_array('mpn', $advppp_settings_filters)) { ?>      
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>  
      <?php if (in_array('model', $advppp_settings_filters)) { ?>      
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>
      <?php if ($filter_report != 'all_products_with_without_orders' && $filter_report != 'products_without_orders' && $filter_report != 'products_shopping_carts' && $filter_report != 'products_wishlists') { ?> 
      <?php if (in_array('option', $advppp_settings_filters)) { ?>      
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>
      <?php } ?>
      <?php if (in_array('attribute', $advppp_settings_filters)) { ?>      
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>
      <?php if (in_array('product_status', $advppp_settings_filters)) { ?>
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>        
      <?php if (in_array('location', $advppp_settings_filters)) { ?>      
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>
      <?php if ($filter_report != 'all_products_with_without_orders' && $filter_report != 'products_without_orders' && $filter_report != 'products_shopping_carts' && $filter_report != 'products_wishlists') { ?> 
      <?php if (in_array('coupon_name', $advppp_settings_filters)) { ?>      
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>
      <?php if ($filter_report != 'all_products_with_without_orders' && $filter_report != 'products_without_orders' && $filter_report != 'products_shopping_carts' && $filter_report != 'products_wishlists') { ?> 
      <?php if (in_array('coupon_code', $advppp_settings_filters)) { ?>      
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>
      <?php if ($filter_report != 'all_products_with_without_orders' && $filter_report != 'products_without_orders' && $filter_report != 'products_shopping_carts' && $filter_report != 'products_wishlists') { ?> 
      <?php if (in_array('voucher_code', $advppp_settings_filters)) { ?>      
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>  
      <?php if ($filter_report != 'all_products_with_without_orders' && $filter_report != 'products_without_orders' && $filter_report != 'products_shopping_carts' && $filter_report != 'products_wishlists') { ?> 
      <?php if (in_array('campaign_name', $advppp_settings_filters)) { ?>      
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>
      <?php if (in_array('campaign_code', $advppp_settings_filters)) { ?>      
    	<div class="col-lg-2" style="height:75px;">
    ...
    <div class="modal-content" id="modal-content">
      ...
      <div><?php echo $text_load_save; ?></div><br />
        <table width="100%" id="adv_load_save" class="table table-bordered table-hover">
          ...
          <?php if ($advppp_load_save_reports) { ?>
		   <?php $adv_load_save_reports_row = 0; ?>
			<?php foreach ($advppp_load_save_reports as $advppp_load_save_report) { ?>
			  <tbody id="adv_load_save_reports_row<?php echo $adv_load_save_reports_row; ?>">
				<tr> 
				  ...
				  <td width="45%" class="text-left"><input type="text" name="advppp_load_save_report[<?php echo $adv_load_save_reports_row; ?>][save_report_title]" value="<?php echo $advppp_load_save_report['save_report_title']; ?>" placeholder="<?php echo $text_report_title; ?>" class="form-control" /></td>
				  <td width="40%" class="text-left"><textarea readonly name="advppp_load_save_report[<?php echo $adv_load_save_reports_row; ?>][save_report_link]" class="form-control"><?php echo $advppp_load_save_report['save_report_link']; ?></textarea></td>    
				  <td width="10%" class="text-center"><button type="button" onclick="location = '<?php echo ($report_link . str_replace('index.php?route=extension/report/adv_products_profit', '', $advppp_load_save_report['save_report_link'])); ?>'" data-toggle="tooltip" title="<?php echo $button_load; ?> Report" class="btn btn-primary"><i class="fa fa-circle-o-notch"></i> <?php echo $button_load; ?></button></td>                                
				</tr>
			  </tbody>
  ...
  <div class="modal-dialog modal-lg modal-info">
    <div class="modal-content" id="modal-content">
      ...
      <fieldset>
        ...
        <div class="text-danger">* <?php echo $text_export_notice1; ?> <a href="http://www.opencartreports.com/documentation/ppp/index.html#req_limit" target="_blank"><strong><?php echo $text_export_limit; ?></strong></a> <?php echo $text_export_notice2; ?></div>      
		</fieldset>
        <div align="right">
		  <button type="button" class="btn btn-default" title="<?php echo $button_close; ?>" data-dismiss="modal"><i class="fa fa-close"></i> <?php echo $button_close; ?></button>
...
<div class="modal fade" id="settings" data-backdrop="static" data-keyboard="false" style="z-index:9999;">
  <div class="modal-dialog modal-lg modal-info">
    <div class="modal-content" id="modal-content">
      ...
      <div class="modal-body">
      <fieldset>
		<legend><?php echo $text_profit_calculation; ?> <span style="color:#ec971f; font-size:small;"> [<?php echo $text_formula_explanation; ?>]</span></legend> 
		<div class="row" style="padding:2px;">
			<div class="col-sm-12"><div class="input-group" style="width:100%;">
				<span class="input-group-addon" style="width:85%; white-space:normal; text-align:left;"><?php echo $text_formula_setting1; ?></span>
				<select name="advppp<?php echo $user; ?>_formula_1" data-style="btn-select" data-width="15%" class="select">
					<?php if ($advppp_formula_1) { ?>
		...
		<div class="row" style="padding:2px;">                                
			<div class="col-sm-12"><div class="input-group" style="width:100%;">
				<span class="input-group-addon" style="width:85%; white-space:normal; text-align:left;"><?php echo $text_formula_setting2; ?></span>
				<select name="advppp<?php echo $user; ?>_formula_2" data-style="btn-select" data-width="15%" class="select">
					<?php if ($advppp_formula_2) { ?>
					<option value="1" selected="selected"><?php echo $text_yes; ?></option>
					<option value="0"><?php echo $text_no; ?></option>
					<?php } else { ?>
					<option value="1"><?php echo $text_yes; ?></option>
		...
		<div class="row" style="padding:2px;">                                     
			<div class="col-sm-12"><div class="input-group" style="width:100%;">
				<span class="input-group-addon" style="width:85%; white-space:normal; text-align:left;"><?php echo $text_formula_setting3; ?></span>
				<select name="advppp<?php echo $user; ?>_formula_3" data-style="btn-select" data-width="15%" class="select">
    				<?php if ($advppp_formula_3) { ?>
					<option value="1" selected="selected"><?php echo $text_yes; ?></option>
					<option value="0"><?php echo $text_no; ?></option>
					<?php } else { ?>
					<option value="1"><?php echo $text_yes; ?></option>
		...
		<div class="row" style="padding:2px;">                                     
			<div class="col-sm-12"><div class="input-group" style="width:100%;">
				<span class="input-group-addon" style="width:85%; white-space:normal; text-align:left;"><?php echo $text_formula_setting4; ?></span>
				<select name="advppp<?php echo $user; ?>_formula_4" data-style="btn-select" data-width="15%" class="select">
    				<?php if ($advppp_formula_4) { ?>
					<option value="1" selected="selected"><?php echo $text_yes; ?></option>
					<option value="0"><?php echo $text_no; ?></option>
					<?php } else { ?>
					<option value="1"><?php echo $text_yes; ?></option>
		...
		<div class="row" style="padding:2px;">
			<div class="col-sm-12"><div class="input-group" style="width:100%;">
				<span class="input-group-addon" style="width:85%; white-space:normal; text-align:left;"><?php echo $text_formula_setting5; ?></span>
				<select name="advppp<?php echo $user; ?>_formula_5" data-style="btn-select" data-width="15%" class="select">
    				<?php if ($advppp_formula_5) { ?>
					<option value="1" selected="selected"><?php echo $text_yes; ?></option>
					<option value="0"><?php echo $text_no; ?></option>
					<?php } else { ?>
					<option value="1"><?php echo $text_yes; ?></option>
		...
		<div class="row" style="padding:2px;">
			<div class="col-sm-12"><div class="input-group" style="width:100%;">
				<span class="input-group-addon" style="width:62%; white-space:normal; text-align:left;"><?php echo $text_formula_setting6; ?></span>
				<select name="advppp<?php echo $user; ?>_formula_6" data-style="btn-select" data-width="10%" class="select">
    				<?php if ($advppp_formula_6) { ?>
					<option value="1" selected="selected"><?php echo $text_yes; ?></option>
					<option value="0"><?php echo $text_no; ?></option>
					<?php } else { ?>
					<option value="1"><?php echo $text_yes; ?></option>
                ...
                <span class="input-group-addon" style="width:13%; white-space:normal; text-align:left;"><?php echo $text_return_action; ?></span>
                  <select name="advppp<?php echo $user; ?>_return_action_refund" data-style="btn-select" data-width="15%" class="select">
                    <option value="0"></option>
                    <?php foreach ($return_actions as $return_action) { ?>
                    <?php if ($return_action['return_action_id'] == $advppp_return_action_refund) { ?>
		...
		<div class="row" style="padding:2px; padding-bottom:20px;">
			<div class="col-sm-12"><div class="input-group" style="width:100%;">
				<span class="input-group-addon" style="width:85%; white-space:normal; text-align:left;"><?php echo $text_formula_setting7; ?></span>
				<select name="advppp<?php echo $user; ?>_formula_7" data-style="btn-select" data-width="15%" class="select">
    				<?php if ($advppp_formula_7) { ?>
					<option value="1" selected="selected"><?php echo $text_yes; ?></option>
					<option value="0"><?php echo $text_no; ?></option>
					<?php } else { ?>
					<option value="1"><?php echo $text_yes; ?></option>
		...
		<div class="row" style="padding:2px; padding-bottom:20px;">
			<div class="col-lg-4"><div class="input-group" style="width:100%;">
				...
				<select name="advppp<?php echo $user; ?>_date_format" data-style="btn-select" data-width="55%" class="select">
					<?php if ($advppp_date_format == 'DDMMYYYY') { ?>
			...
			<div class="col-lg-4"><div class="input-group" style="width:100%;">
				...
				<select name="advppp<?php echo $user; ?>_hour_format" data-style="btn-select" data-width="55%" class="select">
					<?php if ($advppp_hour_format == '24') { ?>
			...
			<div class="col-lg-4"><div class="input-group" style="width:100%;">
				...
				<select name="advppp<?php echo $user; ?>_week_days" data-style="btn-select" data-width="55%" class="select">
					<?php if ($advppp_week_days == 'mon_sun') { ?>
		...
		<div id="checkbox_filter" class="row">
			<div class="col-sm-12">
				<div class="well well-sm" style="background:#f5f5f5; height:295px; overflow:auto;">
                    ...
                    <input type="hidden" value="filters_null" name="advppp<?php echo $user; ?>_settings_filters[]" checked="checked"/>                 
					<?php foreach ($filters as $key => $filter) { ?>
						<div class="checkbox col-md-3">
						<label>
                        <?php if (in_array($key, $advppp_settings_filters)) { ?>
                        	<input type="checkbox" value="<?php echo $key; ?>" name="advppp<?php echo $user; ?>_settings_filters[]" checked="checked"/> <?php echo $filter; ?>
                        <?php } else { ?>
							<input type="checkbox" value="<?php echo $key; ?>" name="advppp<?php echo $user; ?>_settings_filters[]" /> <?php echo $filter; ?>
                        <?php } ?>
						</label>
						</div>
					<?php } ?>
			...
			<div class="col-sm-12">
				<div class="well well-sm" style="background:#f5f5f5; height:155px; overflow:auto;">
					...
					<?php foreach ($filters_scw_pnp_alp as $key => $filter_scw_pnp_alp) { ?>
						...
						<label>
                        <?php if (in_array($key, $advppp_settings_filters)) { ?>
                        	<input type="checkbox" value="<?php echo $key; ?>" name="advppp<?php echo $user; ?>_settings_filters[]" checked="checked"/> <?php echo $filter_scw_pnp_alp; ?>
                        <?php } else { ?>
							<input type="checkbox" value="<?php echo $key; ?>" name="advppp<?php echo $user; ?>_settings_filters[]" /> <?php echo $filter_scw_pnp_alp; ?>
                        <?php } ?>
						</label>
						</div>
					<?php } ?>
					...
					<?php foreach ($filters_fill as $key => $filter_fill) { ?>
                        <?php if (in_array($key, $advppp_settings_filters)) { ?>
                        	<input type="hidden" value="<?php echo $key; ?>" name="advppp<?php echo $user; ?>_settings_filters[]" checked="checked"/>
                        <?php } ?>
                    <?php } ?>
<?php } ?>
...
<?php } ?>                
				<div class="well well-sm" style="background:#f5f5f5; height:275px; overflow:auto;">
                	<div class="col-sm-12" align="right" style="margin-top:10px;">
                    ...
                    <input type="hidden" value="mv_null" name="advppp<?php echo $user; ?>_settings_mv_columns[]" checked="checked"/>                 
					<?php foreach ($mv_columns as $key => $mv_column) { ?>
						<div class="checkbox col-md-3">
						<label>
                        <?php if (in_array($key, $advppp_settings_mv_columns)) { ?>
                        	<input type="checkbox" value="<?php echo $key; ?>" name="advppp<?php echo $user; ?>_settings_mv_columns[]" checked="checked"/> <?php echo $mv_column; ?>
                        <?php } else { ?>
							<input type="checkbox" value="<?php echo $key; ?>" name="advppp<?php echo $user; ?>_settings_mv_columns[]" /> <?php echo $mv_column; ?>
                        <?php } ?>
						</label>
						</div>
                    <?php } ?>
...
<?php } else { ?>
					...
					<?php foreach ($mv_columns as $key => $mv_column) { ?>
                        <?php if (in_array($key, $advppp_settings_mv_columns)) { ?>
                        	<input type="hidden" value="<?php echo $key; ?>" name="advppp<?php echo $user; ?>_settings_mv_columns[]" checked="checked"/>
                        <?php } ?>
                    <?php } ?>
<?php } ?>
		...
		<div id="checkbox_pnp_column" class="row">
			<div class="col-sm-12">
				<div class="well well-sm" style="background:#f5f5f5; height:190px; overflow:auto;">
                    ...
                    <input type="hidden" value="pnp_null" name="advppp<?php echo $user; ?>_settings_pnp_columns[]" checked="checked"/>                 
					<?php foreach ($pnp_columns as $key => $pnp_column) { ?>
						<div class="checkbox col-md-3">
						<label>
                        <?php if (in_array($key, $advppp_settings_pnp_columns)) { ?>
                        	<input type="checkbox" value="<?php echo $key; ?>" name="advppp<?php echo $user; ?>_settings_pnp_columns[]" checked="checked"/> <?php echo $pnp_column; ?>
                        <?php } else { ?>
							<input type="checkbox" value="<?php echo $key; ?>" name="advppp<?php echo $user; ?>_settings_pnp_columns[]" /> <?php echo $pnp_column; ?>
                        <?php } ?>
						</label>
						</div>
                    <?php } ?>
...
<?php } else { ?>
					...
					<?php foreach ($pnp_columns as $key => $pnp_column) { ?>
                        <?php if (in_array($key, $advppp_settings_pnp_columns)) { ?>
                        	<input type="hidden" value="<?php echo $key; ?>" name="advppp<?php echo $user; ?>_settings_pnp_columns[]" checked="checked"/>
                        <?php } ?>                            
					<?php } ?>                         
<?php } ?>
		...
		<div id="checkbox_scw_column" class="row">
			<div class="col-sm-12">
				<div class="well well-sm" style="background:#f5f5f5; height:270px; overflow:auto;">
                    ...
                    <input type="hidden" value="scw_null" name="advppp<?php echo $user; ?>_settings_scw_columns[]" checked="checked"/>                 
					<?php foreach ($scw_columns as $key => $scw_column) { ?>
						<div class="checkbox col-md-3">
						<label>
                        <?php if (in_array($key, $advppp_settings_scw_columns)) { ?>
                        	<input type="checkbox" value="<?php echo $key; ?>" name="advppp<?php echo $user; ?>_settings_scw_columns[]" checked="checked"/> <?php echo $scw_column; ?>
                        <?php } else { ?>
							<input type="checkbox" value="<?php echo $key; ?>" name="advppp<?php echo $user; ?>_settings_scw_columns[]" /> <?php echo $scw_column; ?>
                        <?php } ?>
						</label>
						</div>
                    <?php } ?>
...
<?php } else { ?>
					...
					<?php foreach ($scw_columns as $key => $scw_column) { ?>
                        <?php if (in_array($key, $advppp_settings_scw_columns)) { ?>
                        	<input type="hidden" value="<?php echo $key; ?>" name="advppp<?php echo $user; ?>_settings_scw_columns[]" checked="checked"/>
                        <?php } ?>
					<?php } ?>                         
<?php } ?>
<?php if ($filter_report == 'manufacturers' or $filter_report == 'categories' or $filter_report == 'suppliers') { ?>      
		<legend><?php echo $text_column_settings; ?> <span style="color:#390; font-size:small;"> [<?php echo $text_export_note; ?>]</span></legend>  
		<div id="checkbox_cm_column" class="row">
			<div class="col-sm-12">
				...
				<div class="well well-sm" style="background:#f5f5f5; height:165px; overflow:auto;">
                    ...
                    <input type="hidden" value="cm_null" name="advppp<?php echo $user; ?>_settings_cm_columns[]" checked="checked"/>                 
					<?php foreach ($cm_columns as $key => $cm_column) { ?>
						<div class="checkbox col-md-3">
						<label>
                        <?php if (in_array($key, $advppp_settings_cm_columns)) { ?>
                        	<input type="checkbox" value="<?php echo $key; ?>" name="advppp<?php echo $user; ?>_settings_cm_columns[]" checked="checked"/> <?php echo $cm_column; ?>
                        <?php } else { ?>
							<input type="checkbox" value="<?php echo $key; ?>" name="advppp<?php echo $user; ?>_settings_cm_columns[]" /> <?php echo $cm_column; ?>
                        <?php } ?>
						</label>
						</div>
                    <?php } ?>
...
<?php } else { ?>
					...
					<?php foreach ($cm_columns as $key => $cm_column) { ?>
                        <?php if (in_array($key, $advppp_settings_cm_columns)) { ?>
                        	<input type="hidden" value="<?php echo $key; ?>" name="advppp<?php echo $user; ?>_settings_cm_columns[]" checked="checked"/>
                        <?php } ?>
					<?php } ?>                         
<?php } ?>
<?php if ($filter_report == 'products_purchased_without_options' or $filter_report == 'products_purchased_with_options' or $filter_report == 'new_products_purchased' or $filter_report == 'old_products_purchased' or $filter_report == 'products_options' or $filter_report == 'manufacturers' or $filter_report == 'categories' or $filter_report == 'suppliers' or $filter_report == 'products_abandoned_orders') { ?>
		<div class="row">
			<div class="col-sm-12">
               	<label class="control-label"><i class="fa fa-columns"></i> <?php echo $text_bd_columns; ?></label>
				<div class="well well-sm" style="background:#f5f5f5; height:325px; overflow:auto;">
<?php } ?>                
<?php if ($filter_report == 'products_purchased_without_options' or $filter_report == 'products_purchased_with_options' or $filter_report == 'new_products_purchased' or $filter_report == 'old_products_purchased' or $filter_report == 'products_abandoned_orders') { ?>
                    ...
                    <input type="hidden" value="ol_null" name="advppp<?php echo $user; ?>_settings_ol_columns[]" checked="checked"/>                     
					<?php foreach ($ol_columns as $key => $ol_column) { ?>
						<div class="checkbox col-md-3">
						<label>
                        <?php if (in_array($key, $advppp_settings_ol_columns)) { ?>
                        	<input type="checkbox" value="<?php echo $key; ?>" name="advppp<?php echo $user; ?>_settings_ol_columns[]" checked="checked"/> <?php echo $ol_column; ?>
                        <?php } else { ?>
							<input type="checkbox" value="<?php echo $key; ?>" name="advppp<?php echo $user; ?>_settings_ol_columns[]" /> <?php echo $ol_column; ?>
                        <?php } ?>
						</label>
						</div>
					<?php } ?>
...
<?php } else { ?>  
					...
					<?php foreach ($ol_columns as $key => $ol_column) { ?>
                        <?php if (in_array($key, $advppp_settings_ol_columns)) { ?>
                        	<input type="hidden" value="<?php echo $key; ?>" name="advppp<?php echo $user; ?>_settings_ol_columns[]" checked="checked"/>
                        <?php } ?>
					<?php } ?>                         
<?php } ?>      
<?php if ($filter_report == 'manufacturers' or $filter_report == 'categories' or $filter_report == 'suppliers' or $filter_report == 'products_options') { ?>
                    ...
                    <input type="hidden" value="pl_null" name="advppp<?php echo $user; ?>_settings_pl_columns[]" checked="checked"/>                     
					<?php foreach ($pl_columns as $key => $pl_column) { ?>
						<div class="checkbox col-md-3">
						<label>
                        <?php if (in_array($key, $advppp_settings_pl_columns)) { ?>
                        	<input type="checkbox" value="<?php echo $key; ?>" name="advppp<?php echo $user; ?>_settings_pl_columns[]" checked="checked"/> <?php echo $pl_column; ?>
                        <?php } else { ?>
							<input type="checkbox" value="<?php echo $key; ?>" name="advppp<?php echo $user; ?>_settings_pl_columns[]" /> <?php echo $pl_column; ?>
                        <?php } ?>
						</label>
						</div>
					<?php } ?> 
...
<?php } else { ?>  
					...
					<?php foreach ($pl_columns as $key => $pl_column) { ?>
                        <?php if (in_array($key, $advppp_settings_pl_columns)) { ?>
                        	<input type="hidden" value="<?php echo $key; ?>" name="advppp<?php echo $user; ?>_settings_pl_columns[]" checked="checked"/>
                        <?php } ?>
					<?php } ?>                         
<?php } ?>      
<?php if ($filter_report == 'products_purchased_without_options' or $filter_report == 'products_purchased_with_options' or $filter_report == 'new_products_purchased' or $filter_report == 'old_products_purchased' or $filter_report == 'products_options' or $filter_report == 'manufacturers' or $filter_report == 'categories' or $filter_report == 'suppliers' or $filter_report == 'products_abandoned_orders') { ?>
                    ...
                    <input type="hidden" value="cl_null" name="advppp<?php echo $user; ?>_settings_cl_columns[]" checked="checked"/>                    
					<?php foreach ($cl_columns as $key => $cl_column) { ?>
						<div class="checkbox col-md-3">
						<label>
                        <?php if (in_array($key, $advppp_settings_cl_columns)) { ?>
                        	<input type="checkbox" value="<?php echo $key; ?>" name="advppp<?php echo $user; ?>_settings_cl_columns[]" checked="checked"/> <?php echo $cl_column; ?>
                        <?php } else { ?>
							<input type="checkbox" value="<?php echo $key; ?>" name="advppp<?php echo $user; ?>_settings_cl_columns[]" /> <?php echo $cl_column; ?>
                        <?php } ?>
						</label>
						</div>
					<?php } ?> 
...
<?php } else { ?>  
					...
					<?php foreach ($cl_columns as $key => $cl_column) { ?>
                        <?php if (in_array($key, $advppp_settings_cl_columns)) { ?>
                        	<input type="hidden" value="<?php echo $key; ?>" name="advppp<?php echo $user; ?>_settings_cl_columns[]" checked="checked"/>
                        <?php } ?>
					<?php } ?> 
<?php } ?>  
<?php if ($filter_report == 'products_purchased_without_options' or $filter_report == 'products_purchased_with_options' or $filter_report == 'new_products_purchased' or $filter_report == 'old_products_purchased' or $filter_report == 'products_options' or $filter_report == 'manufacturers' or $filter_report == 'categories' or $filter_report == 'suppliers' or $filter_report == 'products_abandoned_orders') { ?>                                
...
<?php if ($filter_report == 'products_purchased_without_options' or $filter_report == 'products_purchased_with_options' or $filter_report == 'new_products_purchased' or $filter_report == 'old_products_purchased' or $filter_report == 'products_options' or $filter_report == 'manufacturers' or $filter_report == 'categories' or $filter_report == 'suppliers' or $filter_report == 'products_abandoned_orders') { ?>    
		<div id="checkbox_all_column" class="row">
			<div class="col-sm-12">
				...
				<div class="well well-sm" style="background:#f5f5f5; height:600px; overflow:auto;">
                	<div class="col-sm-12" align="right" style="margin-top:10px;">
                    ...
                    <input type="hidden" value="all_null" name="advppp<?php echo $user; ?>_settings_all_columns[]" checked="checked"/>                 
					<?php foreach ($all_columns as $key => $all_column) { ?>
						<div class="checkbox col-md-3">
						<label>
                        <?php if (in_array($key, $advppp_settings_all_columns)) { ?>
                        	<input type="checkbox" value="<?php echo $key; ?>" name="advppp<?php echo $user; ?>_settings_all_columns[]" checked="checked"/> <?php echo $all_column; ?>
                        <?php } else { ?>
							<input type="checkbox" value="<?php echo $key; ?>" name="advppp<?php echo $user; ?>_settings_all_columns[]" /> <?php echo $all_column; ?>
                        <?php } ?>
						</label>
						</div>
					<?php } ?>
...
<?php } else { ?>  
					...
					<?php foreach ($all_columns as $key => $all_column) { ?>
                        <?php if (in_array($key, $advppp_settings_all_columns)) { ?>
                        	<input type="hidden" value="<?php echo $key; ?>" name="advppp<?php echo $user; ?>_settings_all_columns[]" checked="checked"/>
                        <?php } ?>
					<?php } ?>
<?php } ?>         
		</fieldset>
      ...
      <fieldset>
       ...
       <legend><?php echo $text_cron_3; ?></legend> 
        ...
        <table width="100%" id="adv_cron_setting" class="table table-bordered table-hover">
          ...
          <?php if ($advppp_cron_settings) { ?>
		   <?php $adv_cron_settings_row = 0; ?>
			<?php foreach ($advppp_cron_settings as $advppp_cron_setting) { ?>
			  <tbody id="adv_cron_settings_row<?php echo $adv_cron_settings_row; ?>">
				<tr>                
				  <td width="45%" class="text-left">
            	  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_id]" value="<?php echo $advppp_cron_setting['cron_id']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_report_type]" value="<?php echo $advppp_cron_setting['cron_report_type']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_export_type]" value="<?php echo $advppp_cron_setting['cron_export_type']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_export_logo_criteria]" value="<?php echo $advppp_cron_setting['cron_export_logo_criteria']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_export_csv_delimiter]" value="<?php echo $advppp_cron_setting['cron_export_csv_delimiter']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_export_file]" value="<?php echo $advppp_cron_setting['cron_export_file']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_file_save_path]" value="<?php echo $advppp_cron_setting['cron_file_save_path']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_file_name]" value="<?php echo $advppp_cron_setting['cron_file_name']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_email]" value="<?php echo $advppp_cron_setting['cron_email']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_user]" value="<?php echo $advppp_cron_setting['cron_user']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_pass]" value="<?php echo $advppp_cron_setting['cron_pass']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_token]" value="<?php echo $advppp_cron_setting['cron_token']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_user_id]" value="<?php echo $advppp_cron_setting['cron_user_id']; ?>" />
                  
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_report]" value="<?php echo $advppp_cron_setting['cron_filter_report']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_details]" value="<?php echo $advppp_cron_setting['cron_filter_details']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_group]" value="<?php echo $advppp_cron_setting['cron_filter_group']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_sort]" value="<?php echo $advppp_cron_setting['cron_filter_sort']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_order]" value="<?php echo $advppp_cron_setting['cron_filter_order']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_limit]" value="<?php echo $advppp_cron_setting['cron_filter_limit']; ?>" />
                  
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_range]" value="<?php echo $advppp_cron_setting['cron_filter_range']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_date_start]" value="<?php echo $advppp_cron_setting['cron_date_start']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_date_end]" value="<?php echo $advppp_cron_setting['cron_date_end']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_order_status_id]" value="<?php echo $advppp_cron_setting['cron_filter_order_status_id']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_status_date_start]" value="<?php echo $advppp_cron_setting['cron_status_date_start']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_status_date_end]" value="<?php echo $advppp_cron_setting['cron_status_date_end']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_order_id_from]" value="<?php echo $advppp_cron_setting['cron_filter_order_id_from']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_order_id_to]" value="<?php echo $advppp_cron_setting['cron_filter_order_id_to']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_prod_price_min]" value="<?php echo $advppp_cron_setting['cron_filter_prod_price_min']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_prod_price_max]" value="<?php echo $advppp_cron_setting['cron_filter_prod_price_max']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_store_id]" value="<?php echo $advppp_cron_setting['cron_filter_store_id']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_currency]" value="<?php echo $advppp_cron_setting['cron_filter_currency']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_taxes]" value="<?php echo $advppp_cron_setting['cron_filter_taxes']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_tax_classes]" value="<?php echo $advppp_cron_setting['cron_filter_tax_classes']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_geo_zones]" value="<?php echo $advppp_cron_setting['cron_filter_geo_zones']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_customer_group_id]" value="<?php echo $advppp_cron_setting['cron_filter_customer_group_id']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_customer_name]" value="<?php echo $advppp_cron_setting['cron_filter_customer_name']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_customer_email]" value="<?php echo $advppp_cron_setting['cron_filter_customer_email']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_customer_telephone]" value="<?php echo $advppp_cron_setting['cron_filter_customer_telephone']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_ip]" value="<?php echo $advppp_cron_setting['cron_filter_ip']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_payment_company]" value="<?php echo $advppp_cron_setting['cron_filter_payment_company']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_payment_address]" value="<?php echo $advppp_cron_setting['cron_filter_payment_address']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_payment_city]" value="<?php echo $advppp_cron_setting['cron_filter_payment_city']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_payment_zone]" value="<?php echo $advppp_cron_setting['cron_filter_payment_zone']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_payment_postcode]" value="<?php echo $advppp_cron_setting['cron_filter_payment_postcode']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_payment_country]" value="<?php echo $advppp_cron_setting['cron_filter_payment_country']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_payment_method]" value="<?php echo $advppp_cron_setting['cron_filter_payment_method']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_shipping_company]" value="<?php echo $advppp_cron_setting['cron_filter_shipping_company']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_shipping_address]" value="<?php echo $advppp_cron_setting['cron_filter_shipping_address']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_shipping_city]" value="<?php echo $advppp_cron_setting['cron_filter_shipping_city']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_shipping_zone]" value="<?php echo $advppp_cron_setting['cron_filter_shipping_zone']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_shipping_postcode]" value="<?php echo $advppp_cron_setting['cron_filter_shipping_postcode']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_shipping_country]" value="<?php echo $advppp_cron_setting['cron_filter_shipping_country']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_shipping_method]" value="<?php echo $advppp_cron_setting['cron_filter_shipping_method']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_category]" value="<?php echo $advppp_cron_setting['cron_filter_category']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_manufacturer]" value="<?php echo $advppp_cron_setting['cron_filter_manufacturer']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_supplier]" value="<?php echo $advppp_cron_setting['cron_filter_supplier']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_sku]" value="<?php echo $advppp_cron_setting['cron_filter_sku']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_upc]" value="<?php echo $advppp_cron_setting['cron_filter_upc']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_ean]" value="<?php echo $advppp_cron_setting['cron_filter_ean']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_jan]" value="<?php echo $advppp_cron_setting['cron_filter_jan']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_isbn]" value="<?php echo $advppp_cron_setting['cron_filter_isbn']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_mpn]" value="<?php echo $advppp_cron_setting['cron_filter_mpn']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_product_name]" value="<?php echo $advppp_cron_setting['cron_filter_product_name']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_model]" value="<?php echo $advppp_cron_setting['cron_filter_model']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_option]" value="<?php echo $advppp_cron_setting['cron_filter_option']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_attribute]" value="<?php echo $advppp_cron_setting['cron_filter_attribute']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_product_status]" value="<?php echo $advppp_cron_setting['cron_filter_product_status']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_location]" value="<?php echo $advppp_cron_setting['cron_filter_location']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_coupon_name]" value="<?php echo $advppp_cron_setting['cron_filter_coupon_name']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_coupon_code]" value="<?php echo $advppp_cron_setting['cron_filter_coupon_code']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_voucher_code]" value="<?php echo $advppp_cron_setting['cron_filter_voucher_code']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_campaign_name]" value="<?php echo $advppp_cron_setting['cron_filter_campaign_name']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_campaign_code]" value="<?php echo $advppp_cron_setting['cron_filter_campaign_code']; ?>" />
		  
                  <input type="text" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_title]" value="<?php echo $advppp_cron_setting['cron_title']; ?>" placeholder="<?php echo $text_cron_title; ?>" class="form-control" /></td>
				  <td width="45%" class="text-left"><textarea readonly name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_command]" class="form-control"><?php echo $advppp_cron_setting['cron_command']; ?></textarea></td>    
...
<?php } ?>
<div id="charts" class="chart-switcher <?php echo (isset($_COOKIE['show-ppp-chart']) && $_COOKIE['show-ppp-chart'] == 1) ? '' : 'hide-chart'; ?>" style="margin-bottom:15px;">  
	<?php if ($filter_report != 'all_products_with_without_orders' && $filter_report != 'products_without_orders' && $filter_report != 'products_options' && $filter_report != 'products_abandoned_orders' && $filter_report != 'products_shopping_carts' && $filter_report != 'products_wishlists' && $filter_details != 'all_details_products' && $filter_details != 'all_details_orders' && $filter_group == 'no_group' && $filter_limit != '999999') { ?>       
  ...
  $(function() {  
			var data1 = [
				...
				if ($filter_report == 'products_purchased_without_options' || $filter_report == 'products_purchased_with_options' || $filter_report == 'new_products_purchased' || $filter_report == 'old_products_purchased') {					
					...
					foreach ($products as $product) {
					echo '{ label: " '.$product['gsupplier'].'",  data: '.$product['gsold'].' },';
					if (++$d > 9) break;
					}
				}
				;?>
			...
			var data2 = [
				{ label: '<?php echo $column_gsales; ?>', data: dgsales, color: "#b5e08b" },
				{ label: '<?php echo $column_gcosts; ?>', data: dgcosts, color: "#ed9999" },
				{ label: '<?php echo $column_gprofit; ?>', data: dgprofit, color: "#739cc3" }
			];
...
//--></script> 
    ...
    <?php if ($filter_report != 'manufacturers' && $filter_report != 'categories' && $filter_report != 'suppliers') { ?> 
    Top Sold Products
    <?php } elseif ($filter_report == 'manufacturers') { ?>
    Top Manufacturers
    <?php } elseif ($filter_report == 'categories') { ?>
    Top Categories
    <?php } elseif ($filter_report == 'suppliers') { ?>
    Top Suppliers
    <?php } ?>
    </strong></div>
      <div class="col-lg-6">
      	<div id="chart1" style="width:100%; height:300px;"></div><div id="pieHover">&nbsp;</div>
      </div>
      <div class="col-lg-6">      
...
<?php if ($filter_details == 'all_details_products' or $filter_details == 'all_details_orders') { ?>
	...
	<?php if ($products && $filter_limit != '999999') { ?>          
		...
		<tr>
          ...
          <?php if (in_array('all_order_inv_no', $advppp_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_order_inv_no; ?></td>
          <?php } ?>
          <?php if (in_array('all_order_customer_name', $advppp_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_order_customer; ?></td>
          <?php } ?>
          <?php if (in_array('all_order_email', $advppp_settings_all_columns)) { ?>
          <td class="left" nowrap="nowrap"><?php echo $column_order_email; ?></td>
          <?php } ?>
          <?php if (in_array('all_order_customer_group', $advppp_settings_all_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_order_customer_group; ?></td>
          <?php } ?>
          <?php if ($filter_details == 'all_details_products') { ?>
          <?php if (in_array('all_prod_id', $advppp_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_prod_id; ?></td>
          <?php } ?>
          <?php if (in_array('all_prod_sku', $advppp_settings_all_columns)) { ?>           
		  <td class="left" nowrap="nowrap"><?php echo $column_prod_sku; ?></td>
          <?php } ?>
          <?php if (in_array('all_prod_upc', $advppp_settings_all_columns)) { ?>           
		  <td class="left" nowrap="nowrap"><?php echo $column_prod_upc; ?></td>
          <?php } ?>
          <?php if (in_array('all_prod_ean', $advppp_settings_all_columns)) { ?>           
		  <td class="left" nowrap="nowrap"><?php echo $column_prod_ean; ?></td>
          <?php } ?>
          <?php if (in_array('all_prod_jan', $advppp_settings_all_columns)) { ?>           
		  <td class="left" nowrap="nowrap"><?php echo $column_prod_jan; ?></td>
          <?php } ?>
          <?php if (in_array('all_prod_isbn', $advppp_settings_all_columns)) { ?>           
		  <td class="left" nowrap="nowrap"><?php echo $column_prod_isbn; ?></td>
          <?php } ?>
          <?php if (in_array('all_prod_mpn', $advppp_settings_all_columns)) { ?>           
		  <td class="left" nowrap="nowrap"><?php echo $column_prod_mpn; ?></td>
          <?php } ?>
          <?php if (in_array('all_prod_model', $advppp_settings_all_columns)) { ?>           
		  <td class="left" nowrap="nowrap"><?php echo $column_prod_model; ?></td>
          <?php } ?>
          <?php if (in_array('all_prod_name', $advppp_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_prod_name; ?></td>
          <?php } ?>
          <?php if (in_array('all_prod_option', $advppp_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_prod_option; ?></td>
          <?php } ?>
          <?php if (in_array('all_prod_attributes', $advppp_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_prod_attributes; ?></td>
          <?php } ?>
          <?php if (in_array('all_prod_category', $advppp_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_prod_category; ?></td>
          <?php } ?>          
          <?php if (in_array('all_prod_manu', $advppp_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_prod_manu; ?></td>
          <?php } ?>
          <?php if (in_array('all_prod_supplier', $advppp_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_prod_supplier; ?></td>
          <?php } ?>
	  <?php } ?>
          <?php if ($filter_details == 'all_details_products' or $filter_details == 'all_details_orders') { ?>
          <?php if (in_array('all_prod_currency', $advppp_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_prod_currency; ?></td>
          <?php } ?>          
          <?php } ?>
          <?php if ($filter_details == 'all_details_products') { ?>           
          <?php if (in_array('all_prod_price', $advppp_settings_all_columns)) { ?>           
          <td class="right" nowrap="nowrap"><?php echo $column_prod_price; ?></td>
          <?php } ?>
          <?php if (in_array('all_prod_quantity', $advppp_settings_all_columns)) { ?>           
          <td class="right" nowrap="nowrap"><?php echo $column_prod_quantity; ?></td>
          <?php } ?>
          <?php if (in_array('all_prod_total_excl_vat', $advppp_settings_all_columns)) { ?>           
          <td class="right" nowrap="nowrap"><?php echo $column_prod_total_excl_vat; ?></td>
          <?php } ?>
          <?php if (in_array('all_prod_tax', $advppp_settings_all_columns)) { ?>           
          <td class="right" nowrap="nowrap"><?php echo $column_prod_tax; ?></td>
          <?php } ?>
          <?php if (in_array('all_prod_total_incl_vat', $advppp_settings_all_columns)) { ?>           
          <td class="right" nowrap="nowrap"><?php echo $column_prod_total_incl_vat; ?></td>
          <?php } ?>
          <?php if (in_array('all_prod_discount', $advppp_settings_all_columns)) { ?>           
          <td class="right" style="min-width:70px;"><?php echo $column_prod_discount; ?></td>
          <?php } ?>          
          <?php if (in_array('all_prod_qty_refund', $advppp_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_prod_qty_refunded; ?></td>
          <?php } ?> 
          <?php if (in_array('all_prod_refund', $advppp_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_prod_refunded; ?></td>
          <?php } ?>     
          <?php if (in_array('all_prod_reward_points', $advppp_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_prod_reward_points; ?></td>
          <?php } ?>                            
          <?php if (in_array('all_prod_sales', $advppp_settings_all_columns)) { ?>           
          <td class="right" nowrap="nowrap"><?php echo $column_prod_sales; ?></td>
          <?php } ?>
          <?php if (in_array('all_prod_cost', $advppp_settings_all_columns)) { ?>           
          <td class="right" nowrap="nowrap"><?php echo $column_prod_cost; ?></td>
          <?php } ?>
          <?php if (in_array('all_prod_profit', $advppp_settings_all_columns)) { ?>           
          <td class="right" nowrap="nowrap"><?php echo $column_prod_profit; ?></td>
          <?php } ?>
          <?php if (in_array('all_prod_profit_margin', $advppp_settings_all_columns)) { ?>           
          <td class="right" nowrap="nowrap"><?php echo $column_prod_profit_margin; ?></td>
          <?php } ?>
          <?php if (in_array('all_prod_profit_markup', $advppp_settings_all_columns)) { ?>           
          <td class="right" nowrap="nowrap"><?php echo $column_prod_profit_markup; ?></td>
          <?php } ?>     
          <?php } ?>     
          <?php if (in_array('all_sub_total', $advppp_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_sub_total; ?></td>
          <?php } ?>              
          <?php if (in_array('all_handling', $advppp_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_handling; ?></td>
          <?php } ?>
          <?php if (in_array('all_loworder', $advppp_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_loworder; ?></td>
          <?php } ?>                  
          <?php if (in_array('all_shipping', $advppp_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_order_shipping; ?></td>
          <?php } ?>
          <?php if (in_array('all_reward', $advppp_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_reward; ?></td>
          <?php } ?>
          <?php if (in_array('all_reward_points', $advppp_settings_all_columns)) { ?>          
          ...
          <?php } ?>           
          <?php if (in_array('all_coupon', $advppp_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_coupon; ?></td>
          <?php } ?>
          <?php if (in_array('all_coupon_name', $advppp_settings_all_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_coupon_name; ?></td>
          <?php } ?> 
          <?php if (in_array('all_coupon_code', $advppp_settings_all_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_coupon_code; ?></td>
          <?php } ?>                                           
          <?php if (in_array('all_order_tax', $advppp_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_order_tax; ?></td>
          <?php } ?>
          <?php if (in_array('all_credit', $advppp_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_credit; ?></td>
          <?php } ?>
          <?php if (in_array('all_voucher', $advppp_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_voucher; ?></td>
          <?php } ?>
          <?php if (in_array('all_voucher_code', $advppp_settings_all_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_voucher_code; ?></td>
          <?php } ?>
          <?php if (in_array('all_discount', $advppp_settings_all_columns)) { ?>          
          <td class="right" style="min-width:75px;"><?php echo $column_discount; ?></td>
          <?php } ?>          
          <?php if (in_array('all_order_value', $advppp_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_order_value; ?></td>
          <?php } ?>
          <?php if (in_array('all_refund', $advppp_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_order_refund; ?></td>
          <?php } ?>                        
          <?php if (in_array('all_order_sales', $advppp_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_order_sales; ?></td>
          <?php } ?>
          <?php if (in_array('all_order_prod_costs', $advppp_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_order_prod_costs; ?></td>
          <?php } ?>
          <?php if (in_array('all_order_commission', $advppp_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_order_commission; ?></td>
          <?php } ?>
          <?php if (in_array('all_order_payment_cost', $advppp_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_order_payment_cost; ?></td>
          <?php } ?>
          <?php if (in_array('all_order_shipping_cost', $advppp_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_order_shipping_cost; ?></td>
          <?php } ?>
          <?php if (in_array('all_order_extra_cost', $advppp_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_order_extra_cost; ?></td>
          <?php } ?>
          <?php if (in_array('all_order_return_cost', $advppp_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_order_return_cost; ?></td>
          <?php } ?>                    
          <?php if (in_array('all_shipping_balance', $advppp_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_shipping_balance; ?></td>
          <?php } ?>                                                  
          <?php if (in_array('all_order_costs', $advppp_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_order_costs; ?></td>
          <?php } ?>
          <?php if (in_array('all_order_profit', $advppp_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_order_profit; ?></td>
          <?php } ?>
          <?php if (in_array('all_order_profit_prc', $advppp_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_order_margin; ?></td>
          <?php } ?>  
          <?php if (in_array('all_order_shipping_method', $advppp_settings_all_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_order_shipping_method; ?></td>
          <?php } ?>
          <?php if (in_array('all_order_payment_method', $advppp_settings_all_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_order_payment_method; ?></td>
          <?php } ?>
          <?php if (in_array('all_order_status', $advppp_settings_all_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_order_status; ?></td>
          <?php } ?>
          <?php if (in_array('all_order_store', $advppp_settings_all_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_order_store; ?></td>
          <?php } ?>
          <?php if (in_array('all_campaign_name', $advppp_settings_all_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_campaign_name; ?></td>
          <?php } ?> 
          <?php if (in_array('all_campaign_code', $advppp_settings_all_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_campaign_code; ?></td>
          <?php } ?>  
          <?php if (in_array('all_customer_cust_id', $advppp_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_customer_cust_id; ?></td>
          <?php } ?>
          <?php if (in_array('all_custom_fields', $advppp_settings_all_columns)) { ?>          
          ...
          <?php } ?>
          <?php } ?>                   
          <?php if (in_array('all_billing_first_name', $advppp_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_billing_first_name; ?></td>
          <?php } ?>
          <?php if (in_array('all_billing_last_name', $advppp_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_billing_last_name; ?></td>
          <?php } ?>          
          <?php if (in_array('all_billing_company', $advppp_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_billing_company; ?></td>
          <?php } ?>
          <?php if (in_array('all_billing_address_1', $advppp_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_billing_address_1; ?></td>
          <?php } ?>
          <?php if (in_array('all_billing_address_2', $advppp_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_billing_address_2; ?></td>
          <?php } ?>
          <?php if (in_array('all_billing_city', $advppp_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_billing_city; ?></td>
          <?php } ?>
          <?php if (in_array('all_billing_zone', $advppp_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_billing_zone; ?></td> 
          <?php } ?>
          <?php if (in_array('all_billing_zone_id', $advppp_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_billing_zone_id; ?></td> 
          <?php } ?>
          <?php if (in_array('all_billing_zone_code', $advppp_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_billing_zone_code; ?></td> 
          <?php } ?>                    
          <?php if (in_array('all_billing_postcode', $advppp_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_billing_postcode; ?></td>
          <?php } ?>
          <?php if (in_array('all_billing_country', $advppp_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_billing_country; ?></td>
          <?php } ?>
          <?php if (in_array('all_billing_country_id', $advppp_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_billing_country_id; ?></td>
          <?php } ?>
          <?php if (in_array('all_billing_country_code', $advppp_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_billing_country_code; ?></td>
          <?php } ?>                    
          <?php if (in_array('all_customer_telephone', $advppp_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_customer_telephone; ?></td>
          <?php } ?>
          <?php if (in_array('all_shipping_first_name', $advppp_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_shipping_first_name; ?></td> 
          <?php } ?>
          <?php if (in_array('all_shipping_last_name', $advppp_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_shipping_last_name; ?></td> 
          <?php } ?>          
          <?php if (in_array('all_shipping_company', $advppp_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_shipping_company; ?></td> 
          <?php } ?>
          <?php if (in_array('all_shipping_address_1', $advppp_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_shipping_address_1; ?></td> 
          <?php } ?>
          <?php if (in_array('all_shipping_address_2', $advppp_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_shipping_address_2; ?></td> 
          <?php } ?>
          <?php if (in_array('all_shipping_city', $advppp_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_shipping_city; ?></td>
          <?php } ?>
          <?php if (in_array('all_shipping_zone', $advppp_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_shipping_zone; ?></td> 
          <?php } ?>
          <?php if (in_array('all_shipping_zone_id', $advppp_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_shipping_zone_id; ?></td> 
          <?php } ?>
          <?php if (in_array('all_shipping_zone_code', $advppp_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_shipping_zone_code; ?></td> 
          <?php } ?>                    
          <?php if (in_array('all_shipping_postcode', $advppp_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_shipping_postcode; ?></td>
          <?php } ?>
          <?php if (in_array('all_shipping_country', $advppp_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_shipping_country; ?></td>
          <?php } ?> 
          <?php if (in_array('all_shipping_country_id', $advppp_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_shipping_country_id; ?></td>
          <?php } ?> 
          <?php if (in_array('all_shipping_country_code', $advppp_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $column_shipping_country_code; ?></td>
          <?php } ?>                     
          <?php if (in_array('all_order_weight', $advppp_settings_all_columns)) { ?>           
          <td class="right" nowrap="nowrap"><?php echo $column_order_weight; ?></td>
          <?php } ?>           
          <?php if (in_array('all_order_comment', $advppp_settings_all_columns)) { ?>           
		...
		<tr bgcolor="#FFFFFF">
          ...
          <?php } ?>
          <?php if (in_array('all_prod_supplier', $advppp_settings_all_columns)) { ?>           
          <td class="left" nowrap="nowrap" title="<?php echo $column_prod_supplier; ?> [<?php echo $column_order_order_id; ?>: <?php echo $product['order_id']; ?>]"><?php echo $product['product_supplier']; ?></td>
          <?php } ?>
	  <?php } ?>          
          <?php if ($filter_details == 'all_details_products' or $filter_details == 'all_details_orders') { ?>
          <?php if (in_array('all_prod_currency', $advppp_settings_all_columns)) { ?>           
          ...
          <?php } ?>
          <?php if (in_array('all_prod_total_excl_vat', $advppp_settings_all_columns)) { ?>           
          <td class="right" nowrap="nowrap" title="<?php echo $column_prod_total_excl_vat; ?> [<?php echo $column_order_order_id; ?>: <?php echo $product['order_id']; ?>]" <?php echo ($filter_report == 'products_abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><span style="color:#090"><?php echo $product['product_total_excl_vat']; ?></span></td>
          <?php } ?>
          <?php if (in_array('all_prod_tax', $advppp_settings_all_columns)) { ?>           
          ...
          <?php } ?>
          <?php if (in_array('all_prod_discount', $advppp_settings_all_columns)) { ?>           
          <td class="right" nowrap="nowrap" title="<?php echo $column_prod_discount; ?> [<?php echo $column_order_order_id; ?>: <?php echo $product['order_id']; ?>]" <?php echo ($filter_report == 'products_abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><?php echo $product['product_discount']; ?></td>
          <?php } ?>          
          <?php if (in_array('all_prod_qty_refund', $advppp_settings_all_columns)) { ?>          
          ...
          <?php } ?>   
          <?php if (in_array('all_prod_refund', $advppp_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap" title="<?php echo $column_prod_refunded; ?> [<?php echo $column_order_order_id; ?>: <?php echo $product['order_id']; ?>]" <?php echo ($filter_report == 'products_abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><span <?php if ($advppp_formula_6) { echo 'style="color:#090"'; } ?>><?php echo $product['product_refund']; ?></span></td>
          <?php } ?>       
          <?php if (in_array('all_prod_reward_points', $advppp_settings_all_columns)) { ?>          
          ...
          <?php } ?>
          <?php if (in_array('all_prod_sales', $advppp_settings_all_columns)) { ?>           
          <td class="right" nowrap="nowrap" title="<?php echo $column_prod_sales; ?> [<?php echo $column_order_order_id; ?>: <?php echo $product['order_id']; ?>]" <?php echo ($filter_report == 'products_abandoned_orders') ? 'style="background-color:#DCFFB9; text-decoration:line-through;"' : 'style="background-color:#DCFFB9;"' ?> ><?php echo $product['product_sales']; ?></td>
          <?php } ?>
          <?php if (in_array('all_prod_cost', $advppp_settings_all_columns)) { ?>           
          <td class="right" nowrap="nowrap" title="<?php echo $column_prod_cost; ?> [<?php echo $column_order_order_id; ?>: <?php echo $product['order_id']; ?>]" <?php echo ($filter_report == 'products_abandoned_orders') ? 'style="background-color:#ffd7d7; text-decoration:line-through;"' : 'style="background-color:#ffd7d7;"' ?> ><?php echo $product['product_cost']; ?></td>
          <?php } ?>
          <?php if (in_array('all_prod_profit', $advppp_settings_all_columns)) { ?>           
          <td class="right" nowrap="nowrap" title="<?php echo $column_prod_profit; ?> [<?php echo $column_order_order_id; ?>: <?php echo $product['order_id']; ?>]" <?php echo ($filter_report == 'products_abandoned_orders') ? (($product['product_profit_raw'] >= 0) ? 'style="background-color:#c4d9ee; font-weight:bold; text-decoration:line-through;"' : 'style="background-color:#F99; font-weight:bold; text-decoration:line-through;"') : (($product['product_profit_raw'] >= 0) ? 'style="background-color:#c4d9ee; font-weight:bold;"' : 'style="background-color:#F99; font-weight:bold;"') ?> ><?php echo $product['product_profit']; ?></td>
          <?php } ?>
          <?php if (in_array('all_prod_profit_margin', $advppp_settings_all_columns)) { ?>           
          <td class="right" nowrap="nowrap" title="<?php echo $column_prod_profit_margin; ?> [<?php echo $column_order_order_id; ?>: <?php echo $product['order_id']; ?>]" <?php echo ($filter_report == 'products_abandoned_orders') ? (($product['product_profit_raw'] >= 0) ? 'style="background-color:#c4d9ee; font-weight:bold; text-decoration:line-through;"' : 'style="background-color:#F99; font-weight:bold; text-decoration:line-through;"') : (($product['product_profit_raw'] >= 0) ? 'style="background-color:#c4d9ee; font-weight:bold;"' : 'style="background-color:#F99; font-weight:bold;"') ?> ><?php echo $product['product_profit_margin']; ?></td>
          <?php } ?>   
          <?php if (in_array('all_prod_profit_markup', $advppp_settings_all_columns)) { ?>           
          <td class="right" nowrap="nowrap" title="<?php echo $column_prod_profit_markup; ?> [<?php echo $column_order_order_id; ?>: <?php echo $product['order_id']; ?>]" <?php echo ($filter_report == 'products_abandoned_orders') ? (($product['product_profit_raw'] >= 0) ? 'style="background-color:#c4d9ee; font-weight:bold; text-decoration:line-through;"' : 'style="background-color:#F99; font-weight:bold; text-decoration:line-through;"') : (($product['product_profit_raw'] >= 0) ? 'style="background-color:#c4d9ee; font-weight:bold;"' : 'style="background-color:#F99; font-weight:bold;"') ?> ><?php echo $product['product_profit_markup']; ?></td>
          <?php } ?>
          <?php } ?> 
          <?php if (in_array('all_sub_total', $advppp_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap" title="<?php echo $column_sub_total; ?> [<?php echo $column_order_order_id; ?>: <?php echo $product['order_id']; ?>]" <?php echo ($filter_report == 'products_abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><span style="color:#090"><?php echo $product['order_sub_total']; ?></span></td>
          <?php } ?>
          <?php if (in_array('all_handling', $advppp_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap" title="<?php echo $column_handling; ?> [<?php echo $column_order_order_id; ?>: <?php echo $product['order_id']; ?>]" <?php echo ($filter_report == 'products_abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><span style="color:#090"><?php echo $product['order_handling']; ?></span></td>
          <?php } ?>
          <?php if (in_array('all_loworder', $advppp_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap" title="<?php echo $column_loworder; ?> [<?php echo $column_order_order_id; ?>: <?php echo $product['order_id']; ?>]" <?php echo ($filter_report == 'products_abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><span style="color:#090"><?php echo $product['order_low_order_fee']; ?></span></td>
          <?php } ?>                    
          <?php if (in_array('all_shipping', $advppp_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap" title="<?php echo $column_shipping; ?> [<?php echo $column_order_order_id; ?>: <?php echo $product['order_id']; ?>]" <?php echo ($filter_report == 'products_abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><span <?php if ($advppp_formula_1) { echo 'style="color:#090"'; } ?>><?php echo $product['order_shipping']; ?></span></td>
          <?php } ?>
          <?php if (in_array('all_reward', $advppp_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap" title="<?php echo $column_reward; ?> [<?php echo $column_order_order_id; ?>: <?php echo $product['order_id']; ?>]" <?php echo ($filter_report == 'products_abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><span style="color:#090"><?php echo $product['order_reward']; ?></span></td>
          <?php } ?>
          <?php if (in_array('all_reward_points', $advppp_settings_all_columns)) { ?>          
          ...
          <?php } ?>           
          <?php if (in_array('all_coupon', $advppp_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap" title="<?php echo $column_coupon; ?> [<?php echo $column_order_order_id; ?>: <?php echo $product['order_id']; ?>]" <?php echo ($filter_report == 'products_abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><span style="color:#090"><?php echo $product['order_coupon']; ?></span></td>
          <?php } ?>
          <?php if (in_array('all_coupon_name', $advppp_settings_all_columns)) { ?>          
          ...
          <?php } ?>
          <?php if (in_array('all_credit', $advppp_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap" title="<?php echo $column_credit; ?> [<?php echo $column_order_order_id; ?>: <?php echo $product['order_id']; ?>]" <?php echo ($filter_report == 'products_abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><span style="color:#090"><?php echo $product['order_credit']; ?></span></td>
          <?php } ?>
          <?php if (in_array('all_voucher', $advppp_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap" title="<?php echo $column_voucher; ?> [<?php echo $column_order_order_id; ?>: <?php echo $product['order_id']; ?>]" <?php echo ($filter_report == 'products_abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><span style="color:#090"><?php echo $product['order_voucher']; ?></span></td>
          <?php } ?>
          <?php if (in_array('all_voucher_code', $advppp_settings_all_columns)) { ?>          
          ...
          <?php } ?>
          <?php if (in_array('all_discount', $advppp_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap" title="<?php echo $column_discount; ?> [<?php echo $column_order_order_id; ?>: <?php echo $product['order_id']; ?>]" <?php echo ($filter_report == 'products_abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><?php echo $product['order_discount']; ?></td>
          <?php } ?>          
          <?php if (in_array('all_order_value', $advppp_settings_all_columns)) { ?>          
          ...
          <?php } ?>
          <?php if (in_array('all_refund', $advppp_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap" title="<?php echo $column_order_refund; ?> [<?php echo $column_order_order_id; ?>: <?php echo $product['order_id']; ?>]" <?php echo ($filter_report == 'products_abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><span <?php if ($advppp_formula_6) { echo 'style="color:#090"'; } ?>><?php echo $product['order_refund']; ?></span></td>
          <?php } ?>
          <?php if (in_array('all_order_sales', $advppp_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap" title="<?php echo $column_order_sales; ?> [<?php echo $column_order_order_id; ?>: <?php echo $product['order_id']; ?>]" <?php echo ($filter_report == 'products_abandoned_orders') ? 'style="background-color:#DCFFB9; text-decoration:line-through;"' : 'style="background-color:#DCFFB9;"' ?> ><?php echo $product['order_sales']; ?></td>
          <?php } ?>
          <?php if (in_array('all_order_prod_costs', $advppp_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap" title="<?php echo $column_order_prod_costs; ?> [<?php echo $column_order_order_id; ?>: <?php echo $product['order_id']; ?>]" <?php echo ($filter_report == 'products_abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><span style="color:#F00"><?php echo $product['order_product_costs']; ?></span></td>
          <?php } ?>
          <?php if (in_array('all_order_commission', $advppp_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap" title="<?php echo $column_order_commission; ?> [<?php echo $column_order_order_id; ?>: <?php echo $product['order_id']; ?>]" <?php echo ($filter_report == 'products_abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><span style="color:#F00"><?php echo $product['order_commission']; ?></span></td>
          <?php } ?>
          <?php if (in_array('all_order_payment_cost', $advppp_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap" title="<?php echo $column_order_payment_cost; ?> [<?php echo $column_order_order_id; ?>: <?php echo $product['order_id']; ?>]" <?php echo ($filter_report == 'products_abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><span <?php if ($advppp_formula_3) { echo 'style="color:#F00"'; } ?>><?php echo $product['order_payment_cost']; ?></span></td>
          <?php } ?>
          <?php if (in_array('all_order_shipping_cost', $advppp_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap" title="<?php echo $column_order_shipping_cost; ?> [<?php echo $column_order_order_id; ?>: <?php echo $product['order_id']; ?>]" <?php echo ($filter_report == 'products_abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><span <?php if ($advppp_formula_2) { echo 'style="color:#F00"'; } ?>><?php echo $product['order_shipping_cost']; ?></span></td>
          <?php } ?>
          <?php if (in_array('all_order_extra_cost', $advppp_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap" title="<?php echo $column_order_extra_cost; ?> [<?php echo $column_order_order_id; ?>: <?php echo $product['order_id']; ?>]" <?php echo ($filter_report == 'products_abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><span <?php if ($advppp_formula_4) { echo 'style="color:#F00"'; } ?>><?php echo $product['order_extra_cost']; ?></span></td>
          <?php } ?>
          <?php if (in_array('all_order_return_cost', $advppp_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap" title="<?php echo $column_order_return_cost; ?> [<?php echo $column_order_order_id; ?>: <?php echo $product['order_id']; ?>]" <?php echo ($filter_report == 'products_abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><span <?php if ($advppp_formula_5) { echo 'style="color:#F00"'; } ?>><?php echo $product['order_return_cost']; ?></span></td>
          <?php } ?>                    
          <?php if (in_array('all_shipping_balance', $advppp_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap" title="<?php echo $column_shipping_balance; ?> [<?php echo $column_order_order_id; ?>: <?php echo $product['order_id']; ?>]" <?php echo ($filter_report == 'products_abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><?php echo $product['order_ship_balance']; ?></td>
          <?php } ?>            
          <?php if (in_array('all_order_costs', $advppp_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap" title="<?php echo $column_order_costs; ?> [<?php echo $column_order_order_id; ?>: <?php echo $product['order_id']; ?>]" <?php echo ($filter_report == 'products_abandoned_orders') ? 'style="background-color:#ffd7d7; text-decoration:line-through;"' : 'style="background-color:#ffd7d7;"' ?> ><?php echo $product['order_costs']; ?></td>
          <?php } ?>
          <?php if (in_array('all_order_profit', $advppp_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap" title="<?php echo $column_order_profit; ?> [<?php echo $column_order_order_id; ?>: <?php echo $product['order_id']; ?>]" <?php echo ($filter_report == 'products_abandoned_orders') ? (($product['order_profit_raw'] >= 0) ? 'style="background-color:#c4d9ee; font-weight:bold; text-decoration:line-through;"' : 'style="background-color:#F99; font-weight:bold; text-decoration:line-through;"') : (($product['order_profit_raw'] >= 0) ? 'style="background-color:#c4d9ee; font-weight:bold;"' : 'style="background-color:#F99; font-weight:bold;"') ?> ><?php echo $product['order_profit']; ?></td>
          <?php } ?>
          <?php if (in_array('all_order_profit_prc', $advppp_settings_all_columns)) { ?>          
          <td class="right" nowrap="nowrap" title="<?php echo $column_order_margin; ?> [<?php echo $column_order_order_id; ?>: <?php echo $product['order_id']; ?>]" <?php echo ($filter_report == 'products_abandoned_orders') ? (($product['order_profit_raw'] >= 0) ? 'style="background-color:#c4d9ee; font-weight:bold; text-decoration:line-through;"' : 'style="background-color:#F99; font-weight:bold; text-decoration:line-through;"') : (($product['order_profit_raw'] >= 0) ? 'style="background-color:#c4d9ee; font-weight:bold;"' : 'style="background-color:#F99; font-weight:bold;"') ?> ><?php echo $product['order_profit_prc']; ?></td>
          <?php } ?>
          <?php if (in_array('all_order_shipping_method', $advppp_settings_all_columns)) { ?>          
...
<?php if ($filter_details != 'all_details_products' && $filter_details != 'all_details_orders' && $filter_limit != '999999') { ?>
    <table class="list_main">
        <thead>
          ...
          <?php } ?>
          <?php if ($filter_report == 'products_shopping_carts' or $filter_report == 'products_wishlists') { ?>
          <?php if (in_array('scw_id', $advppp_settings_scw_columns)) { ?>            
          <td class="right"><?php echo $column_id; $c++; ?></td>
          <?php } ?>   
          <?php if (in_array('scw_image', $advppp_settings_scw_columns)) { ?>            
          <td class="center"><?php echo $column_image; $c++; ?></td>
          <?php } ?>  
          <?php if (in_array('scw_name', $advppp_settings_scw_columns)) { ?>            
          ...
          <?php } ?>  
          <?php if (in_array('scw_sku', $advppp_settings_scw_columns)) { ?>            
          <td class="left"><?php echo $column_sku; $c++; ?></td>
          <?php } ?>   
          <?php if (in_array('scw_upc', $advppp_settings_scw_columns)) { ?>            
          <td class="left"><?php echo $column_upc; $c++; ?></td>
          <?php } ?>  
          <?php if (in_array('scw_ean', $advppp_settings_scw_columns)) { ?>            
          <td class="left"><?php echo $column_ean; $c++; ?></td>
          <?php } ?>  
          <?php if (in_array('scw_jan', $advppp_settings_scw_columns)) { ?>            
          <td class="left"><?php echo $column_jan; $c++; ?></td>
          <?php } ?>  
          <?php if (in_array('scw_isbn', $advppp_settings_scw_columns)) { ?>            
          <td class="left"><?php echo $column_isbn; $c++; ?></td>
          <?php } ?>  
          <?php if (in_array('scw_mpn', $advppp_settings_scw_columns)) { ?>            
          <td class="left"><?php echo $column_mpn; $c++; ?></td>
          <?php } ?>     
          <?php if (in_array('scw_model', $advppp_settings_scw_columns)) { ?>            
          <td class="left"><?php echo $column_model; $c++; ?></td>
          <?php } ?>   
          <?php if (in_array('scw_category', $advppp_settings_scw_columns)) { ?>            
          <td class="left"><?php echo $column_category; $c++; ?></td>
          <?php } ?>   
          <?php if (in_array('scw_manufacturer', $advppp_settings_scw_columns)) { ?>
          <td class="left"><?php echo $column_manufacturer; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('scw_supplier', $advppp_settings_scw_columns)) { ?>
          <td class="left"><?php echo $column_supplier; $c++; ?></td>
          <?php } ?>          
          <?php if (in_array('scw_attribute', $advppp_settings_scw_columns)) { ?>
          <td class="left"><?php echo $column_attribute; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('scw_status', $advppp_settings_scw_columns)) { ?>          
          <td class="left"><?php echo $column_status; $c++; ?></td> 
          <?php } ?>
          <?php if (in_array('scw_location', $advppp_settings_scw_columns)) { ?>            
          <td class="left"><?php echo $column_location; $c++; ?></td>
          <?php } ?>   
          <?php if (in_array('scw_tax_class', $advppp_settings_scw_columns)) { ?>          
          <td class="left"><?php echo $column_tax_class; $c++; ?></td>
          <?php } ?>    
          <?php if (in_array('scw_viewed', $advppp_settings_scw_columns)) { ?>          
          <td class="right"><?php echo $column_viewed; $c++; ?></td> 
          <?php } ?>              
          <?php if (in_array('scw_price', $advppp_settings_scw_columns)) { ?>          
          <td class="right"><?php echo $column_price; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('scw_cost', $advppp_settings_scw_columns)) { ?>          
          <td class="right"><?php echo $column_cost; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('scw_profit', $advppp_settings_scw_columns)) { ?>          
          <td class="right"><label class="control-label"><span data-toggle="tooltip" title="<?php echo $help_profit; ?>"><?php echo $column_profit; $c++; ?></span></label></td>
          <?php } ?>    
          <?php if (in_array('scw_profit_margin', $advppp_settings_scw_columns)) { ?>          
          <td class="right"><label class="control-label"><span data-toggle="tooltip" title="<?php echo $help_profit_margin; ?>"><?php echo $column_profit_margin; $c++; ?></span></label></td>
          <?php } ?>                
          <?php if (in_array('scw_profit_markup', $advppp_settings_scw_columns)) { ?>          
          <td class="right"><label class="control-label"><span data-toggle="tooltip" title="<?php echo $help_profit_markup; ?>"><?php echo $column_profit_markup; $c++; ?></span></label></td>
          <?php } ?>                                          
          <?php if (in_array('scw_stock_quantity', $advppp_settings_scw_columns)) { ?>                           
          <td class="right"><?php echo $column_stock_quantity; $c++; ?></td>
          <?php } ?>
          <?php if ($filter_report == 'products_shopping_carts') { ?>
          <?php if (in_array('scw_cart_quantity', $advppp_settings_scw_columns)) { ?>                           
          <td class="right"><?php echo $column_cart_quantity; $c++; ?></td>
          <?php } ?>
          <?php } elseif ($filter_report == 'products_wishlists') { ?>
          <?php if (in_array('scw_wishlist_quantity', $advppp_settings_scw_columns)) { ?>                           
          ...
          <?php if (in_array('pnp_id', $advppp_settings_pnp_columns)) { ?>            
          <td class="right"><?php echo $column_id; $c++; ?></td>
          <?php } ?>   
          <?php if (in_array('pnp_image', $advppp_settings_pnp_columns)) { ?>            
          <td class="center"><?php echo $column_image; $c++; ?></td>
          <?php } ?>  
          <?php if (in_array('pnp_name', $advppp_settings_pnp_columns)) { ?>            
          <td class="left"><?php echo $column_prod_name; $c++; ?></td>
          <?php } ?>  
          <?php if (in_array('pnp_sku', $advppp_settings_pnp_columns)) { ?>            
          <td class="left"><?php echo $column_sku; $c++; ?></td>
          <?php } ?>   
          <?php if (in_array('pnp_upc', $advppp_settings_pnp_columns)) { ?>            
          <td class="left"><?php echo $column_upc; $c++; ?></td>
          <?php } ?>  
          <?php if (in_array('pnp_ean', $advppp_settings_pnp_columns)) { ?>            
          <td class="left"><?php echo $column_ean; $c++; ?></td>
          <?php } ?>  
          <?php if (in_array('pnp_jan', $advppp_settings_pnp_columns)) { ?>            
          <td class="left"><?php echo $column_jan; $c++; ?></td>
          <?php } ?>  
          <?php if (in_array('pnp_isbn', $advppp_settings_pnp_columns)) { ?>            
          <td class="left"><?php echo $column_isbn; $c++; ?></td>
          <?php } ?>  
          <?php if (in_array('pnp_mpn', $advppp_settings_pnp_columns)) { ?>            
          <td class="left"><?php echo $column_mpn; $c++; ?></td>
          <?php } ?>     
          <?php if (in_array('pnp_model', $advppp_settings_pnp_columns)) { ?>            
          <td class="left"><?php echo $column_model; $c++; ?></td>
          <?php } ?>   
          <?php if (in_array('pnp_category', $advppp_settings_pnp_columns)) { ?>            
          <td class="left"><?php echo $column_category; $c++; ?></td>
          <?php } ?>   
          <?php if (in_array('pnp_manufacturer', $advppp_settings_pnp_columns)) { ?>
          <td class="left"><?php echo $column_manufacturer; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('pnp_supplier', $advppp_settings_pnp_columns)) { ?>
          <td class="left"><?php echo $column_supplier; $c++; ?></td>
          <?php } ?>          
          <?php if (in_array('pnp_attribute', $advppp_settings_pnp_columns)) { ?>
          <td class="left"><?php echo $column_attribute; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('pnp_status', $advppp_settings_pnp_columns)) { ?>          
          <td class="left"><?php echo $column_status; $c++; ?></td> 
          <?php } ?>
          <?php if (in_array('pnp_location', $advppp_settings_pnp_columns)) { ?>            
          <td class="left"><?php echo $column_location; $c++; ?></td>
          <?php } ?>   
          <?php if (in_array('pnp_tax_class', $advppp_settings_pnp_columns)) { ?>          
          <td class="left"><?php echo $column_tax_class; $c++; ?></td>
          <?php } ?>  
          <?php if (in_array('pnp_viewed', $advppp_settings_pnp_columns)) { ?>          
          <td class="right"><?php echo $column_viewed; $c++; ?></td> 
          <?php } ?>              
          <?php if (in_array('pnp_price', $advppp_settings_pnp_columns)) { ?>          
          <td class="right"><?php echo $column_price; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('pnp_cost', $advppp_settings_pnp_columns)) { ?>          
          <td class="right"><?php echo $column_cost; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('pnp_profit', $advppp_settings_pnp_columns)) { ?>          
          <td class="right"><label class="control-label"><span data-toggle="tooltip" title="<?php echo $help_profit; ?>"><?php echo $column_profit; $c++; ?></span></label></td>
          <?php } ?>    
          <?php if (in_array('pnp_profit_margin', $advppp_settings_pnp_columns)) { ?>          
          <td class="right"><label class="control-label"><span data-toggle="tooltip" title="<?php echo $help_profit_margin; ?>"><?php echo $column_profit_margin; $c++; ?></span></label></td>
          <?php } ?>                
          <?php if (in_array('pnp_profit_markup', $advppp_settings_pnp_columns)) { ?>          
          <td class="right"><label class="control-label"><span data-toggle="tooltip" title="<?php echo $help_profit_markup; ?>"><?php echo $column_profit_markup; $c++; ?></span></label></td>
          <?php } ?>                     
          <?php if (in_array('pnp_stock_quantity', $advppp_settings_pnp_columns)) { ?>                           
          <td class="right"><?php echo $column_stock_quantity; $c++; ?></td>
          <?php } ?>
          <?php } elseif ($filter_report == 'manufacturers' or $filter_report == 'categories' or $filter_report == 'suppliers') { ?>
          <?php if ($filter_report == 'manufacturers') { ?> 
          <?php if (in_array('cm_manufacturer', $advppp_settings_cm_columns)) { ?>
          <td class="left"><?php echo $column_manufacturer; $c++; ?></td>
          <?php } ?>
		  <?php } elseif ($filter_report == 'categories') { ?>
          <?php if (in_array('cm_category', $advppp_settings_cm_columns)) { ?>            
          <td class="left"><?php echo $column_category; $c++; ?></td>
          <?php } ?>   
		  <?php } elseif ($filter_report == 'suppliers') { ?>
          <?php if (in_array('cm_supplier', $advppp_settings_cm_columns)) { ?>            
          <td class="left"><?php echo $column_supplier; $c++; ?></td>
          <?php } ?>            
		  <?php } ?>  
          <?php if (in_array('cm_orders', $advppp_settings_cm_columns)) { ?>          
          <td class="right"><?php echo $column_orders; $c++; ?></td>
          <?php } ?>  
          <?php if (in_array('cm_customers', $advppp_settings_cm_columns)) { ?>          
          <td class="right"><?php echo $column_customers; $c++; ?></td>
          <?php } ?>  
          <?php if (in_array('cm_sold_quantity', $advppp_settings_cm_columns)) { ?>          
          <td class="right"><?php echo $column_sold_quantity; $c++; ?></td>
          <?php } ?>                  
          <?php if (in_array('cm_sold_percent', $advppp_settings_cm_columns)) { ?>          
          <td class="right"><?php echo $column_sold_percent; $c++; ?></td>
          <?php } ?>    
          <?php if (in_array('cm_total_excl_vat', $advppp_settings_cm_columns)) { ?>          
          <td class="right" style="min-width:75px;"><?php echo $column_prod_total_excl_vat; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('cm_total_tax', $advppp_settings_cm_columns)) { ?>          
          <td class="right"><?php echo $column_total_tax; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('cm_total_incl_vat', $advppp_settings_cm_columns)) { ?>          
          <td class="right" style="min-width:75px;"><?php echo $column_prod_total_incl_vat; $c++; ?></td>
          <?php } ?>                 
          <?php if (in_array('cm_app', $advppp_settings_cm_columns)) { ?>          
          <td class="right" style="min-width:90px;"><?php echo $column_app; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('cm_discount', $advppp_settings_cm_columns)) { ?>          
          <td class="right"><?php echo $column_product_discount; $c++; ?></td>
          <?php } ?>   
          <?php if (in_array('cm_refunds', $advppp_settings_cm_columns)) { ?>          
          <td class="right"><?php echo $column_product_refunds; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('cm_reward_points', $advppp_settings_cm_columns)) { ?>          
          <td class="right"><?php echo $column_product_reward_points; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('cm_total_sales', $advppp_settings_cm_columns)) { ?>          
          <td class="right" style="min-width:95px;"><?php echo $column_total_sales; $c++; ?></td>
          <?php } ?>                                        
          <?php if (in_array('cm_total_costs', $advppp_settings_cm_columns)) { ?>          
          <td class="right" style="min-width:95px;"><?php echo $column_total_costs; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('cm_total_profit', $advppp_settings_cm_columns)) { ?>
          <td class="right" style="min-width:95px;"><label class="control-label"><span data-toggle="tooltip" title="<?php echo $help_total_profit; ?>"><?php echo $column_total_profit; $c++; ?></span></label></td>
          <?php } ?>
          <?php if (in_array('cm_total_profit_margin', $advppp_settings_cm_columns)) { ?>          
          <td class="right" style="min-width:85px;"><label class="control-label"><span data-toggle="tooltip" title="<?php echo $help_total_profit_margin; ?>"><?php echo $column_total_profit_margin; $c++; ?></span></label></td>
          <?php } ?>     
          <?php if (in_array('cm_total_profit_markup', $advppp_settings_cm_columns)) { ?>          
          <td class="right" style="min-width:85px;"><label class="control-label"><span data-toggle="tooltip" title="<?php echo $help_total_profit_markup; ?>"><?php echo $column_total_profit_markup; $c++; ?></span></label></td>
          <?php } ?>                 
          ...
          <?php if (in_array('mv_orders', $advppp_settings_mv_columns)) { ?>          
          <td class="right"><?php echo $column_orders; $c++; ?></td>
          <?php } ?>  
          <?php if (in_array('mv_customers', $advppp_settings_mv_columns)) { ?>          
          <td class="right"><?php echo $column_customers; $c++; ?></td>
          <?php } ?> 
          <td class="right"><?php echo $column_sold_quantity; $c++; ?></td>
          <td class="right"><?php echo $column_sold_percent; $c++; ?></td> 
          <?php if ($filter_details == 'basic_details') { ?><td class="center"><?php $c++; ?><a class="btn btn-info btn-sm toggle-all expand" data-original-title="<?php echo $button_expand; ?>" data-toggle="tooltip"><i id="circle" class="fa fa-arrow-circle-down"></i></a></td><?php } ?>          
          <?php } else { ?>
          <?php if (in_array('mv_id', $advppp_settings_mv_columns)) { ?>            
          <td class="right"><?php echo $column_id; $c++; ?></td>
          <?php } ?>   
          <?php if (in_array('mv_image', $advppp_settings_mv_columns)) { ?>            
          <td class="center"><?php echo $column_image; $c++; ?></td>
          <?php } ?>   
          <?php if (in_array('mv_name', $advppp_settings_mv_columns)) { ?>            
          ...
          <?php } ?>  
          <?php if (in_array('mv_sku', $advppp_settings_mv_columns)) { ?>            
          <td class="left"><?php echo $column_sku; $c++; ?></td>
          <?php } ?>  
          <?php if (in_array('mv_upc', $advppp_settings_mv_columns)) { ?>            
          <td class="left"><?php echo $column_upc; $c++; ?></td>
          <?php } ?>  
          <?php if (in_array('mv_ean', $advppp_settings_mv_columns)) { ?>            
          <td class="left"><?php echo $column_ean; $c++; ?></td>
          <?php } ?>  
          <?php if (in_array('mv_jan', $advppp_settings_mv_columns)) { ?>            
          <td class="left"><?php echo $column_jan; $c++; ?></td>
          <?php } ?>  
          <?php if (in_array('mv_isbn', $advppp_settings_mv_columns)) { ?>            
          <td class="left"><?php echo $column_isbn; $c++; ?></td>
          <?php } ?>  
          <?php if (in_array('mv_mpn', $advppp_settings_mv_columns)) { ?>            
          <td class="left"><?php echo $column_mpn; $c++; ?></td>
          <?php } ?>     
          <?php if (in_array('mv_model', $advppp_settings_mv_columns)) { ?>            
          <td class="left"><?php echo $column_model; $c++; ?></td>
          <?php } ?>   
          <?php if (in_array('mv_category', $advppp_settings_mv_columns)) { ?>            
          <td class="left"><?php echo $column_category; $c++; ?></td>
          <?php } ?>   
          <?php if (in_array('mv_manufacturer', $advppp_settings_mv_columns)) { ?>
          <td class="left"><?php echo $column_manufacturer; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('mv_supplier', $advppp_settings_mv_columns)) { ?>
          <td class="left"><?php echo $column_supplier; $c++; ?></td>
          <?php } ?>          
          <?php if (in_array('mv_attribute', $advppp_settings_mv_columns)) { ?>
          <td class="left"><?php echo $column_attribute; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('mv_status', $advppp_settings_mv_columns)) { ?>          
          <td class="left"><?php echo $column_status; $c++; ?></td> 
          <?php } ?>
          <?php if (in_array('mv_location', $advppp_settings_mv_columns)) { ?>            
          <td class="left"><?php echo $column_location; $c++; ?></td>
          <?php } ?>   
          <?php if (in_array('mv_tax_class', $advppp_settings_mv_columns)) { ?>          
          <td class="left"><?php echo $column_tax_class; $c++; ?></td>
          <?php } ?>  
          <?php if (in_array('mv_viewed', $advppp_settings_mv_columns)) { ?>          
          <td class="right"><?php echo $column_viewed; $c++; ?></td> 
          <?php } ?>            
          <?php if (in_array('mv_price', $advppp_settings_mv_columns)) { ?>          
          <td class="right"><?php echo $column_price; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('mv_cost', $advppp_settings_mv_columns)) { ?>          
          <td class="right"><?php echo $column_cost; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('mv_profit', $advppp_settings_mv_columns)) { ?>
          <td class="right"><label class="control-label"><span data-toggle="tooltip" title="<?php echo $help_profit; ?>"><?php echo $column_profit; $c++; ?></span></label></td>
          <?php } ?>
          <?php if (in_array('mv_profit_margin', $advppp_settings_mv_columns)) { ?>          
          <td class="right"><label class="control-label"><span data-toggle="tooltip" title="<?php echo $help_profit_margin; ?>"><?php echo $column_profit_margin; $c++; ?></span></label></td>
          <?php } ?>
          <?php if (in_array('mv_profit_markup', $advppp_settings_mv_columns)) { ?>          
          <td class="right"><label class="control-label"><span data-toggle="tooltip" title="<?php echo $help_profit_markup; ?>"><?php echo $column_profit_markup; $c++; ?></span></label></td>
          <?php } ?>                  
          <?php if (in_array('mv_stock_quantity', $advppp_settings_mv_columns)) { ?>                           
          <td class="right"><?php echo $column_stock_quantity; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('mv_orders', $advppp_settings_mv_columns)) { ?>          
          <td class="right"><?php echo $column_orders; $c++; ?></td>
          ...
          <td class="right"><?php echo $column_customers; $c++; ?></td>
          <?php } ?> 
          <?php if (in_array('mv_sold_quantity', $advppp_settings_mv_columns)) { ?>          
          <td class="right"><?php echo $column_sold_quantity; $c++; ?></td>
          <?php } ?>                  
          <?php if (in_array('mv_sold_percent', $advppp_settings_mv_columns)) { ?>          
          <td class="right"><?php echo $column_sold_percent; $c++; ?></td>
          <?php } ?>     
          <?php if (in_array('mv_total_excl_vat', $advppp_settings_mv_columns)) { ?>          
          <td class="right" style="min-width:75px;"><?php echo $column_prod_total_excl_vat; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('mv_total_tax', $advppp_settings_mv_columns)) { ?>          
          <td class="right"><?php echo $column_total_tax; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('mv_total_incl_vat', $advppp_settings_mv_columns)) { ?>          
          <td class="right" style="min-width:75px;"><?php echo $column_prod_total_incl_vat; $c++; ?></td>
          <?php } ?>                 
          <?php if (in_array('mv_app', $advppp_settings_mv_columns)) { ?>          
          <td class="right" style="min-width:90px;"><?php echo $column_app; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('mv_discount', $advppp_settings_mv_columns)) { ?>          
          <td class="right" style="min-width:90px;"><?php echo $column_product_discount; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('mv_refunds', $advppp_settings_mv_columns)) { ?>          
          <td class="right"><?php echo $column_product_refunds; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('mv_reward_points', $advppp_settings_mv_columns)) { ?>          
          <td class="right"><?php echo $column_product_reward_points; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('mv_total_sales', $advppp_settings_mv_columns)) { ?>          
          <td class="right" style="min-width:95px;"><?php echo $column_total_sales; $c++; ?></td>
          <?php } ?>                                        
          <?php if (in_array('mv_total_costs', $advppp_settings_mv_columns)) { ?>          
          <td class="right" style="min-width:95px;"><?php echo $column_total_costs; $c++; ?></td>
          <?php } ?>
          <?php if (in_array('mv_total_profit', $advppp_settings_mv_columns)) { ?>
          <td class="right" style="min-width:95px;"><label class="control-label"><span data-toggle="tooltip" title="<?php echo $help_total_profit; ?>"><?php echo $column_total_profit; $c++; ?></span></label></td>
          <?php } ?>
          <?php if (in_array('mv_total_profit_margin', $advppp_settings_mv_columns)) { ?>          
          <td class="right" style="min-width:85px;"><label class="control-label"><span data-toggle="tooltip" title="<?php echo $help_total_profit_margin; ?>"><?php echo $column_total_profit_margin; $c++; ?></span></label></td>
          <?php } ?>
          <?php if (in_array('mv_total_profit_markup', $advppp_settings_mv_columns)) { ?>          
          <td class="right" style="min-width:85px;"><label class="control-label"><span data-toggle="tooltip" title="<?php echo $help_total_profit_markup; ?>"><?php echo $column_total_profit_markup; $c++; ?></span></label></td>
          <?php } ?>          
          <?php if ($filter_details == 'basic_details') { ?><td class="center"><?php $c++; ?><a class="btn btn-info btn-sm toggle-all expand" data-original-title="<?php echo $button_expand; ?>" data-toggle="tooltip"><i id="circle" class="fa fa-arrow-circle-down"></i></a></td><?php } ?> 
          <?php } ?>
          ...
          <td class="left">
		  <?php foreach ($suppliers as $supplier) { ?>
          <?php if (in_array($supplier['supplier_id'], $product['supplier'])) { ?>
          ...
          <?php } ?>         
          <?php if (in_array('scw_price', $advppp_settings_scw_columns)) { ?>           
          <td class="right" nowrap="nowrap" style="background-color:#f1f9e9;"><?php echo $product['price']; ?></td>  
          <?php } ?>  
          <?php if (in_array('scw_cost', $advppp_settings_scw_columns)) { ?>           
          <td class="right" nowrap="nowrap" style="background-color:#f7e9e3;"><?php echo $product['cost']; ?></td>  
          <?php } ?>  
          <?php if (in_array('scw_profit', $advppp_settings_scw_columns)) { ?>             
          <td class="right" nowrap="nowrap" <?php echo ($product['profit_raw'] >= 0) ? 'style="background-color:#dfe7ee; font-weight:bold;"' : 'style="background-color:#F99; font-weight:bold;"' ?> ><?php echo $product['profit']; ?></td>
          <?php } ?>
          <?php if (in_array('scw_profit_margin', $advppp_settings_scw_columns)) { ?>           
          <td class="right" nowrap="nowrap" <?php echo ($product['profit_raw'] >= 0) ? 'style="background-color:#dfe7ee; font-weight:bold;"' : 'style="background-color:#F99; font-weight:bold;"' ?> ><?php echo $product['profit_margin']; ?></td>
          <?php } ?>  
          <?php if (in_array('scw_profit_markup', $advppp_settings_scw_columns)) { ?>           
          <td class="right" nowrap="nowrap" <?php echo ($product['profit_raw'] >= 0) ? 'style="background-color:#dfe7ee; font-weight:bold;"' : 'style="background-color:#F99; font-weight:bold;"' ?> ><?php echo $product['profit_markup']; ?></td>
          <?php } ?>        
          <?php if (in_array('scw_stock_quantity', $advppp_settings_scw_columns)) { ?>          
          ...
          <?php } ?>
          <?php if (in_array('cm_total_excl_vat', $advppp_settings_cm_columns)) { ?>          
          <td class="right" nowrap="nowrap" style="color:#090;"><?php echo $product['total_excl_vat']; ?></td>
          <?php } ?>
          <?php if (in_array('cm_total_tax', $advppp_settings_cm_columns)) { ?>          
          ...
          <?php } ?> 
          <?php if (in_array('cm_discount', $advppp_settings_cm_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $product['discount']; ?></td>
          <?php } ?>           
          <?php if (in_array('cm_refunds', $advppp_settings_cm_columns)) { ?>          
          <td class="right" nowrap="nowrap" <?php echo ($advppp_formula_6 ? 'style="color:#090;"' : '') ?> ><?php echo $product['refunds']; ?></td>
          <?php } ?> 
          <?php if (in_array('cm_reward_points', $advppp_settings_cm_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $product['reward_points']; ?></td>
          <?php } ?>
          <?php if (in_array('cm_total_sales', $advppp_settings_cm_columns)) { ?>
          <td class="right" nowrap="nowrap" style="background-color:#DCFFB9;"><?php echo $product['total_sales']; ?></td>  
          <?php } ?>
          <?php if (in_array('cm_total_costs', $advppp_settings_cm_columns)) { ?>
          <td class="right" nowrap="nowrap" style="background-color:#ffd7d7;"><?php echo $product['total_costs']; ?></td>
          <?php } ?>
          <?php if (in_array('cm_total_profit', $advppp_settings_cm_columns)) { ?>
          <td class="right" nowrap="nowrap" <?php echo ($product['total_profit_raw'] >= 0) ? 'style="background-color:#c4d9ee; font-weight:bold;"' : 'style="background-color:#F99; font-weight:bold;"' ?> ><?php echo $product['total_profit']; ?></td>
          <?php } ?>
          <?php if (in_array('cm_total_profit_margin', $advppp_settings_cm_columns)) { ?>
		  <td class="right" nowrap="nowrap" <?php echo ($product['total_profit_raw'] >= 0) ? 'style="background-color:#c4d9ee; font-weight:bold;"' : 'style="background-color:#F99; font-weight:bold;"' ?> ><?php echo ($product['sold_quantity'] > 0) ? $product['total_profit_margin'] : '0%' ?></td>
          <?php } ?>
          <?php if (in_array('cm_total_profit_markup', $advppp_settings_cm_columns)) { ?>
		  <td class="right" nowrap="nowrap" <?php echo ($product['total_profit_raw'] >= 0) ? 'style="background-color:#c4d9ee; font-weight:bold;"' : 'style="background-color:#F99; font-weight:bold;"' ?> ><?php echo ($product['sold_quantity'] > 0) ? $product['total_profit_markup'] : '0%' ?></td>
          <?php } ?>                 
          ...
          <?php } ?>    
          <?php if (in_array('mv_price', $advppp_settings_mv_columns)) { ?>           
          <td class="right" nowrap="nowrap" style="background-color:#f1f9e9;"><?php echo $product['price']; ?>
		  <?php if ($filter_report == 'products_purchased_with_options' or $filter_report == 'products_abandoned_orders') { ?> 
		  <?php if ($product['option']) { ?><br />
          <?php foreach ($product['option'] as $option) { ?> 
          <div style="font-size:smaller;"><?php echo $option['fprice']; ?><br /></div>
          <?php } ?>
		  <?php } ?>
		  <?php } ?>
          </td>  
          <?php } ?>
          <?php if (in_array('mv_cost', $advppp_settings_mv_columns)) { ?>                                                          
          <td class="right" nowrap="nowrap" style="background-color:#f7e9e3;"><?php echo $product['cost']; ?>
		  <?php if ($filter_report == 'products_purchased_with_options' or $filter_report == 'products_abandoned_orders') { ?> 
		  <?php if ($product['option']) { ?><br />
          <?php foreach ($product['option'] as $option) { ?> 
          <div style="font-size:smaller;"><?php echo $option['fcost']; ?><br /></div>
          <?php } ?>
		  <?php } ?>
		  <?php } ?>
          </td>
          ...
          <?php } ?>
          <?php if (in_array('mv_total_excl_vat', $advppp_settings_mv_columns)) { ?>          
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'products_abandoned_orders') ? 'style="color:#090; text-decoration:line-through;"' : 'style="color:#090;"' ?> ><?php echo $product['total_excl_vat']; ?></td>
          <?php } ?>
          <?php if (in_array('mv_total_tax', $advppp_settings_mv_columns)) { ?>          
          ...
          <?php } ?> 
          <?php if (in_array('mv_discount', $advppp_settings_mv_columns)) { ?>          
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'products_abandoned_orders') ? 'style="text-decoration:line-through;"' : '' ?> ><?php echo $product['discount']; ?></td>
          <?php } ?> 
          <?php if (in_array('mv_refunds', $advppp_settings_mv_columns)) { ?>          
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'products_abandoned_orders') ? (($advppp_formula_6) ? 'style="color:#090; text-decoration:line-through;"' : 'style="text-decoration:line-through;"') : (($advppp_formula_6) ? 'style="color:#090;"' : '') ?> ><?php echo $product['refunds']; ?></td>
          <?php } ?> 
          <?php if (in_array('mv_reward_points', $advppp_settings_mv_columns)) { ?>          
          ...
          <?php } ?>                                               
          <?php if (in_array('mv_total_sales', $advppp_settings_mv_columns)) { ?>
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'products_abandoned_orders') ? 'style="background-color:#DCFFB9; text-decoration:line-through;"' : 'style="background-color:#DCFFB9;"' ?> ><?php echo $product['total_sales']; ?></td>  
          <?php } ?>
          <?php if (in_array('mv_total_costs', $advppp_settings_mv_columns)) { ?>
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'products_abandoned_orders') ? 'style="background-color:#ffd7d7; text-decoration:line-through;"' : 'style="background-color:#ffd7d7;"' ?> ><?php echo $product['total_costs']; ?></td>
          <?php } ?>
          <?php if (in_array('mv_total_profit', $advppp_settings_mv_columns)) { ?>
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'products_abandoned_orders') ? (($product['total_profit_raw'] >= 0) ? 'style="background-color:#c4d9ee; font-weight:bold; text-decoration:line-through;"' : 'style="background-color:#F99; font-weight:bold; text-decoration:line-through;"') : (($product['total_profit_raw'] >= 0) ? 'style="background-color:#c4d9ee; font-weight:bold;"' : 'style="background-color:#F99; font-weight:bold;"') ?> ><?php echo $product['total_profit']; ?></td>
          <?php } ?>
          <?php if (in_array('mv_total_profit_margin', $advppp_settings_mv_columns)) { ?>
		  <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'products_abandoned_orders') ? (($product['total_profit_raw'] >= 0) ? 'style="background-color:#c4d9ee; font-weight:bold; text-decoration:line-through;"' : 'style="background-color:#F99; font-weight:bold; text-decoration:line-through;"') : (($product['total_profit_raw'] >= 0) ? 'style="background-color:#c4d9ee; font-weight:bold;"' : 'style="background-color:#F99; font-weight:bold;"') ?> ><?php echo ($product['sold_quantity'] > 0) ? $product['total_profit_margin'] : '0%' ?></td>
          <?php } ?>
          <?php if (in_array('mv_total_profit_markup', $advppp_settings_mv_columns)) { ?>
		  <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'products_abandoned_orders') ? (($product['total_profit_raw'] >= 0) ? 'style="background-color:#c4d9ee; font-weight:bold; text-decoration:line-through;"' : 'style="background-color:#F99; font-weight:bold; text-decoration:line-through;"') : (($product['total_profit_raw'] >= 0) ? 'style="background-color:#c4d9ee; font-weight:bold;"' : 'style="background-color:#F99; font-weight:bold;"') ?> ><?php echo ($product['sold_quantity'] > 0) ? $product['total_profit_markup'] : '0%' ?></td>
          <?php } ?>          
          <?php if ($filter_details == 'basic_details') { ?><td class="center"><a class="btn btn-info btn-xs"><?php echo $text_detail; ?></a></td><?php } ?> 
          <?php } ?>
          </tr>        
...
<div id="tab_details_<?php echo $product['date']; ?>" class="more" style="display:none;">
    <table class="list_detail">
      <thead>
        <tr>
          <?php if (in_array('scw_customer_id', $advppp_settings_scw_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_customer_cust_id; ?></td>
          <?php } ?>        
          <?php if (in_array('scw_date_added', $advppp_settings_scw_columns)) { ?>
          <td class="left" nowrap="nowrap"><?php echo $column_customer_date_added; ?></td>
          <?php } ?>           
          <?php if (in_array('scw_customer_name', $advppp_settings_scw_columns)) { ?>                           
          <td class="left" nowrap="nowrap"><?php echo $column_order_customer; ?></td>
          <?php } ?>
          <?php if (in_array('scw_customer_email', $advppp_settings_scw_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_order_email; ?></td>
          <?php } ?>
          <?php if (in_array('scw_customer_telephone', $advppp_settings_scw_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_customer_telephone; ?></td>
          <?php } ?>            
          <?php if (in_array('scw_customer_group', $advppp_settings_scw_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_order_customer_group; ?></td>
          <?php } ?>  
          <?php if (in_array('scw_billing_company', $advppp_settings_scw_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_company; ?></td>
          <?php } ?>
          <?php if (in_array('scw_billing_address_1', $advppp_settings_scw_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_address_1; ?></td> 
          <?php } ?>
          <?php if (in_array('scw_billing_address_2', $advppp_settings_scw_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_address_2; ?></td> 
          <?php } ?>
          <?php if (in_array('scw_billing_city', $advppp_settings_scw_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_city; ?></td>
          <?php } ?>
          <?php if (in_array('scw_billing_zone', $advppp_settings_scw_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_region_state; ?></td> 
          <?php } ?>
          <?php if (in_array('scw_billing_postcode', $advppp_settings_scw_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_postcode; ?></td>
          <?php } ?>
          <?php if (in_array('scw_billing_country', $advppp_settings_scw_columns)) { ?>          
...
<div id="tab_details_<?php echo $product['order_product_id']; ?>" class="more" style="display:none;">
    <table class="list_detail">
      <thead>
        <tr>
          <?php if (in_array('ol_order_order_id', $advppp_settings_ol_columns)) { ?>
          <td class="left" nowrap="nowrap"><?php echo $column_order_order_id; ?></td>
          <?php } ?>
          <?php if (in_array('ol_order_date_added', $advppp_settings_ol_columns)) { ?>
          <td class="left" nowrap="nowrap"><?php echo $column_order_date_added; ?></td>
          <?php } ?>
          <?php if (in_array('ol_order_inv_no', $advppp_settings_ol_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_order_inv_no; ?></td> 
          <?php } ?>
          <?php if (in_array('ol_order_customer', $advppp_settings_ol_columns)) { ?>                           
          <td class="left" nowrap="nowrap"><?php echo $column_order_customer; ?></td>
          <?php } ?>
          <?php if (in_array('ol_order_email', $advppp_settings_ol_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_order_email; ?></td>
          <?php } ?>
          <?php if (in_array('ol_order_customer_group', $advppp_settings_ol_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_order_customer_group; ?></td>
          <?php } ?>
          <?php if (in_array('ol_order_shipping_method', $advppp_settings_ol_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_order_shipping_method; ?></td>
          <?php } ?>
          <?php if (in_array('ol_order_payment_method', $advppp_settings_ol_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_order_payment_method; ?></td>
          <?php } ?>
          <?php if (in_array('ol_order_status', $advppp_settings_ol_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_order_status; ?></td>
          <?php } ?>
          <?php if (in_array('ol_order_store', $advppp_settings_ol_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_order_store; ?></td>
          <?php } ?>
          <?php if (in_array('ol_order_currency', $advppp_settings_ol_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_order_currency; ?></td>
          <?php } ?>
          <?php if (in_array('ol_prod_price', $advppp_settings_ol_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_prod_price; ?></td>
          <?php } ?>
          <?php if (in_array('ol_prod_quantity', $advppp_settings_ol_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_prod_quantity; ?></td>  
          <?php } ?>          
          <?php if (in_array('ol_prod_total_excl_vat', $advppp_settings_ol_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_prod_total_excl_vat; ?></td>
          <?php } ?>
          <?php if (in_array('ol_prod_tax', $advppp_settings_ol_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_prod_tax; ?></td>
          <?php } ?>
          <?php if (in_array('ol_prod_total_incl_vat', $advppp_settings_ol_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_prod_total_incl_vat; ?></td>
          <?php } ?>
          <?php if (in_array('ol_prod_sales', $advppp_settings_ol_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_prod_sales; ?></td>
          <?php } ?>
          <?php if (in_array('ol_prod_cost', $advppp_settings_ol_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_prod_cost; ?></td>
          <?php } ?>
          <?php if (in_array('ol_prod_profit', $advppp_settings_ol_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_prod_profit; ?></td>
          <?php } ?>
          <?php if (in_array('ol_prod_profit_margin', $advppp_settings_ol_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_prod_profit_margin; ?></td>
          <?php } ?>
          <?php if (in_array('ol_prod_profit_markup', $advppp_settings_ol_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_prod_profit_markup; ?></td>
          <?php } ?>          
        </tr>
      </thead>
        <tr bgcolor="#FFFFFF">
          ...
          <?php } ?>
          <?php if (in_array('ol_prod_total_excl_vat', $advppp_settings_ol_columns)) { ?>          
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'products_abandoned_orders') ? 'style="color:#090; text-decoration:line-through;"' : 'style="color:#090;"' ?> ><?php echo $product['order_prod_total_excl_vat']; ?></td>
          <?php } ?>
          <?php if (in_array('ol_prod_tax', $advppp_settings_ol_columns)) { ?>          
          ...
          <?php } ?>
          <?php if (in_array('ol_prod_sales', $advppp_settings_ol_columns)) { ?>          
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'products_abandoned_orders') ? 'style="background-color:#DCFFB9; text-decoration:line-through;"' : 'style="background-color:#DCFFB9;"' ?> ><?php echo $product['order_prod_sales']; ?></td>
          <?php } ?>
          <?php if (in_array('ol_prod_cost', $advppp_settings_ol_columns)) { ?>          
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'products_abandoned_orders') ? 'style="background-color:#ffd7d7; text-decoration:line-through;"' : 'style="background-color:#ffd7d7;"' ?> >-<?php echo $product['order_prod_cost']; ?></td>
          <?php } ?>
          <?php if (in_array('ol_prod_profit', $advppp_settings_ol_columns)) { ?>          
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'products_abandoned_orders') ? 'style="background-color:#c4d9ee; font-weight:bold; text-decoration:line-through;"' : 'style="background-color:#c4d9ee; font-weight:bold;"' ?> ><?php echo $product['order_prod_profit']; ?></td>
          <?php } ?>
          <?php if (in_array('ol_prod_profit_margin', $advppp_settings_ol_columns)) { ?>          
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'products_abandoned_orders') ? 'style="background-color:#c4d9ee; font-weight:bold; text-decoration:line-through;"' : 'style="background-color:#c4d9ee; font-weight:bold;"' ?> ><?php echo $product['order_prod_profit_margin']; ?>%</td>
          <?php } ?>
          <?php if (in_array('ol_prod_profit_markup', $advppp_settings_ol_columns)) { ?>          
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'products_abandoned_orders') ? 'style="background-color:#c4d9ee; font-weight:bold; text-decoration:line-through;"' : 'style="background-color:#c4d9ee; font-weight:bold;"' ?> ><?php echo $product['order_prod_profit_markup']; ?>%</td>
          <?php } ?>          
         </tr>
    </table> 
<?php } ?>    
<?php if (($filter_report == 'manufacturers' or $filter_report == 'categories' or $filter_report == 'suppliers' or $filter_report == 'products_options') && $filter_details == 'basic_details') { ?>
<?php if ($filter_report == 'products_options') { ?>
...
<?php } ?>
    <table class="list_detail">
      <thead>
        <tr>
          <?php if (in_array('pl_prod_order_id', $advppp_settings_pl_columns)) { ?>
          <td class="left" nowrap="nowrap"><?php echo $column_prod_order_id; ?></td>
          <?php } ?>
          <?php if (in_array('pl_prod_date_added', $advppp_settings_pl_columns)) { ?>
          <td class="left" nowrap="nowrap"><?php echo $column_prod_date_added; ?></td>
          <?php } ?>     
          <?php if (in_array('pl_prod_inv_no', $advppp_settings_pl_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_prod_inv_no; ?></td>
          <?php } ?>               
          <?php if (in_array('pl_prod_id', $advppp_settings_pl_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_prod_id; ?></td>
          <?php } ?>
          <?php if (in_array('pl_prod_sku', $advppp_settings_pl_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_prod_sku; ?></td>
          <?php } ?>
          <?php if (in_array('pl_prod_model', $advppp_settings_pl_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_prod_model; ?></td>
          <?php } ?>
          <?php if (in_array('pl_prod_name', $advppp_settings_pl_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_prod_name; ?></td>
          <?php } ?>
          <?php if (in_array('pl_prod_option', $advppp_settings_pl_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_prod_option; ?></td>
          <?php } ?>
          <?php if (in_array('pl_prod_attributes', $advppp_settings_pl_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_prod_attributes; ?></td>
          <?php } ?>
          <?php if ($filter_report == 'categories') { ?>          
          <?php if (in_array('pl_prod_manu', $advppp_settings_pl_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_prod_manu; ?></td>
          <?php } ?>
          <?php if (in_array('pl_prod_supplier', $advppp_settings_pl_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_prod_supplier; ?></td>
          <?php } ?>          
          <?php } ?>
          <?php if ($filter_report == 'manufacturers') { ?>          
          <?php if (in_array('pl_prod_category', $advppp_settings_pl_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_prod_category; ?></td>
          <?php } ?>
          <?php if (in_array('pl_prod_supplier', $advppp_settings_pl_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_prod_supplier; ?></td>
          <?php } ?>                
          <?php } ?>
          <?php if ($filter_report == 'suppliers') { ?>          
          <?php if (in_array('pl_prod_category', $advppp_settings_pl_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_prod_category; ?></td>
          <?php } ?>
          <?php if (in_array('pl_prod_manu', $advppp_settings_pl_columns)) { ?>          
          ...
          <?php } ?>
          <?php } ?>          
          <?php if (in_array('pl_prod_currency', $advppp_settings_pl_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_prod_currency; ?></td>
          <?php } ?>
          <?php if (in_array('pl_prod_price', $advppp_settings_pl_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_prod_price; ?></td>
          <?php } ?>
          <?php if (in_array('pl_prod_quantity', $advppp_settings_pl_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_prod_quantity; ?></td>
          <?php } ?>
          <?php if (in_array('pl_prod_total_excl_vat', $advppp_settings_pl_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_prod_total_excl_vat; ?></td>
          <?php } ?>
          <?php if (in_array('pl_prod_tax', $advppp_settings_pl_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_prod_tax; ?></td>
          <?php } ?>
          <?php if (in_array('pl_prod_total_incl_vat', $advppp_settings_pl_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_prod_total_incl_vat; ?></td>
          <?php } ?>
          <?php if (in_array('pl_prod_sales', $advppp_settings_pl_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_prod_sales; ?></td>
          <?php } ?>
          <?php if (in_array('pl_prod_cost', $advppp_settings_pl_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_prod_cost; ?></td>
          <?php } ?>
          <?php if (in_array('pl_prod_profit', $advppp_settings_pl_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_prod_profit; ?></td>
          <?php } ?>
          <?php if (in_array('pl_prod_profit_margin', $advppp_settings_pl_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_prod_profit_margin; ?></td>
          <?php } ?>
          <?php if (in_array('pl_prod_profit_markup', $advppp_settings_pl_columns)) { ?>          
          <td class="right" nowrap="nowrap"><?php echo $column_prod_profit_markup; ?></td>
          <?php } ?>          
        </tr>
      </thead>
        <tr bgcolor="#FFFFFF">
          ...
          <?php } ?>
          <?php if (in_array('pl_prod_supplier', $advppp_settings_pl_columns)) { ?>           
          <td class="left" nowrap="nowrap"><?php echo $product['product_supplier']; ?></td>
          <?php } ?>          
          <?php } ?>           
          <?php if ($filter_report == 'manufacturers') { ?>          
          <?php if (in_array('pl_prod_category', $advppp_settings_pl_columns)) { ?>           
          ...
          <?php } ?>
          <?php if (in_array('pl_prod_total_excl_vat', $advppp_settings_pl_columns)) { ?>           
          <td class="right" nowrap="nowrap" style="color:#090;"><?php echo $product['product_total_excl_vat']; ?></td>
          <?php } ?>
          <?php if (in_array('pl_prod_tax', $advppp_settings_pl_columns)) { ?>           
          ...
          <?php } ?>
          <?php if (in_array('pl_prod_sales', $advppp_settings_pl_columns)) { ?>           
          <td class="right" nowrap="nowrap" style="background-color:#DCFFB9;"><?php echo $product['product_sales']; ?></td>
          <?php } ?>
          <?php if (in_array('pl_prod_cost', $advppp_settings_pl_columns)) { ?>           
          <td class="right" nowrap="nowrap" style="background-color:#ffd7d7;">-<?php echo $product['product_cost']; ?></td>
          <?php } ?>
          <?php if (in_array('pl_prod_profit', $advppp_settings_pl_columns)) { ?>           
          <td class="right" nowrap="nowrap" style="background-color:#c4d9ee; font-weight:bold;"><?php echo $product['product_profit']; ?></td>
          <?php } ?>
          <?php if (in_array('pl_prod_profit_margin', $advppp_settings_pl_columns)) { ?>           
          <td class="right" nowrap="nowrap" style="background-color:#c4d9ee; font-weight:bold;"><?php echo $product['product_profit_margin']; ?>%</td>
          <?php } ?>      
          <?php if (in_array('pl_prod_profit_markup', $advppp_settings_pl_columns)) { ?>           
          <td class="right" nowrap="nowrap" style="background-color:#c4d9ee; font-weight:bold;"><?php echo $product['product_profit_markup']; ?>%</td>
          <?php } ?>                  
         </tr>       
    </table>
<?php } ?>
<?php if ($filter_details == 'basic_details') { ?>   
    <table class="list_detail">
      <thead>
        <tr>
          <?php if (in_array('cl_customer_order_id', $advppp_settings_cl_columns)) { ?>
          <td class="left" nowrap="nowrap"><?php echo $column_customer_order_id; ?></td>
          <?php } ?>
          <?php if (in_array('cl_customer_date_added', $advppp_settings_cl_columns)) { ?>
          <td class="left" nowrap="nowrap"><?php echo $column_customer_date_added; ?></td>
          <?php } ?>         
          <?php if (in_array('cl_customer_cust_id', $advppp_settings_cl_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_customer_cust_id; ?></td>
          <?php } ?>
          <?php if (in_array('cl_billing_name', $advppp_settings_cl_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_billing_name; ?></td>
          <?php } ?>
          <?php if (in_array('cl_billing_company', $advppp_settings_cl_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_billing_company; ?></td>
          <?php } ?>
          <?php if (in_array('cl_billing_address_1', $advppp_settings_cl_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_billing_address_1; ?></td> 
          <?php } ?>
          <?php if (in_array('cl_billing_address_2', $advppp_settings_cl_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_billing_address_2; ?></td> 
          <?php } ?>
          <?php if (in_array('cl_billing_city', $advppp_settings_cl_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_billing_city; ?></td>
          <?php } ?>
          <?php if (in_array('cl_billing_zone', $advppp_settings_cl_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_billing_zone; ?></td> 
          <?php } ?>
          <?php if (in_array('cl_billing_postcode', $advppp_settings_cl_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_billing_postcode; ?></td>
          <?php } ?>
          <?php if (in_array('cl_billing_country', $advppp_settings_cl_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_billing_country; ?></td>
          <?php } ?>
          <?php if (in_array('cl_customer_telephone', $advppp_settings_cl_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_customer_telephone; ?></td>
          <?php } ?>
          <?php if (in_array('cl_shipping_name', $advppp_settings_cl_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_shipping_name; ?></td> 
          <?php } ?>
          <?php if (in_array('cl_shipping_company', $advppp_settings_cl_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_shipping_company; ?></td> 
          <?php } ?>
          <?php if (in_array('cl_shipping_address_1', $advppp_settings_cl_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_shipping_address_1; ?></td> 
          <?php } ?>
          <?php if (in_array('cl_shipping_address_2', $advppp_settings_cl_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_shipping_address_2; ?></td> 
          <?php } ?>
          <?php if (in_array('cl_shipping_city', $advppp_settings_cl_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_shipping_city; ?></td>
          <?php } ?>
          <?php if (in_array('cl_shipping_zone', $advppp_settings_cl_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_shipping_zone; ?></td> 
          <?php } ?>
          <?php if (in_array('cl_shipping_postcode', $advppp_settings_cl_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_shipping_postcode; ?></td>
          <?php } ?>
          <?php if (in_array('cl_shipping_country', $advppp_settings_cl_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_shipping_country; ?></td>
          <?php } ?>          
        </tr>
      </thead>
...
<?php } ?>
        ...
        <tr>
          ...
          <?php } ?>
          <?php if (in_array('cm_discount', $advppp_settings_cm_columns)) { ?>            
          <td class="right" nowrap="nowrap" style="background-color:#E7EFEF; color:#003A88;"><strong><?php echo $product['discount_total']; ?></strong></td>
          <?php } ?>          
          <?php if (in_array('cm_refunds', $advppp_settings_cm_columns)) { ?>            
          ...
          <?php } ?>   
          <?php if (in_array('cm_total_sales', $advppp_settings_cm_columns)) { ?>            
          <td class="right" nowrap="nowrap" style="background-color:#DCFFB9; color:#003A88;"><strong><?php echo $product['total_sales_total']; ?></strong></td>
          <?php } ?>                                        
          <?php if (in_array('cm_total_costs', $advppp_settings_cm_columns)) { ?>             
          <td class="right" nowrap="nowrap" style="background-color:#ffd7d7; color:#003A88;"><strong><?php echo $product['total_costs_total']; ?></strong></td>
          <?php } ?>
          <?php if (in_array('cm_total_profit', $advppp_settings_cm_columns)) { ?>           
          <td class="right" nowrap="nowrap" <?php echo ($product['total_profit_total_raw'] >= 0) ? 'style="background-color:#c4d9ee; color:#003A88;"' : 'style="background-color:#F99; color:#003A88;"' ?> ><strong><?php echo $product['total_profit_total']; ?></strong></td>
          <?php } ?>
          <?php if (in_array('cm_total_profit_margin', $advppp_settings_cm_columns)) { ?>
          <td class="right" nowrap="nowrap" <?php echo ($product['total_profit_total_raw'] >= 0) ? 'style="background-color:#c4d9ee; color:#003A88;"' : 'style="background-color:#F99; color:#003A88;"' ?> ><strong><?php echo ($product['sold_quantity_total'] > 0) ? $product['total_profit_margin_total'] : '0%' ?></strong></td>
          <?php } ?>   
          <?php if (in_array('cm_total_profit_markup', $advppp_settings_cm_columns)) { ?>
          <td class="right" nowrap="nowrap" <?php echo ($product['total_profit_total_raw'] >= 0) ? 'style="background-color:#c4d9ee; color:#003A88;"' : 'style="background-color:#F99; color:#003A88;"' ?> ><strong><?php echo ($product['sold_quantity_total'] > 0) ? $product['total_profit_markup_total'] : '0%' ?></strong></td>
          <?php } ?>  
          <?php } elseif ($filter_report == 'products_options') { ?>
          <td style="background-color:#E5E5E5;"></td>
          <?php if (in_array('mv_orders', $advppp_settings_mv_columns)) { ?>          
          ...
          <td class="right" nowrap="nowrap" style="background-color:#FFC; color:#003A88;"><strong><?php echo $product['sold_quantity_total']; ?></strong></td>
          <td class="right" nowrap="nowrap" style="background-color:#FFC; color:#003A88;"><strong><?php echo $product['sold_percent_total']; ?></strong></td>
		  <?php } elseif ($filter_report != 'products_without_orders' && $filter_report != 'products_shopping_carts' && $filter_report != 'products_wishlists' && $filter_report != 'products_options' && $filter_report != 'manufacturers' && $filter_report != 'categories' && $filter_report != 'suppliers') { ?>
          <?php if (in_array('mv_id', $advppp_settings_mv_columns)) { ?>
          <td style="background-color:#E5E5E5;"></td>
          <?php } ?>
          <?php if (in_array('mv_image', $advppp_settings_mv_columns)) { ?>
          ...
          <?php } ?>
          <?php if (in_array('mv_discount', $advppp_settings_mv_columns)) { ?>            
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'products_abandoned_orders') ? 'style="background-color:#E7EFEF; color:#003A88; text-decoration:line-through;"' : 'style="background-color:#E7EFEF; color:#003A88;"' ?> ><strong><?php echo $product['discount_total']; ?></strong></td>
          <?php } ?>
          <?php if (in_array('mv_refunds', $advppp_settings_mv_columns)) { ?>            
          ...
          <?php } ?>
          <?php if (in_array('mv_total_sales', $advppp_settings_mv_columns)) { ?>            
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'products_abandoned_orders') ? 'style="background-color:#DCFFB9; color:#003A88; text-decoration:line-through;"' : 'style="background-color:#DCFFB9; color:#003A88;"' ?> ><strong><?php echo $product['total_sales_total']; ?></strong></td>
          <?php } ?>                                        
          <?php if (in_array('mv_total_costs', $advppp_settings_mv_columns)) { ?>             
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'products_abandoned_orders') ? 'style="background-color:#ffd7d7; color:#003A88; text-decoration:line-through;"' : 'style="background-color:#ffd7d7; color:#003A88;"' ?> ><strong><?php echo $product['total_costs_total']; ?></strong></td>
          <?php } ?>
          <?php if (in_array('mv_total_profit', $advppp_settings_mv_columns)) { ?>           
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'products_abandoned_orders') ? (($product['total_profit_total_raw'] >= 0) ? 'style="background-color:#c4d9ee; color:#003A88; text-decoration:line-through;"' : 'style="background-color:#F99; color:#003A88; text-decoration:line-through;"') : (($product['total_profit_total_raw'] >= 0) ? 'style="background-color:#c4d9ee; color:#003A88;"' : 'style="background-color:#F99; color:#003A88;"') ?> ><strong><?php echo $product['total_profit_total']; ?></strong></td>
          <?php } ?>
          <?php if (in_array('mv_total_profit_margin', $advppp_settings_mv_columns)) { ?>
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'products_abandoned_orders') ? (($product['total_profit_total_raw'] >= 0) ? 'style="background-color:#c4d9ee; color:#003A88; text-decoration:line-through;"' : 'style="background-color:#F99; color:#003A88; text-decoration:line-through;"') : (($product['total_profit_total_raw'] >= 0) ? 'style="background-color:#c4d9ee; color:#003A88;"' : 'style="background-color:#F99; color:#003A88;"') ?> ><strong><?php echo ($product['sold_quantity_total'] > 0) ? $product['total_profit_margin_total'] : '0%' ?></strong></td>
          <?php } ?>
          <?php if (in_array('mv_total_profit_markup', $advppp_settings_mv_columns)) { ?>
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'products_abandoned_orders') ? (($product['total_profit_total_raw'] >= 0) ? 'style="background-color:#c4d9ee; color:#003A88; text-decoration:line-through;"' : 'style="background-color:#F99; color:#003A88; text-decoration:line-through;"') : (($product['total_profit_total_raw'] >= 0) ? 'style="background-color:#c4d9ee; color:#003A88;"' : 'style="background-color:#F99; color:#003A88;"') ?> ><strong><?php echo ($product['sold_quantity_total'] > 0) ? $product['total_profit_markup_total'] : '0%' ?></strong></td>
          <?php } ?>          
          <?php } ?>       
...
<script type="text/javascript">
function filter() {
	url = 'index.php?route=extension/report/adv_products_profit&user_token=<?php echo $user_token; ?>';										 
	...
	var filter_supplier = supplier.join(',');
	if (filter_supplier) {
...
function deleteCookie(name) {
	...
	var initCookies = function() {
		setCookie('show-ppp-chart', 1, 365);
		$('.chart-switcher').removeClass('hide-chart');
		$(".chart_button").html('<span>Hide <?php echo $button_chart; ?></span>');
	};

	if (getCookie('show-ppp-chart') == 1) {
		$('.chart-switcher').show();
		$(".chart_button").html('<span>Hide <?php echo $button_chart; ?></span>');
	} else if (getCookie('show-ppp-chart') == 2) {
		$('.chart-switcher').hide();
	...
	$(document).on('click', '.chart-button', function(e) {
		...
		if (getCookie('show-ppp-chart') == 1) {
			$('.chart-switcher').hide();
			setCookie('show-ppp-chart', 2, 365);
			$(".chart_button").html('<span>Show <?php echo $button_chart; ?></span>');
		} else if (getCookie('show-ppp-chart') == 2) {
			$('.chart-switcher').show();
			setCookie('show-ppp-chart', 1, 365);
	...
	$(document).on('click', '.filters-button', function(e) {
		...
		if (getCookie('show-ppp-filters') == 1) {
			$('.filters-switcher').hide();
			setCookie('show-ppp-filters', 2, 365);
			$(".filters_button").html('<span>Show <?php echo $button_filters; ?></span>');
		} else if (getCookie('show-ppp-filters') == 2) {
			$('.filters-switcher').show();
			setCookie('show-ppp-filters', 1, 365);
...
$('input[name=\'filter_customer_name\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_products_profit/customer_autocomplete&user_token=<?php echo $user_token; ?>&filter_customer_name=' +  encodeURIComponent(request),
			dataType: 'json',
...
$('input[name=\'filter_customer_email\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_products_profit/customer_autocomplete&user_token=<?php echo $user_token; ?>&filter_customer_email=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_customer_telephone\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_products_profit/customer_autocomplete&user_token=<?php echo $user_token; ?>&filter_customer_telephone=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_ip\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_products_profit/customer_autocomplete&user_token=<?php echo $user_token; ?>&filter_ip=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_payment_company\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_products_profit/customer_autocomplete&user_token=<?php echo $user_token; ?>&filter_payment_company=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_payment_address\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_products_profit/customer_autocomplete&user_token=<?php echo $user_token; ?>&filter_payment_address=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_payment_city\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_products_profit/customer_autocomplete&user_token=<?php echo $user_token; ?>&filter_payment_city=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_payment_zone\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_products_profit/customer_autocomplete&user_token=<?php echo $user_token; ?>&filter_payment_zone=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_payment_postcode\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_products_profit/customer_autocomplete&user_token=<?php echo $user_token; ?>&filter_payment_postcode=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_payment_country\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_products_profit/customer_autocomplete&user_token=<?php echo $user_token; ?>&filter_payment_country=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_shipping_company\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_products_profit/customer_autocomplete&user_token=<?php echo $user_token; ?>&filter_shipping_company=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_shipping_address\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_products_profit/customer_autocomplete&user_token=<?php echo $user_token; ?>&filter_shipping_address=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_shipping_city\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_products_profit/customer_autocomplete&user_token=<?php echo $user_token; ?>&filter_shipping_city=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_shipping_zone\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_products_profit/customer_autocomplete&user_token=<?php echo $user_token; ?>&filter_shipping_zone=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_shipping_postcode\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_products_profit/customer_autocomplete&user_token=<?php echo $user_token; ?>&filter_shipping_postcode=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_shipping_country\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_products_profit/customer_autocomplete&user_token=<?php echo $user_token; ?>&filter_shipping_country=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_sku\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_products_profit/product_autocomplete&user_token=<?php echo $user_token; ?>&filter_sku=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_upc\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_products_profit/product_autocomplete&user_token=<?php echo $user_token; ?>&filter_upc=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_ean\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_products_profit/product_autocomplete&user_token=<?php echo $user_token; ?>&filter_ean=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_jan\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_products_profit/product_autocomplete&user_token=<?php echo $user_token; ?>&filter_jan=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_isbn\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_products_profit/product_autocomplete&user_token=<?php echo $user_token; ?>&filter_isbn=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_mpn\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_products_profit/product_autocomplete&user_token=<?php echo $user_token; ?>&filter_mpn=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_product_name\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_products_profit/product_autocomplete&user_token=<?php echo $user_token; ?>&filter_product_name=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_model\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_products_profit/product_autocomplete&user_token=<?php echo $user_token; ?>&filter_model=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_coupon_code\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_products_profit/coupon_autocomplete&user_token=<?php echo $user_token; ?>&filter_coupon_code=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_voucher_code\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_products_profit/voucher_autocomplete&user_token=<?php echo $user_token; ?>&filter_voucher_code=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_campaign_code\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_products_profit/campaign_autocomplete&user_token=<?php echo $user_token; ?>&filter_campaign_code=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('#save_settings').on('click', function(){
	$.ajax ({
		url: 'index.php?route=extension/report/adv_products_profit/settings&user_token=<?php echo $user_token; ?>',		
		type: 'post',
...
$('#save_report').on('click', function(){
	$.ajax ({
		url: 'index.php?route=extension/report/adv_products_profit/load_save_report&user_token=<?php echo $user_token; ?>',		
		type: 'post',
...
function addSaveReport() {
	...
	html += '<tr>';
	html += '<td width="5%"></td>';	
	html += '<td width="45%" class="text-left"><input type="text" name="advppp_load_save_report[' + adv_load_save_reports_row + '][save_report_title]" placeholder="<?php echo $text_report_title; ?>" value="" class="form-control" style="background-color:#f7e9e3;" /></td>';
	html += '<td width="40%" class="text-left"><textarea readonly name="advppp_load_save_report[' + adv_load_save_reports_row + '][save_report_link]" class="form-control"><?php echo $save_report_link; ?></textarea></td>';
	html += '<td width="10%"></td>';
	html += '</tr>';
	html += '</tbody>';
...
function addCron() {
	...
	html += '<input type="hidden" id="cron_id_save" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_id]" value="" />';
	html += '<input type="hidden" id="cron_report_type_save" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_report_type]" value="" />';
	html += '<input type="hidden" id="cron_export_type_save" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_export_type]" value="" />';
	html += '<input type="hidden" id="cron_export_logo_criteria_save" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_export_logo_criteria]" value="" />';
	html += '<input type="hidden" id="cron_export_csv_delimiter_save" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_export_csv_delimiter]" value="" />';
	html += '<input type="hidden" id="cron_export_file_save" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_export_file]" value="" />';
	html += '<input type="hidden" id="cron_file_save_path_save" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_file_save_path]" value="" />';
	html += '<input type="hidden" id="cron_file_name_save" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_file_name]" value="" />';
	html += '<input type="hidden" id="cron_email_save" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_email]" value="" />';
	html += '<input type="hidden" id="cron_user_save" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_user]" value="" />';
	html += '<input type="hidden" id="cron_pass_save" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_pass]" value="" />';
	html += '<input type="hidden" id="cron_token_save" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_token]" value="" />';
	html += '<input type="hidden" id="cron_user_id_save" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_user_id]" value="" />';
	
	html += '<input type="hidden" id="cron_filter_report" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_filter_report]" value="" />';
	html += '<input type="hidden" id="cron_filter_details" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_filter_details]" value="" />';
	html += '<input type="hidden" id="cron_filter_group" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_filter_group]" value="" />';
	html += '<input type="hidden" id="cron_filter_sort" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_filter_sort]" value="" />';
	html += '<input type="hidden" id="cron_filter_order" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_filter_order]" value="" />';
	html += '<input type="hidden" id="cron_filter_limit" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_filter_limit]" value="" />';
	
	html += '<input type="hidden" id="cron_filter_range" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_filter_range]" value="" />';
	html += '<input type="hidden" id="cron_date_start" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_date_start]" value="" />';
	html += '<input type="hidden" id="cron_date_end" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_date_end]" value="" />';
	html += '<input type="hidden" id="cron_filter_order_status_id" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_filter_order_status_id]" value="" />';
	html += '<input type="hidden" id="cron_status_date_start" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_status_date_start]" value="" />';
	html += '<input type="hidden" id="cron_status_date_end" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_status_date_end]" value="" />';
	html += '<input type="hidden" id="cron_filter_order_id_from" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_filter_order_id_from]" value="" />';
	html += '<input type="hidden" id="cron_filter_order_id_to" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_filter_order_id_to]" value="" />';
	html += '<input type="hidden" id="cron_filter_prod_price_min" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_filter_prod_price_min]" value="" />';
	html += '<input type="hidden" id="cron_filter_prod_price_max" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_filter_prod_price_max]" value="" />';
	html += '<input type="hidden" id="cron_filter_store_id" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_filter_store_id]" value="" />';
	html += '<input type="hidden" id="cron_filter_currency" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_filter_currency]" value="" />';
	html += '<input type="hidden" id="cron_filter_taxes" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_filter_taxes]" value="" />';
	html += '<input type="hidden" id="cron_filter_tax_classes" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_filter_tax_classes]" value="" />';
	html += '<input type="hidden" id="cron_filter_geo_zones" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_filter_geo_zones]" value="" />';
	html += '<input type="hidden" id="cron_filter_customer_group_id" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_filter_customer_group_id]" value="" />';
	html += '<input type="hidden" id="cron_filter_customer_name" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_filter_customer_name]" value="" />';
	html += '<input type="hidden" id="cron_filter_customer_email" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_filter_customer_email]" value="" />';
	html += '<input type="hidden" id="cron_filter_customer_telephone" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_filter_customer_telephone]" value="" />';
	html += '<input type="hidden" id="cron_filter_ip" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_filter_ip]" value="" />';
	html += '<input type="hidden" id="cron_filter_payment_company" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_filter_payment_company]" value="" />';
	html += '<input type="hidden" id="cron_filter_payment_address" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_filter_payment_address]" value="" />';
	html += '<input type="hidden" id="cron_filter_payment_city" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_filter_payment_city]" value="" />';
	html += '<input type="hidden" id="cron_filter_payment_zone" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_filter_payment_zone]" value="" />';
	html += '<input type="hidden" id="cron_filter_payment_postcode" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_filter_payment_postcode]" value="" />';
	html += '<input type="hidden" id="cron_filter_payment_country" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_filter_payment_country]" value="" />';
	html += '<input type="hidden" id="cron_filter_payment_method" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_filter_payment_method]" value="" />';
	html += '<input type="hidden" id="cron_filter_shipping_company" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_filter_shipping_company]" value="" />';
	html += '<input type="hidden" id="cron_filter_shipping_address" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_filter_shipping_address]" value="" />';
	html += '<input type="hidden" id="cron_filter_shipping_city" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_filter_shipping_city]" value="" />';
	html += '<input type="hidden" id="cron_filter_shipping_zone" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_filter_shipping_zone]" value="" />';
	html += '<input type="hidden" id="cron_filter_shipping_postcode" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_filter_shipping_postcode]" value="" />';
	html += '<input type="hidden" id="cron_filter_shipping_country" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_filter_shipping_country]" value="" />';
	html += '<input type="hidden" id="cron_filter_shipping_method" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_filter_shipping_method]" value="" />';
	html += '<input type="hidden" id="cron_filter_category" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_filter_category]" value="" />';
	html += '<input type="hidden" id="cron_filter_manufacturer" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_filter_manufacturer]" value="" />';
	html += '<input type="hidden" id="cron_filter_supplier" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_filter_supplier]" value="" />';
	html += '<input type="hidden" id="cron_filter_sku" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_filter_sku]" value="" />';
	html += '<input type="hidden" id="cron_filter_upc" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_filter_upc]" value="" />';
	html += '<input type="hidden" id="cron_filter_ean" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_filter_ean]" value="" />';
	html += '<input type="hidden" id="cron_filter_jan" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_filter_jan]" value="" />';
	html += '<input type="hidden" id="cron_filter_isbn" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_filter_isbn]" value="" />';
	html += '<input type="hidden" id="cron_filter_mpn" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_filter_mpn]" value="" />';
	html += '<input type="hidden" id="cron_filter_product_name" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_filter_product_name]" value="" />';
	html += '<input type="hidden" id="cron_filter_model" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_filter_model]" value="" />';
	html += '<input type="hidden" id="cron_filter_option" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_filter_option]" value="" />';
	html += '<input type="hidden" id="cron_filter_attribute" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_filter_attribute]" value="" />';
	html += '<input type="hidden" id="cron_filter_product_status" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_filter_product_status]" value="" />';
	html += '<input type="hidden" id="cron_filter_location" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_filter_location]" value="" />';
	html += '<input type="hidden" id="cron_filter_coupon_name" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_filter_coupon_name]" value="" />';
	html += '<input type="hidden" id="cron_filter_coupon_code" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_filter_coupon_code]" value="" />';
	html += '<input type="hidden" id="cron_filter_voucher_code" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_filter_voucher_code]" value="" />';
	html += '<input type="hidden" id="cron_filter_campaign_name" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_filter_campaign_name]" value="" />';
	html += '<input type="hidden" id="cron_filter_campaign_code" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_filter_campaign_code]" value="" />';
	
	html += '<input type="text" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_title]" placeholder="<?php echo $text_cron_title; ?>" value="" class="form-control" style="background-color:#f7e9e3;" /></td>';
	html += '<td width="45%" class="text-left"><textarea id="cron_command" readonly name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_command]" class="form-control"></textarea></td>';
	html += '<td width="10%"></td>';
	html += '</tr>';
	html += '</tbody>';
...
$('#export_report').on('click', function(){
	var url_exp ='index.php?route=extension/report/adv_products_profit/export&user_token=<?php echo $user_token; ?>';
	...
	$.ajax ({
		url: 'index.php?route=extension/report/adv_products_profit/export_validate&user_token=<?php echo $user_token; ?>',
		type: 'post',
...
$('#save_cron').on('click', function(){
	...
	if ($("#filter_supplier").val() != null) { $('#cron_filter_supplier').val($("#filter_supplier").val().join(',')) };
	...
	$.ajax ({
		url: 'index.php?route=extension/report/adv_products_profit/cron&user_token=<?php echo $user_token; ?>',		
		type: 'post',
...
function cron_command() {
	...
	var addr = link+"&cron_route="+"extension/report/adv_products_profit"+"&user_id="+user+"&cron_token="+token+"&cron_id="+id+"&cron=1";
...
function checkValidOptions() {
  ...
  var filter_details = document.getElementById('filter_details');
    if (filter_report.options[0].selected === true || filter_report.options[5].selected === true || filter_report.options[12].selected === true || filter_report.options[13].selected === true) {
    ...
    if (filter_report.options[0].selected === true || filter_report.options[1].selected === true || filter_report.options[2].selected === true || filter_report.options[3].selected === true || filter_report.options[4].selected === true || filter_report.options[9].selected === true) {	
		<?php if ($filter_report == 'products_shopping_carts') { ?>
		<?php if (in_array('scw_cart_quantity', $advppp_settings_scw_columns)) { ?>document.getElementById("cart_quantity").disabled = true;<?php } ?>
		<?php } ?>			
		<?php if ($filter_report == 'products_wishlists') { ?>
		<?php if (in_array('scw_wishlist_quantity', $advppp_settings_scw_columns)) { ?>document.getElementById("wishlist_quantity").disabled = true;<?php } ?>
		<?php } ?>		
	}
    if (filter_report.options[6].selected === true || filter_report.options[7].selected === true || filter_report.options[8].selected === true || filter_report.options[9].selected === true || filter_details.options[2].selected === true || filter_details.options[3].selected === true) {
		<?php if ($filter_report == 'categories') { ?>
		<?php if (in_array('cm_category', $advppp_settings_cm_columns)) { ?>document.getElementById("category").disabled = true;<?php } ?>
		<?php } ?>			
		<?php if ($filter_report == 'manufacturers') { ?>
		<?php if (in_array('cm_manufacturer', $advppp_settings_cm_columns)) { ?>document.getElementById("manufacturer").disabled = true;<?php } ?>	
		<?php } ?>
		<?php if ($filter_report == 'suppliers') { ?>
		<?php if (in_array('cm_supplier', $advppp_settings_cm_columns)) { ?>document.getElementById("supplier").disabled = true;<?php } ?>
		<?php } ?>			
		<?php if ($filter_report == 'products_wishlists' or $filter_report == 'products_shopping_carts') { ?>
		<?php if (in_array('scw_id', $advppp_settings_scw_columns)) { ?>document.getElementById("id").disabled = true;<?php } ?>
		<?php if (in_array('scw_sku', $advppp_settings_scw_columns)) { ?>document.getElementById("sku").disabled = true;<?php } ?>
		<?php if (in_array('scw_upc', $advppp_settings_scw_columns)) { ?>document.getElementById("upc").disabled = true;<?php } ?>
		<?php if (in_array('scw_ean', $advppp_settings_scw_columns)) { ?>document.getElementById("ean").disabled = true;<?php } ?>
		<?php if (in_array('scw_jan', $advppp_settings_scw_columns)) { ?>document.getElementById("jan").disabled = true;<?php } ?>
		<?php if (in_array('scw_isbn', $advppp_settings_scw_columns)) { ?>document.getElementById("isbn").disabled = true;<?php } ?>
		<?php if (in_array('scw_mpn', $advppp_settings_scw_columns)) { ?>document.getElementById("mpn").disabled = true;<?php } ?>
		<?php if (in_array('scw_name', $advppp_settings_scw_columns)) { ?>document.getElementById("name").disabled = true;<?php } ?>
		<?php if (in_array('scw_model', $advppp_settings_scw_columns)) { ?>document.getElementById("model").disabled = true;<?php } ?>
		<?php if (in_array('scw_category', $advppp_settings_scw_columns)) { ?>document.getElementById("category").disabled = true;<?php } ?>
		<?php if (in_array('scw_manufacturer', $advppp_settings_scw_columns)) { ?>document.getElementById("manufacturer").disabled = true;<?php } ?>
		<?php if (in_array('scw_supplier', $advppp_settings_scw_columns)) { ?>document.getElementById("supplier").disabled = true;<?php } ?>
		<?php if (in_array('scw_attribute', $advppp_settings_scw_columns)) { ?>document.getElementById("attribute").disabled = true;<?php } ?>
		<?php if (in_array('scw_status', $advppp_settings_scw_columns)) { ?>document.getElementById("status").disabled = true;<?php } ?>
		<?php if (in_array('scw_location', $advppp_settings_scw_columns)) { ?>document.getElementById("location").disabled = true;<?php } ?>
		<?php if (in_array('scw_tax_class', $advppp_settings_scw_columns)) { ?>document.getElementById("tax_class").disabled = true;<?php } ?>
		<?php if (in_array('scw_viewed', $advppp_settings_scw_columns)) { ?>document.getElementById("viewed").disabled = true;<?php } ?>
		<?php if (in_array('scw_price', $advppp_settings_scw_columns)) { ?>document.getElementById("price").disabled = true;<?php } ?>
		<?php if (in_array('scw_cost', $advppp_settings_scw_columns)) { ?>document.getElementById("cost").disabled = true;<?php } ?>
		<?php if (in_array('scw_profit', $advppp_settings_scw_columns)) { ?>document.getElementById("profit").disabled = true;<?php } ?>
		<?php if (in_array('scw_profit_margin', $advppp_settings_scw_columns)) { ?>document.getElementById("profit_margin").disabled = true;<?php } ?>
		<?php if (in_array('scw_profit_markup', $advppp_settings_scw_columns)) { ?>document.getElementById("profit_markup").disabled = true;<?php } ?>
		<?php if (in_array('scw_stock_quantity', $advppp_settings_scw_columns)) { ?>document.getElementById("stock_quantity").disabled = true;<?php } ?>		
		<?php if ($filter_report == 'products_shopping_carts') { ?>
		<?php if (in_array('scw_cart_quantity', $advppp_settings_scw_columns)) { ?>document.getElementById("cart_quantity").disabled = true;<?php } ?>
		<?php } ?>
		<?php if ($filter_report == 'products_wishlists') { ?>
		...
		<?php } ?>
		<?php if ($filter_report == 'products_without_orders') { ?>
		<?php if (in_array('pnp_id', $advppp_settings_pnp_columns)) { ?>document.getElementById("id").disabled = true;<?php } ?>
		<?php if (in_array('pnp_sku', $advppp_settings_pnp_columns)) { ?>document.getElementById("sku").disabled = true;<?php } ?>
		<?php if (in_array('pnp_upc', $advppp_settings_pnp_columns)) { ?>document.getElementById("upc").disabled = true;<?php } ?>
		<?php if (in_array('pnp_ean', $advppp_settings_pnp_columns)) { ?>document.getElementById("ean").disabled = true;<?php } ?>
		<?php if (in_array('pnp_jan', $advppp_settings_pnp_columns)) { ?>document.getElementById("jan").disabled = true;<?php } ?>
		<?php if (in_array('pnp_isbn', $advppp_settings_pnp_columns)) { ?>document.getElementById("isbn").disabled = true;<?php } ?>
		<?php if (in_array('pnp_mpn', $advppp_settings_pnp_columns)) { ?>document.getElementById("mpn").disabled = true;<?php } ?>
		<?php if (in_array('pnp_name', $advppp_settings_pnp_columns)) { ?>document.getElementById("name").disabled = true;<?php } ?>
		<?php if (in_array('pnp_model', $advppp_settings_pnp_columns)) { ?>document.getElementById("model").disabled = true;<?php } ?>
		<?php if (in_array('pnp_category', $advppp_settings_pnp_columns)) { ?>document.getElementById("category").disabled = true;<?php } ?>
		<?php if (in_array('pnp_manufacturer', $advppp_settings_pnp_columns)) { ?>document.getElementById("manufacturer").disabled = true;<?php } ?>
		<?php if (in_array('pnp_supplier', $advppp_settings_pnp_columns)) { ?>document.getElementById("supplier").disabled = true;<?php } ?>
		<?php if (in_array('pnp_attribute', $advppp_settings_pnp_columns)) { ?>document.getElementById("attribute").disabled = true;<?php } ?>
		<?php if (in_array('pnp_status', $advppp_settings_pnp_columns)) { ?>document.getElementById("status").disabled = true;<?php } ?>
		<?php if (in_array('pnp_location', $advppp_settings_pnp_columns)) { ?>document.getElementById("location").disabled = true;<?php } ?>
		<?php if (in_array('pnp_tax_class', $advppp_settings_pnp_columns)) { ?>document.getElementById("tax_class").disabled = true;<?php } ?>
		<?php if (in_array('pnp_viewed', $advppp_settings_pnp_columns)) { ?>document.getElementById("viewed").disabled = true;<?php } ?>
		<?php if (in_array('pnp_price', $advppp_settings_pnp_columns)) { ?>document.getElementById("price").disabled = true;<?php } ?>
		<?php if (in_array('pnp_cost', $advppp_settings_pnp_columns)) { ?>document.getElementById("cost").disabled = true;<?php } ?>
		<?php if (in_array('pnp_profit', $advppp_settings_pnp_columns)) { ?>document.getElementById("profit").disabled = true;<?php } ?>
		<?php if (in_array('pnp_profit_margin', $advppp_settings_pnp_columns)) { ?>document.getElementById("profit_margin").disabled = true;<?php } ?>
		<?php if (in_array('pnp_profit_markup', $advppp_settings_pnp_columns)) { ?>document.getElementById("profit_markup").disabled = true;<?php } ?>
		<?php if (in_array('pnp_stock_quantity', $advppp_settings_pnp_columns)) { ?>document.getElementById("stock_quantity").disabled = true;<?php } ?>	
		<?php } ?>
		<?php if ($filter_report == 'all_products_with_without_orders' or $filter_report == 'products_purchased_without_options' or $filter_report == 'products_purchased_with_options' or $filter_report == 'new_products_purchased' or $filter_report == 'old_products_purchased' or $filter_report == 'products_abandoned_orders') { ?>		
		<?php if (in_array('mv_id', $advppp_settings_mv_columns)) { ?>document.getElementById("id").disabled = true;<?php } ?>
		<?php if (in_array('mv_sku', $advppp_settings_mv_columns)) { ?>document.getElementById("sku").disabled = true;<?php } ?>
		<?php if (in_array('mv_upc', $advppp_settings_mv_columns)) { ?>document.getElementById("upc").disabled = true;<?php } ?>
		<?php if (in_array('mv_ean', $advppp_settings_mv_columns)) { ?>document.getElementById("ean").disabled = true;<?php } ?>
		<?php if (in_array('mv_jan', $advppp_settings_mv_columns)) { ?>document.getElementById("jan").disabled = true;<?php } ?>
		<?php if (in_array('mv_isbn', $advppp_settings_mv_columns)) { ?>document.getElementById("isbn").disabled = true;<?php } ?>
		<?php if (in_array('mv_mpn', $advppp_settings_mv_columns)) { ?>document.getElementById("mpn").disabled = true;<?php } ?>
		<?php if (in_array('mv_name', $advppp_settings_mv_columns)) { ?>document.getElementById("name").disabled = true;<?php } ?>
		<?php if (in_array('mv_model', $advppp_settings_mv_columns)) { ?>document.getElementById("model").disabled = true;<?php } ?>
		<?php if (in_array('mv_category', $advppp_settings_mv_columns)) { ?>document.getElementById("category").disabled = true;<?php } ?>
		<?php if (in_array('mv_manufacturer', $advppp_settings_mv_columns)) { ?>document.getElementById("manufacturer").disabled = true;<?php } ?>	
		<?php if (in_array('mv_supplier', $advppp_settings_mv_columns)) { ?>document.getElementById("supplier").disabled = true;<?php } ?>	
		<?php if (in_array('mv_attribute', $advppp_settings_mv_columns)) { ?>document.getElementById("attribute").disabled = true;<?php } ?>
		<?php if (in_array('mv_status', $advppp_settings_mv_columns)) { ?>document.getElementById("status").disabled = true;<?php } ?>
		<?php if (in_array('mv_location', $advppp_settings_mv_columns)) { ?>document.getElementById("location").disabled = true;<?php } ?>
		<?php if (in_array('mv_tax_class', $advppp_settings_mv_columns)) { ?>document.getElementById("tax_class").disabled = true;<?php } ?>
		<?php if (in_array('mv_viewed', $advppp_settings_mv_columns)) { ?>document.getElementById("viewed").disabled = true;<?php } ?>
		<?php if (in_array('mv_price', $advppp_settings_mv_columns)) { ?>document.getElementById("price").disabled = true;<?php } ?>
		<?php if (in_array('mv_cost', $advppp_settings_mv_columns)) { ?>document.getElementById("cost").disabled = true;<?php } ?>
		<?php if (in_array('mv_profit', $advppp_settings_mv_columns)) { ?>document.getElementById("profit").disabled = true;<?php } ?>
		<?php if (in_array('mv_profit_margin', $advppp_settings_mv_columns)) { ?>document.getElementById("profit_margin").disabled = true;<?php } ?>
		<?php if (in_array('mv_profit_markup', $advppp_settings_mv_columns)) { ?>document.getElementById("profit_markup").disabled = true;<?php } ?>
		<?php if (in_array('mv_stock_quantity', $advppp_settings_mv_columns)) { ?>document.getElementById("stock_quantity").disabled = true;<?php } ?>
		<?php } ?>		
	}
    if (filter_report.options[5].selected === true || filter_report.options[12].selected === true || filter_report.options[13].selected === true || filter_details.options[2].selected === true || filter_details.options[3].selected === true) {
		<?php if ($filter_report == 'all_products_with_without_orders' or $filter_report == 'products_purchased_without_options' or $filter_report == 'products_purchased_with_options' or $filter_report == 'new_products_purchased' or $filter_report == 'old_products_purchased' or $filter_report == 'products_abandoned_orders') { ?>
		<?php if (in_array('mv_orders', $advppp_settings_mv_columns)) { ?>document.getElementById("orders").disabled = true;<?php } ?>
		<?php if (in_array('mv_customers', $advppp_settings_mv_columns)) { ?>document.getElementById("customers").disabled = true;<?php } ?>
		<?php if (in_array('mv_sold_quantity', $advppp_settings_mv_columns)) { ?>document.getElementById("sold_quantity").disabled = true;<?php } ?>
		<?php if (in_array('mv_total_excl_vat', $advppp_settings_mv_columns)) { ?>document.getElementById("total_excl_vat").disabled = true;<?php } ?>
		<?php if (in_array('mv_total_tax', $advppp_settings_mv_columns)) { ?>document.getElementById("total_tax").disabled = true;<?php } ?>
		<?php if (in_array('mv_total_incl_vat', $advppp_settings_mv_columns)) { ?>document.getElementById("total_incl_vat").disabled = true;<?php } ?>
		<?php if (in_array('mv_app', $advppp_settings_mv_columns)) { ?>document.getElementById("app").disabled = true;<?php } ?>
		<?php if (in_array('mv_discount', $advppp_settings_mv_columns)) { ?>document.getElementById("discount").disabled = true;<?php } ?>
		<?php if (in_array('mv_refunds', $advppp_settings_mv_columns)) { ?>document.getElementById("refunds").disabled = true;<?php } ?>
		<?php if (in_array('mv_reward_points', $advppp_settings_mv_columns)) { ?>document.getElementById("reward_points").disabled = true;<?php } ?>
		<?php if (in_array('mv_total_sales', $advppp_settings_mv_columns)) { ?>document.getElementById("total_sales").disabled = true;<?php } ?>
		<?php if (in_array('mv_total_costs', $advppp_settings_mv_columns)) { ?>document.getElementById("total_costs").disabled = true;<?php } ?>
		<?php if (in_array('mv_total_profit', $advppp_settings_mv_columns)) { ?>document.getElementById("total_profit").disabled = true;<?php } ?>
		<?php if (in_array('mv_total_profit_margin', $advppp_settings_mv_columns)) { ?>document.getElementById("total_profit_margin").disabled = true;<?php } ?>
		<?php if (in_array('mv_total_profit_markup', $advppp_settings_mv_columns)) { ?>document.getElementById("total_profit_markup").disabled = true;<?php } ?>
		<?php } ?>
		<?php if ($filter_report == 'categories' or $filter_report == 'manufacturers' or $filter_report == 'suppliers') { ?>
		<?php if (in_array('cm_orders', $advppp_settings_cm_columns)) { ?>document.getElementById("orders").disabled = true;<?php } ?>
		<?php if (in_array('cm_customers', $advppp_settings_cm_columns)) { ?>document.getElementById("customers").disabled = true;<?php } ?>
		<?php if (in_array('cm_sold_quantity', $advppp_settings_cm_columns)) { ?>document.getElementById("sold_quantity").disabled = true;<?php } ?>
		<?php if (in_array('cm_total_excl_vat', $advppp_settings_cm_columns)) { ?>document.getElementById("total_excl_vat").disabled = true;<?php } ?>
		<?php if (in_array('cm_total_tax', $advppp_settings_cm_columns)) { ?>document.getElementById("total_tax").disabled = true;<?php } ?>
		<?php if (in_array('cm_total_incl_vat', $advppp_settings_cm_columns)) { ?>document.getElementById("total_incl_vat").disabled = true;<?php } ?>
		<?php if (in_array('cm_app', $advppp_settings_cm_columns)) { ?>document.getElementById("app").disabled = true;<?php } ?>
		<?php if (in_array('cm_discount', $advppp_settings_cm_columns)) { ?>document.getElementById("discount").disabled = true;<?php } ?>
		<?php if (in_array('cm_refunds', $advppp_settings_cm_columns)) { ?>document.getElementById("refunds").disabled = true;<?php } ?>
		<?php if (in_array('cm_reward_points', $advppp_settings_cm_columns)) { ?>document.getElementById("reward_points").disabled = true;<?php } ?>
		<?php if (in_array('cm_total_sales', $advppp_settings_cm_columns)) { ?>document.getElementById("total_sales").disabled = true;<?php } ?>
		<?php if (in_array('cm_total_costs', $advppp_settings_cm_columns)) { ?>document.getElementById("total_costs").disabled = true;<?php } ?>
		<?php if (in_array('cm_total_profit', $advppp_settings_cm_columns)) { ?>document.getElementById("total_profit").disabled = true;<?php } ?>
		<?php if (in_array('cm_total_profit_margin', $advppp_settings_cm_columns)) { ?>document.getElementById("total_profit_margin").disabled = true;<?php } ?>
		<?php if (in_array('cm_total_profit_markup', $advppp_settings_cm_columns)) { ?>document.getElementById("total_profit_markup").disabled = true;<?php } ?>
		<?php } ?>		
		<?php if ($filter_report == 'products_shopping_carts') { ?>
		<?php if (in_array('scw_cart_quantity', $advppp_settings_scw_columns)) { ?>document.getElementById("cart_quantity").disabled = true;<?php } ?>
		<?php } ?>			

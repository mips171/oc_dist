	...
	hyphens: auto;
          ...
          <div class="tab-content">
            <div id="tab_about" class="tab-pane active">
     		<div id="adv_products_profit"></div>

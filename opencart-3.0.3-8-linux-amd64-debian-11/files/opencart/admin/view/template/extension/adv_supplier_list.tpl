            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-right"><?php if ($sort == 's.supplier_id') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-left"><?php if ($sort == 's.name') { ?>
                    <a href="<?php echo $sort_name; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_name; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_name; ?>"><?php echo $column_name; ?></a>
                    <?php } ?></td>                    
                  <td class="text-left"><?php if ($sort == 's.email') { ?>
                    <a href="<?php echo $sort_email; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_email; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_email; ?>"><?php echo $column_email; ?></a>
                    <?php } ?></td>  
                  <td class="text-right"><?php if ($sort == 's.telephone') { ?>
                    ...
                    <?php } ?></td>                                        
                  <td class="text-left"><?php if ($sort == 's.website') { ?>

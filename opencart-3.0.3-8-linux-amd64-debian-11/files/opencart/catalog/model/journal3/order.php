...
class ModelJournal3Order extends Model {
	...
	public function save($order_id, $order_data) {
		if (!defined('JOURNAL3_IGNORE_CHECKOUT_FIX') && $order_id) {
	...
	private function getOrder($order_id) {
		...
		if ($order_query->num_rows) {
			return array(
				...
				'fax'                     => $this->journal3_opencart->is_oc2 ? $order_query->row['fax'] : '',
...
class_alias('ModelJournal3Order', '\Opencart\Catalog\Model\Journal3\Order');

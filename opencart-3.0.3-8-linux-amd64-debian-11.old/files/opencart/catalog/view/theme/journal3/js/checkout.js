	...
	window['_QuickCheckout'] = new Vue({
		...
		methods: {
			...
			payment: function () {
				...
				$('.quick-checkout-payment').append('<div class="journal-loading-overlay" style="position: absolute;"><div class="journal-loading"><em class="fa fa-spinner fa-spin"></em></div></div>');

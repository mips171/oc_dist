				...
				if ($category_info) {
					...
					foreach ($subcategories as $subcategory) {
						...
						if ($this->settings['images']) {
							$subcategory['image'] = $this->journal3_image->resize($subcategory['image'], $this->settings['imageDimensions']['width'], $this->settings['imageDimensions']['height'], $this->settings['imageDimensions']['resize']);
							$subcategory['image2x'] = $this->journal3_image->resize($subcategory['image'], $this->settings['imageDimensions']['width'] * 2, $this->settings['imageDimensions']['height'] * 2, $this->settings['imageDimensions']['resize']);
						} else {
